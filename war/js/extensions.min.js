(function(){function t(a){var d=null!=a.Text?a.Text:null!=a.Value?a.Value:a.Lane_0;null==d&&null!=a.State&&null!=a.State.t&&(d=a.State);null==d&&null!=a.TextAreas&&null!=a.TextAreas.Text&&null!=a.TextAreas.Text.Value&&null!=a.TextAreas.Text.Value.t&&(d=a.TextAreas.Text.Value);if(null!=d){if(null!=d.t)return d.t=d.t.replace(/</g,"&lt;"),d.t=d.t.replace(/>/g,"&gt;"),d.t;if(null!=d.Value&&null!=d.Value.t)return d.Value.t=d.Value.t.replace(/</g,"&lt;"),d.Value.t=d.Value.t.replace(/>/g,"&gt;"),d.Value.t}return""}
function q(a){return null!=a.Action?a.Action:a}function x(a,d){var f=q(d);if(null!=f){var b=B[f.Class]+";";null!=b&&(a.style+=b);b=null!=f.Properties?f.Properties:f;if(null!=b){a.value=t(b);var h=!1,g;a:{if(null!=b.Text){if(null!=b.Text.m){g=b.Text.m;break a}}else if(null!=b.TextAreas&&null!=b.TextAreas.Text&&null!=b.TextAreas.Text.Value&&null!=b.TextAreas.Text.Value.m){g=b.TextAreas.Text.Value.m;break a}g=null}if(null!=g)for(var e=0;!h&&e<g.length;){var c=g[e];"s"==c.n&&null!=c.v&&(h=!0,c=c.v,c=
Math.round(.6*c),a.style+="fontSize="+c+";");e++}0==h&&(a.style+="fontSize=10;");h=!1;if(null!=g){for(e=0;!h&&e<g.length;)c=g[e],"c"==c.n&&null!=c.v&&(h=!0,c=c.v,"#"!=c.charAt(0)&&(c="#"+c),c=c.substring(0,7),a.style+=mxConstants.STYLE_FONTCOLOR+"="+c+";"),e++;var h=0,m=!1;if(null!=g)for(e=0;!m&&e<g.length;)c=g[e],"b"==c.n&&null!=c.v&&c.v&&(m=!0,h+=1),e++;m=!1;if(null!=g)for(e=0;!m&&e<g.length;)c=g[e],"i"==c.n&&null!=c.v&&c.v&&(m=!0,h+=2),e++;m=!1;if(null!=g)for(e=0;!m&&e<g.length;)c=g[e],"u"==c.n&&
null!=c.v&&c.v&&(m=!0,h+=4),e++;0<h&&(a.style+="fontStyle="+h+";");h=!1;if(null!=g)for(e=0;!h&&e<g.length;)c=g[e],"a"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="align="+c+";"),e++;h=!1;if(null!=g)for(e=0;!h&&e<g.length;)c=g[e],"il"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="spacingLeft="+c+";"),e++;h=!1;if(null!=g)for(e=0;!h&&e<g.length;)c=g[e],"ir"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="spacingRight="+c+";"),e++;h=!1;if(null!=g)for(e=0;!h&&e<g.length;)c=g[e],"mt"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="spacingTop="+
c+";"),e++;h=!1;if(null!=g)for(e=0;!h&&e<g.length;)c=g[e],"mb"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="spacingBottom="+c+";"),e++;"number"===typeof b.InsetMargin&&(a.style+="spacing="+parseInt(b.InsetMargin)+";");"string"===typeof b.LineColor&&7<b.LineColor.length&&(g="0x"+b.LineColor.substring(b.LineColor.length-2,b.LineColor.length),a.style+="strokeOpacity="+Math.round(parseInt(g)/2.55)+";");"string"===typeof b.FillColor&&7<b.FillColor.length&&(g="0x"+b.FillColor.substring(b.FillColor.length-2,b.FillColor.length),
a.style+="fillOpacity="+Math.round(parseInt(g)/2.55)+";");null!=b.Text_VAlign&&"string"===typeof b.Text_VAlign&&(a.style+="verticalAlign="+b.Text_VAlign+";")}"ImageSearchBlock2"==f.Class&&(a.style+="image="+b.URL+";");a.style+=l(mxConstants.STYLE_STROKEWIDTH,.6*parseFloat(b.LineWidth),"1");C.includes(f.Class)?"Venn"==f.Class.substring(0,4)&&(a.style+=l(mxConstants.STYLE_STROKECOLOR,b.FillColor.substring(0,7),"#FFFFFF")):a.style=0==b.LineWidth?a.style+(mxConstants.STYLE_STROKECOLOR+"=none;"):a.style+
l(mxConstants.STYLE_STROKECOLOR,b.LineColor.substring(0,7),"#000000");a.style+=l(mxConstants.STYLE_ALIGN,b.TextAlign,"center");a.style+=l(mxConstants.STYLE_VERTICAL_ALIGN,b.TextVAlign,"middle");D.includes(f.Class)||(a.style+=l(mxConstants.STYLE_OPACITY,b.Opacity,"100"));null!=b.Rotation&&(g=mxUtils.toDegree(parseFloat(b.Rotation)),"AdvancedSwimLaneBlockRotated"==f.Class?(g+=90,a.geometry.rotate90()):E.includes(f.Class)&&(g-=90,a.geometry.rotate90(),a.geometry.rotate90(),a.geometry.rotate90()),a.style+=
"rotation="+g+";");b.FlipX&&(a.style+="flipH=1;");b.FlipY&&(a.style+="flipV=1;");null!=b.Shadow&&(a.style+=mxConstants.STYLE_SHADOW+"=1;");"dashed"==b.StrokeStyle?a.style+="dashed=1;":"dotted"==b.StrokeStyle&&(a.style+="dashed=1;dashPattern=1 4;");null==b.FillColor||F.includes(f.Class)||("object"===typeof b.FillColor?null!=b.FillColor.cs&&1<b.FillColor.cs.length&&(a.style+=l(mxConstants.STYLE_FILLCOLOR,b.FillColor.cs[0].c.substring(0,7)),a.style+=l(mxConstants.STYLE_GRADIENTCOLOR,b.FillColor.cs[1].c.substring(0,
7))):a.style="string"===typeof b.FillColor?a.style+l(mxConstants.STYLE_FILLCOLOR,b.FillColor.substring(0,7),"#FFFFFF"):a.style+l(mxConstants.STYLE_FILLCOLOR,"none"));if(a.edge){a.style+="rounded=1;arcSize=6;";if("diagonal"!=b.Shape)if(null!=b.ElbowPoints)for(a.geometry.points=[],e=0;e<b.ElbowPoints.length;e++)a.geometry.points.push(new mxPoint(Math.round(.6*b.ElbowPoints[e].x+0),Math.round(.6*b.ElbowPoints[e].y+0)));else"elbow"==b.Shape?a.style=null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block?a.style+
"edgeStyle=orthogonalEdgeStyle;":a.style+"edgeStyle=elbowEdgeStyle;":null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block&&(a.style+="edgeStyle=orthogonalEdgeStyle;","curve"==b.Shape&&(a.style+="curved=1;"));null!=b.Endpoint1.Style&&(a.style+="startArrow="+r[b.Endpoint1.Style]+";");null!=b.Endpoint2.Style&&(a.style+="endArrow="+r[b.Endpoint2.Style].replace(/startSize/g,"endSize")+";");y(a,b.Endpoint1,!0);y(a,b.Endpoint2,!1)}}}}function z(a){var d=q(a).Properties.BoundingBox;null!=a.Class&&"AWS"===a.Class.substring(0,
3)&&(d.h-=20);v=new mxCell("",new mxGeometry(Math.round(.6*d.x+0),Math.round(.6*d.y+0),Math.round(.6*d.w),Math.round(.6*d.h)),"html=1;whiteSpace=wrap;");v.vertex=!0;x(v,a);return v}function u(a,d,f){f=2*(parseFloat(a.Location)-.5);a=new mxCell(t(a),new mxGeometry(f,0,0,0),"text;html=1;resizable=0;align=center;verticalAlign=middle;labelBackgroundColor=#ffffff;");a.geometry.relative=!0;a.vertex=!0;d.insert(a);return d}function l(a,d,f,b){null!=d&&null!=b&&(d=b(d));return null!=d&&d!=f?a+"="+d+";":""}
function y(a,d,f){null!=d&&null!=d.LinkX&&null!=d.LinkY&&(a.style+=(f?"exitX":"entryX")+"="+d.LinkX+";"+(f?"exitY":"entryY")+"="+d.LinkY+";"+(f?"exitPerimeter":"entryPerimeter")+"=0;")}var C="VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8 UMLEndBlock DefaultTextBlockNew".split(" "),
F="AWSAndroidBlock3 AWSiOSBlock3 AWSJavaBlock3 AWSJavaScript AWSNetBlock3 AWSNodeJSBlock3 AWSPHPBlock3 AWSPythonBlock3 AWSRubyBlock3 AWSXamarin AWSCLIBlock3 AWSEclipseToolkitBlock3 AWSVisualStudioToolkitBlock3 AWSWindowsPowershellToolkitBlock3 DefaultTextBlock RectangleContainerBlock UMLStartBlock UMLEndBlock DefaultTextBlockNew UMLHForkJoinBlock".split(" "),D="VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8".split(" "),
E=["AEUSBBlock","AGSCutandpasteBlock","iOSDeviceiPadLandscape","iOSDeviceiPadProLandscape"],r={None:"none",Arrow:"block;endFill=1","Hollow Arrow":"block;endFill=0","Open Arrow":"open;","CFN ERD Zero Or More Arrow":"ERzeroToMany;startSize=10","CFN ERD One Or More Arrow":"ERoneToMany;startSize=10","CFN ERD Many Arrow":"ERmany;startSize=10","CFN ERD Exactly One Arrow":"ERmandOne;startSize=10","CFN ERD Zero Or One Arrow":"ERzeroToOne;startSize=10","CFN ERD One Arrow":"ERone;startSize=16",Generalization:"block;endFill=0;startSize=12",
"Big Open Arrow":"open;startSize=10",Asynch1:"openAsync;flipH=1;startSize=10",Asynch2:"openAsync;startSize=10",Aggregation:"diamond;endFill=0;startSize=16",Composition:"diamond;endFill=1;startSize=16",BlockEnd:"none;endFill=1;startSize=16"},B={DefaultTextBlockNew:"text;strokeColor=none;fillColor=none",DefaultTextBlock:"text;strokeColor=none;fillColor=none",DefaultSquareBlock:"rounded=1;absoluteArcSize=1;arcSize=6",DefaultNoteBlock:"shape=note;size=15",DefaultNoteBlockV2:"shape=note;size=15",HotspotBlock:"strokeColor=none;opacity=50",
ImageSearchBlock2:"shape=image",ProcessBlock:"rounded=1;absoluteArcSize=1;arcSize=6",DecisionBlock:"rhombus;rounded=1;arcSize=6",TerminatorBlock:"rounded=1;arcSize=50",PredefinedProcessBlock:"shape=process;absoluteArcSize=1;rounded=1;arcSize=6",DocumentBlock:"shape=document",MultiDocumentBlock:"shape=mxgraph.flowchart.multi-document",ManualInputBlock:"shape=manualInput;size=15;rounded=1;arcSize=6",PreparationBlock:"shape=hexagon;rounded=1;arcSize=6",DataBlock:"shape=parallelogram;rounded=1;arcSize=6",
DataBlockNew:"shape=parallelogram;rounded=1;arcSize=6",DatabaseBlock:"shape=cylinder",DirectAccessStorageBlock:"shape=mxgraph.flowchart.direct_data",InternalStorageBlock:"shape=internalStorage;rounded=1;arcSize=6;dx=10;dy=10",PaperTapeBlock:"shape=tape;size=0.2",ManualOperationBlockNew:"shape=trapezoid;rounded=1;arcSize=6;flipV=1",DelayBlock:"shape=delay",StoredDataBlock:"shape=dataStorage",MergeBlock:"triangle;direction=south;rounded=1;arcSize=6",ConnectorBlock:"ellipse",OrBlock:"shape=mxgraph.flowchart.summing_function",
SummingJunctionBlock:"shape=mxgraph.flowchart.or",DisplayBlock:"shape=display",OffPageLinkBlock:"shape=offPageConnector;rounded=1;arcSize=6",BraceNoteBlock:"shape=curlyBracket;rounded=1",NoteBlock:"shape=mxgraph.flowchart.annotation_1",AdvancedSwimLaneBlock:"swimlane;rounded=1;absoluteArcSize=1;arcSize=6",AdvancedSwimLaneBlockRotated:"swimlane;horizontal=0;rounded=1;absoluteArcSize=1;arcSize=6",RectangleContainerBlock:"fillColor=none;container=1;absoluteArcSize=1;rounded=1;arcSize=6",DiamondContainerBlock:"shape=rhombus;fillColor=none;container=1",
RoundedRectangleContainerBlock:"absoluteArcSize=1;arcSize=6;rounded=1;fillColor=none;container=1",CircleContainerBlock:"shape=ellipse;fillColor=none;container=1",PillContainerBlock:"rounded=1;arcSize=50;fillColor=none;container=1",IsoscelesTriangleBlock:"triangle;direction=north",RightTriangleBlock:"shape=mxgraph.basic.orthogonal_triangle",PentagonBlock:"shape=mxgraph.basic.pentagon",HexagonBlock:"shape=hexagon;rounded=1;arcSize=6",OctagonBlock:"shape=mxgraph.basic.octagon",CrossBlock:"shape=cross;size=0.6",
CloudBlock:"ellipse;shape=cloud",HeartBlock:"shape=mxgraph.basic.heart",RightArrowBlock:"shape=singleArrow;arrowWidth=0.5;arrowSize=0.3",DoubleArrowBlock:"shape=doubleArrow;arrowWidth=0.5;arrowSize=0.3",CalloutBlock:"shape=mxgraph.basic.rectangular_callout",ShapeCircleBlock:"ellipse",ShapePolyStarBlock:"shape=mxgraph.basic.star",ShapeDiamondBlock:"rhombus;rounded=1;arcSize=6",UI2HotspotBlock:"opacity=50;strokeColor=none;absoluteArcSize=1;arcSize=6rounded=1",AndroidIconCheck:"shape=mxgraph.ios7.misc.check",
...
AndroidIconEmail:"shape=mxgraph.mockup.misc.mail2",AndroidIconNew:"shape=mxgraph.ios7.misc.flagged",iOSDeviceiPhoneSE:"shape=mxgraph.ios7.misc.iphone",iOSDeviceiPhone6s:"shape=mxgraph.ios7.misc.iphone",iOSDeviceiPhone6sPlus:"shape=mxgraph.ios7.misc.iphone",iOSDeviceiPadPortrait:"shape=mxgraph.ios7.misc.ipad7inch",iOSDeviceiPadLandscape:"shape=mxgraph.ios7.misc.ipad7inch",iOSDeviceiPadProPortrait:"shape=mxgraph.ios7.misc.ipad7inch",iOSDeviceiPadProLandscape:"shape=mxgraph.ios7.misc.ipad10inch",iOSButton:"",
iOSStepper:"shape=mxgraph.ios7.misc.adjust",iOSToggle:"shape=mxgraph.ios7ui.onOffButton;buttonState=on;strokeColor2=#aaaaaa;fillColor2=#ffffff",iOSSlider:"shape=mxgraph.ios7ui.slider;barPos=20;strokeColor2=#a0a0a0",iOSProgressBar:"shape=mxgraph.ios.iCloudProgressBar;barPos=20",iOSPageControls:"shape=mxgraph.ios.iCloudProgressBar;barPos=20",iOSUniversalKeyboard:"shape=mxgraph.ios.iKeybLett",MindMapBlock:"absoluteArcSize=1;arcSize=6rounded=1",MindMapStadiumBlock:"rounded=1;arcSize=50",MindMapCloud:"shape=cloud",
MindMapCircle:"shape=ellipse",MindMapIsoscelesTriangleBlock:"shape=triangle;direction=north",MindMapDiamondBlock:"shape=rhombus",MindMapPentagonBlock:"shape=mxgraph.basic.pentagon",MindMapHexagonBlock:"shape=hexagon",MindMapOctagonBlock:"shape=mxgraph.basic.octagon",MindMapCrossBlock:"shape=mxgraph.basic.cross2;dx=20",UMLClassBlock:"rounded=1;absoluteArcSize=1;arcSize=6",UMLActiveClassBlock:"shape=mxgraph.flowchart.predefined_process",UMLPackageBlock:"shape=folder;tabPosition=left",UMLNoteBlock:"shape=note;size=15",
UMLTextBlock:"shape=text;strokeColor=none;fillColor=none",UMLActorBlock:"shape=umlActor;labelPosition=center;verticalLabelPosition=bottom;verticalAlign=top;whiteSpace=nowrap",UMLUseCaseBlock:"shape=ellipse",UMLCircleContainerBlock:"shape=ellipse;container=1",UMLRectangleContainerBlock:"absoluteArcSize=1;arcSize=6;rounded=1;container=1",UMLOptionLoopBlock:"shape=mxgraph.sysml.package2;xSize=90;align=left;spacingLeft=10;overflow=fill",UMLAlternativeBlock2:"shape=mxgraph.sysml.package2;xSize=90;align=left;spacingLeft=10;overflow=fill",
UMLStartBlock:"shape=ellipse;fillColor=#000000",UMLStateBlock:"absoluteArcSize=1;arcSize=6;rounded=1",UMLDecisionBlock:"shape=rhombus;rounded=1;",UMLHForkJoinBlock:"absoluteArcSize=1;arcSize=6;rounded=1;fillColor=#000000",UMLVForkJoinBlock:"absoluteArcSize=1;arcSize=6;rounded=1;fillColor=#000000",UMLFlowFinalBlock:"shape=mxgraph.flowchart.or",UMLHistoryStateBlock:"shape=ellipse",UMLEndBlock:"shape=mxgraph.bpmn.shape;outline=end;symbol=terminate;strokeColor=#000000;fillColor=#ffffff",UMLObjectBlock:"absoluteArcSize=1;arcSize=6;rounded=1",
UMLSendSignalBlock:"shape=mxgraph.sysml.sendSigAct",UMLReceiveSignalBlock:"shape=mxgraph.sysml.accEvent;flipH=1",UMLAcceptTimeEventActionBlock:"shape=mxgraph.sysml.timeEvent",UMLOffPageLinkBlock:"shape=mxgraph.sysml.sendSigAct;direction=south",UMLActivationBlock:"absoluteArcSize=1;arcSize=6;rounded=1",UMLDeletionBlock:"shape=mxgraph.sysml.x;strokeWidth=4",UMLSeqEntityBlock:"shape=mxgraph.electrical.radio.microphone_1;direction=north",UMLComponentBlock:"shape=component;align=left;spacingLeft=36",UMLNodeBlock:"shape=cube;size=12;flipH=1",
UMLComponentInterfaceBlock:"shape=ellipse",UMLProvidedInterfaceBlock:"shape=lollipop;direction=south",UMLRequiredInterfaceBlock:"shape=requires;direction=north",UMLEntityBlock:"absoluteArcSize=1;arcSize=6;rounded=1",UMLWeakEntityBlock:"shape=ext;double=1;rounded=1",UMLAttributeBlock:"shape=ellipse",UMLMultivaluedAttributeBlock:"shape=doubleEllipse",UMLRelationshipBlock:"shape=rhombus;rounded=1",UMLWeakRelationshipBlock:"shape=rhombus;rounded=1;double=1",DFDExternalEntityBlock2:"absoluteArcSize=1;arcSize=6;rounded=1",
YDMDFDProcessBlock:"shape=ellipse",YDMDFDDataStoreBlock:"shape=partialRectangle;right=0;left=0",GSDFDProcessBlock:"shape=swimlane;rounded=1;absoluteArcSize=1;arcSize=6",GSDFDProcessBlock2:"absoluteArcSize=1;arcSize=6;rounded=1",GSDFDDataStoreBlock2:"shape=partialRectangle;right=0",OrgBlock:"absoluteArcSize=1;arcSize=6;rounded=1",VSMCustomerSupplierBlock:"shape=mxgraph.lean_mapping.outside_sources",VSMDedicatedProcessBlock:"shape=mxgraph.lean_mapping.manufacturing_process",VSMSharedProcessBlock:"shape=mxgraph.lean_mapping.manufacturing_process_shared",
...
AWSAmazonRedshiftDW1Cluster2:"strokeColor=none;shape=mxgraph.aws3.dense_compute_node",AWSAmazonRedshiftDW2Cluster2:"strokeColor=none;shape=mxgraph.aws3.dense_storage_node",AWSAmazonRedshiftSSDFamilyCluster2:"strokeColor=none;shape=mxgraph.aws3.dense_storage_node",AWSAmazonRoute53RouteTable2:"strokeColor=none;shape=mxgraph.aws3.route_table",AWSSubnetBlock2:"strokeColor=none;shape=mxgraph.aws3.permissions",ACAccessControlBlock:"strokeColor=none;shape=mxgraph.azure.access_control",ACAPIAppsBlock:"strokeColor=none;shape=mxgraph.mscae.cloud.api_app",
ACAPIManagementBlock:"strokeColor=none;shape=mxgraph.mscae.cloud.api_management",ACAppInsightsBlock:"strokeColor=none;shape=mxgraph.mscae.cloud.application_insights",ACAppServicesBlock:"strokeColor=none;shape=mxgraph.mscae.cloud.app_service",ACAutoscalingBlock:"strokeColor=none;shape=mxgraph.azure.autoscale",ACAzureActiveDirectoryBlock:"strokeColor=none;shape=mxgraph.azure.azure_active_directory",ACAzurealertBlock:"strokeColor=none;shape=mxgraph.azure.azure_alert",ACAzureAutomationBlock:"strokeColor=none;shape=mxgraph.azure.automation",
ACAzureBatchBlock:"strokeColor=none;shape=mxgraph.mscae.cloud.azure_batch",ACAzureRedisBlock:"strokeColor=none;shape=mxgraph.azure.azure_cache",ACAzureFilesBlock:"strokeColor=none;shape=mxgraph.mscae.cloud.azure_files_service",ACAzureloadbalancerBlock:"strokeColor=none;shape=mxgraph.mscae.cloud.azure_automatic_load_balancer",ACAzureMarketplaceBlock:"strokeColor=none;shape=mxgraph.azure.azure_marketplace",ACAzureRightManagementRMSBlock:"strokeColor=none;shape=mxgraph.mscae.cloud.azure_rights_management_rms",
...
NET_Satellite:"shape=mxgraph.networks.satellite;fillColor=#29AAE1",NET_WirelessAccessPoint:"shape=mxgraph.networks.radio_tower;fillColor=#29AAE1",NET_Server:"shape=mxgraph.networks.server;fillColor=#29AAE1",NET_Mainframe:"shape=mxgraph.networks.mainframe;fillColor=#29AAE1",NET_Router:"shape=mxgraph.networks.wireless_hub;fillColor=#29AAE1",NET_Switch:"shape=mxgraph.networks.switch;fillColor=#29AAE1",NET_Firewall:"shape=mxgraph.networks.firewall;fillColor=#29AAE1",NET_User:"shape=mxgraph.networks.user_male;fillColor=#29AAE1",
NET_CommLink:"shape=mxgraph.networks.comm_link_edge;fillColor=#29AAE1",NET_SuperComputer:"shape=mxgraph.networks.supercomputer;fillColor=#29AAE1",NET_VirtualServer:"shape=mxgraph.networks.virtual_server;fillColor=#29AAE1",NET_Printer:"shape=mxgraph.networks.printer;fillColor=#29AAE1",NET_Scanner:"shape=mxgraph.networks.scanner;fillColor=#29AAE1",NET_Copier:"shape=mxgraph.networks.copier;fillColor=#29AAE1",NET_MultiFunctionMachine:"shape=mxgraph.networks.copier;fillColor=#29AAE1",NET_Projector:"shape=mxgraph.networks.video_projector;fillColor=#29AAE1",
NET_ProjectorScreen:"shape=mxgraph.networks.video_projector_screen;fillColor=#29AAE1",NET_Bridge:"shape=mxgraph.networks.router;fillColor=#29AAE1",NET_Hub:"shape=mxgraph.networks.hub;fillColor=#29AAE1",NET_Modem:"shape=mxgraph.networks.modem;fillColor=#29AAE1",NET_Telephone:"shape=mxgraph.signs.tech.telephone_5;fillColor=#29AAE1",NET_CellPhone:"shape=mxgraph.networks.mobile;fillColor=#29AAE1",NET_SmartPhone:"shape=mxgraph.networks.mobile;fillColor=#29AAE1",NET_Camera:"shape=mxgraph.signs.tech.camera_2;fillColor=#29AAE1",
RackServerRack:"shape=mxgraph.rackGeneral.container;container=1;collapsible=0;childLayout=rack;marginLeft=9;marginRight=9;marginTop=21;marginBottom=22;textColor=#000000;numDisp=off",RackBlank:"shape=mxgraph.rackGeneral.plate;strokeColor=#666666;labelPosition=left;align=right;spacingRight=15;fillColor=#e8e8e8",RackRaidArray:"shape=mxgraph.rack.cisco.cisco_carrier_packet_transport_50;labelPosition=left;align=right;spacingRight=15",RackServer:"shape=mxgraph.rack.oracle.sunfire_x4100;labelPosition=left;align=right;spacingRight=15",
...
EE_TTypeFlipFlop:"shape=mxgraph.electrical.logic_gates.t_type_flip-flop",EE_Plus:"shape=mxgraph.ios7.misc.flagged",EE_Negative:"shape=line",EE_InverterContact:"shape=ellipse",EE_Voltmeter:"shape=mxgraph.electrical.instruments.voltmeter",EE_Ammeter:"shape=mxgraph.electrical.instruments.ampermeter",EE_SineWave:"shape=mxgraph.electrical.waveforms.sine_wave",EE_Sawtooth:"shape=mxgraph.electrical.waveforms.sawtooth",EE_SquareWave:"shape=mxgraph.electrical.waveforms.square_wave",EIChannelBlock:"shape=mxgraph.eip.messageChannel",
EIMessageRouterBlock:"shape=mxgraph.eip.content_based_router",EIMessageTranslatorBlock:"shape=mxgraph.eip.message_translator",EIMessagingBridgeBlock:"shape=mxgraph.eip.messaging_bridge",EIContentBasedRouterBlock:"shape=mxgraph.eip.content_based_router",EIMessageFilterBlock:"shape=mxgraph.eip.message_filter",EIDynamicRouterBlock:"shape=mxgraph.eip.dynamic_router",EIRecipientListBlock:"shape=mxgraph.eip.recipient_list",EISplitterBlock:"shape=mxgraph.eip.splitter",EIAggregatorBlock:"shape=mxgraph.eip.aggregator",
EIResequencerBlock:"shape=mxgraph.eip.resequencer",EIComposedMessageBlock:"shape=mxgraph.eip.composed_message_processor",EIRoutingSlipBlock:"shape=mxgraph.eip.routing_slip",EIProcessManagerBlock:"shape=mxgraph.eip.process_manager",EIEnvelopeWrapperBlock:"shape=mxgraph.eip.envelope_wrapper",EIContentEnricherBlock:"shape=mxgraph.eip.content_enricher",EIContentFilterBlock:"shape=mxgraph.eip.content_filter",EIClaimCheckBlock:"shape=mxgraph.eip.claim_check",EINormalizerBlock:"shape=mxgraph.eip.normalizer",
EIMessagingGatewayBlock:"shape=mxgraph.eip.messaging_gateway",EITransactionalClientBlock:"shape=mxgraph.eip.transactional_client",EIPollingConsumerBlock:"shape=mxgraph.eip.polling_consumer",EIEventDrivenConsumerBlock:"shape=mxgraph.eip.event_driven_consumer",EICompetingConsumersBlock:"shape=mxgraph.eip.competing_consumers",EIMessageDispatcherBlock:"shape=mxgraph.eip.message_dispatcher",EISelectiveConsumerBlock:"shape=mxgraph.eip.selective_consumer",EIServiceActivatorBlock:"shape=mxgraph.eip.service_activator",
EIDetourBlock:"shape=mxgraph.eip.detour",EIWireTapBlock:"shape=mxgraph.eip.wire_tap",EIMessageStoreBlock:"shape=mxgraph.eip.message_store",EISmartProxyBlock:"shape=mxgraph.eip.smart_proxy",EITestMessageBlock:"shape=mxgraph.eip.test_message",EIChannelPurgerBlock:"shape=mxgraph.eip.channel_purger",GCPIconComputeEngineBlock:"strokeColor=none;shape=mxgraph.gcp.compute.compute_engine",GCPIconAppEngineBlock:"strokeColor=none;shape=mxgraph.gcp.compute.app_engine",GCPIconContainerEngineBlock:"strokeColor=none;shape=mxgraph.gcp.compute.container_engine",
GCPIconContainerRegistryBlock:"strokeColor=none;shape=mxgraph.gcp.compute.container_registry",GCPIconCloudFunctionsBlock:"strokeColor=none;shape=mxgraph.gcp.compute.cloud_functions",GCPIconCloudStorageBlock:"strokeColor=none;shape=mxgraph.gcp.storage_databases.cloud_storage",GCPIconCloudSQLBlock:"strokeColor=none;shape=mxgraph.gcp.storage_databases.cloud_sql",GCPIconCloudBigtableBlock:"strokeColor=none;shape=mxgraph.gcp.storage_databases.cloud_bigtable",GCPIconCloudDatastoreBlock:"strokeColor=none;shape=mxgraph.gcp.storage_databases.cloud_datastore",
GCPIconPersistentDiskBlock:"strokeColor=none;shape=mxgraph.gcp.storage_databases.persistent_disk",GCPIconCloudVirtualNetworkBlock:"strokeColor=none;shape=mxgraph.gcp.networking.cloud_virtual_network",GCPIconCloudLoadBalancingBlock:"strokeColor=none;shape=mxgraph.gcp.networking.cloud_load_balancing",GCPIconCloudCDNBlock:"strokeColor=none;shape=mxgraph.gcp.networking.cloud_cdn",GCPIconCloudInterconnectBlock:"strokeColor=none;shape=mxgraph.gcp.networking.cloud_interconnect",GCPIconCloudDNSBlock:"strokeColor=none;shape=mxgraph.gcp.networking.cloud_dns",
GCPIconBigQueryBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.bigquery",GCPIconCloudDataflowBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.cloud_dataflow",GCPIconCloudDataprocBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.cloud_dataproc",GCPIconCloudDatalabBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.cloud_datalab",GCPIconCloudPubSubBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.cloud_pubsub",GCPIconGenomicsBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.genomics",GCPIconCloudMachineLearningServicesBlock:"strokeColor=none;shape=mxgraph.gcp.machine_learning.cloud_machine_learning",
GCPIconVisionAPIBlock:"strokeColor=none;shape=mxgraph.gcp.machine_learning.vision_api",GCPIconSpeechAPIBlock:"strokeColor=none;shape=mxgraph.gcp.machine_learning.speech_api",GCPIconNaturalLanguageAPIBlock:"strokeColor=none;shape=mxgraph.gcp.machine_learning.natural_language_api",GCPIconTranslateAPIBlock:"strokeColor=none;shape=mxgraph.gcp.machine_learning.translation_api",GCPIconStackdriverOverviewBlock:"strokeColor=none;shape=mxgraph.gcp.management_tools.stackdriver",GCPIconMonitoringBlock:"strokeColor=none;shape=mxgraph.gcp.management_tools.monitoring",
GCPIconErrorReportingBlock:"strokeColor=none;shape=mxgraph.gcp.management_tools.error_reporting",GCPIconTraceBlock:"strokeColor=none;shape=mxgraph.gcp.management_tools.trace",GCPIconDebuggerBlock:"strokeColor=none;shape=mxgraph.gcp.management_tools.debugger",GCPIconDeploymentManagerBlock:"strokeColor=none;shape=mxgraph.gcp.management_tools.deployment_manager",GCPIconCloudEndpointsBlock:"strokeColor=none;shape=mxgraph.gcp.management_tools.cloud_endpoints",GCPIconCloudToolsForPowerShellBlock:"strokeColor=none;shape=mxgraph.gcp.developer_tools.cloud_tools_for_powershell",
GCPIconCloudToolsForVisualStudioBlock:"strokeColor=none;shape=mxgraph.gcp.developer_tools.cloud_tools_for_visual_studio",GCPIconCloudIAMBlock:"strokeColor=none;shape=mxgraph.gcp.identity_and_security.cloud_iam",GCPIconGCPLogoBlock:"strokeColor=none;shape=mxgraph.gcp.extras.generic_gcp",GCPIconBlankBlock:"strokeColor=none;shape=mxgraph.gcp.extras.blue_hexagon",fpWall:"",fpWindow:"shape=mxgraph.floorplan.window",fpOpening:"shape=rect",fpDoor:"shape=mxgraph.floorplan.doorLeft;flipV=1",fpDoubleDoor:"shape=mxgraph.floorplan.doorDouble;flipV=1",
fpStairs:"shape=mxgraph.floorplan.stairs;direction=north",fpStairsDirectional:"shape=mxgraph.floorplan.stairs;direction=north",fpDeskLongSegment:"shape=rect",fpDeskShortSegment:"absoluteArcSize=1;arcSize=6;rounded=1",fpDeskLargeCornerSegment:"shape=mxgraph.floorplan.desk_corner",fpCubiclePanel:"shape=mxgraph.floorplan.wall;wallThickness=3",fpCubicleWorkstation:"shape=mxgraph.floorplan.wallU;wallThickness=3",fpCubicleCorner5x5:"shape=mxgraph.floorplan.wallCorner;wallThickness=3",fpCubicleCorner6x6:"shape=mxgraph.floorplan.wallCorner;wallThickness=3",
fpCubicleCorner8x8:"shape=mxgraph.floorplan.wallCorner;wallThickness=3",fpCubicleCorner8x6:"shape=mxgraph.floorplan.wallCorner;wallThickness=3",fpCubicleCornerOpen6x4:"shape=mxgraph.floorplan.wallCorner;wallThickness=3",fpCubicleDouble14x8:"shape=mxgraph.floorplan.wallU;wallThickness=3",fpCubicleEnclosed11x9:"shape=mxgraph.floorplan.wallU;wallThickness=3",fpTableConferenceOval:"shape=ellipse",fpTableConferenceBoat:"absoluteArcSize=1;arcSize=6;rounded=1",fpTableConferenceRectangle:"absoluteArcSize=1;arcSize=6;rounded=1",
fpTableDiningRound:"shape=ellipse",fpTableDiningSquare:"absoluteArcSize=1;arcSize=6;rounded=1",fpChairOffice:"shape=mxgraph.floorplan.office_chair",fpChairExecutive:"shape=mxgraph.floorplan.office_chair",fpChairLobby:"shape=mxgraph.floorplan.office_chair",fpChairDining:"shape=mxgraph.floorplan.chair",fpChairBarstool:"shape=ellipse",fpCabinetBasic:"absoluteArcSize=1;arcSize=6;rounded=1",fpCabinetDoubleWide:"absoluteArcSize=1;arcSize=6;rounded=1",fpCabinetDoubleWithShelves:"absoluteArcSize=1;arcSize=6;rounded=1",
fpCabinetShelvesBasic:"absoluteArcSize=1;arcSize=6;rounded=1",fpCabinetShelvesDouble:"absoluteArcSize=1;arcSize=6;rounded=1",fpCabinetBasicWithShelves:"absoluteArcSize=1;arcSize=6;rounded=1",fpCabinetsAboveDeskShelves:"absoluteArcSize=1;arcSize=6;rounded=1",fpRestroomToiletPrivate:"shape=mxgraph.floorplan.toilet",fpRestroomToiletPublic:"shape=mxgraph.floorplan.toilet",fpRestroomBathtub:"shape=mxgraph.floorplan.bathtub;direction=south",fpRestroomShower:"shape=mxgraph.floorplan.shower;flipH=1",fpRestroomPedastalSink:"shape=mxgraph.floorplan.sink_1",
fpRestroomCountertop:"absoluteArcSize=1;arcSize=6;rounded=1",fpRestroomMirror:"shape=line;strokeWidth=3",fpBedDouble:"shape=mxgraph.floorplan.bed_double",fpBedSingle:"shape=mxgraph.floorplan.bed_single",fpBedQueen:"shape=mxgraph.floorplan.bed_double",fpBedKing:"shape=mxgraph.floorplan.bed_double",fpBedDoubleWithTrundle:"shape=mxgraph.floorplan.bed_double",fpBedBunk:"shape=mxgraph.floorplan.bed_double",fpBedBassinet:"shape=mxgraph.pid.fittings.compensator",fpApplianceWasher:"",fpApplianceDryer:"",
fpApplianceWaterHeater:"shape=ellipse",fpApplianceStoveOven:"shape=mxgraph.floorplan.range_1",fpStoveOvenSixBurner:"shape=mxgraph.floorplan.range_2",fpApplianceDishwasher:"",fpKitchenSink:"shape=mxgraph.floorplan.sink_2",fpKitchenDoubleSink:"shape=mxgraph.floorplan.sink_double",fpKitchenCountertop:"absoluteArcSize=1;arcSize=6;rounded=1",fpKitchenCountertopCorner:"shape=mxgraph.floorplan.desk_corner",fpCouchLoveSeat:"shape=mxgraph.floorplan.couch",fpCouchSofa:"shape=mxgraph.floorplan.couch",fpCouchOttoman:"absoluteArcSize=1;arcSize=6;rounded=1",
fpMiscDesktopComputer:"shape=mxgraph.floorplan.workstation",fpMiscLaptopComputer:"shape=mxgraph.floorplan.laptop",fpComputerMonitor:"shape=mxgraph.floorplan.flat_tv",fpCRTTelevision:"shape=mxgraph.floorplan.flat_tv",fpMiscIndoorPlant:"shape=mxgraph.floorplan.plant",fpPiano:"shape=mxgraph.floorplan.piano",PEAxialCompressor:"shape=mxgraph.pid.compressors.centrifugal_compressor_-_turbine_driven",PECentrifugalCompressor:"shape=mxgraph.pid.compressors.centrifugal_compressor",PECentrifugalCompressor2:"shape=mxgraph.pid.compressors.centrifugal_compressor_-_turbine_driven",
PEReciprocationCompressor:"shape=mxgraph.pid.compressors.reciprocating_compressor",PERotaryCompressorBlock:"shape=mxgraph.pid.compressors.rotary_compressor",PERotaryCompressor2Block:"shape=mxgraph.pid.compressors.compressor_and_silencers",PEConveyorBlock:"shape=mxgraph.pid2misc.conveyor",PEElevator1Block:"shape=mxgraph.pid.misc.bucket_elevator;flipH=1",PEAgitatorMixerBlock:"shape=mxgraph.pid.agitators.agitator_(propeller)",PEDrumBlock:"shape=mxgraph.pid.vessels.drum_or_condenser",PETankEquipmentBlock:"shape=mxgraph.pid.vessels.tank",
...
PEVesselBlock:"shape=rect",PEOpenTankBlock:"shape=mxgraph.pid.vessels.container,_tank,_cistern",PEOpenTopTank:"shape=mxgraph.pid.vessels.container,_tank,_cistern",PEClosedTankBlock:"shape=rect",PEStorageSphereBlock:"shape=mxgraph.pid.vessels.storage_sphere",PEColumnBlock:"shape=mxgraph.pid.vessels.pressurized_vessel",PEBagBlock:"shape=mxgraph.pid.vessels.bag",PEGasCylinderBlock:"shape=mxgraph.pid.vessels.gas_bottle",PEGasHolderBlock:"shape=mxgraph.pid.vessels.gas_holder",PEClarifierBlock:"shape=mxgraph.pid.vessels.bunker_(conical_bottom)",
PETrayColumnBlock:"shape=mxgraph.pid2misc.column;columnType=tray",PEReactionVesselBlock:"shape=mxgraph.pid.vessels.reactor",PEBin:"shape=mxgraph.pid.vessels.tank_(conical_bottom)",PEDomeRoofTank:"shape=mxgraph.pid.vessels.tank_(dished_roof)",PEConeRoofTank:"shape=mxgraph.pid.vessels.tank_(conical_roof)",PEBoilerBlock:"shape=mxgraph.pid.misc.boiler_(dome)",PEEquipmentBoilerBlock:"shape=mxgraph.pid.misc.boiler_(dome)",PEReboilerBlock:"shape=mxgraph.pid.heat_exchangers.reboiler",PECondenserBlock:"shape=mxgraph.pid.heat_exchangers.heat_exchanger_(straight_tubes)",
PEEquipmentCondenserBlock:"shape=mxgraph.pid.heat_exchangers.condenser",PECoolingTowerBlock:"shape=mxgraph.pid.misc.cooling_tower",PEHeatExchangerBlock:"shape=mxgraph.pid.heat_exchangers.shell_and_tube_heat_exchanger_1",PEHairpinExchangerBlock:"shape=mxgraph.pid.heat_exchangers.hairpin_exchanger",PEPlateAndFrameHeatExchangerBlock:"shape=mxgraph.pid.heat_exchangers.plate_and_frame_heat_exchanger",PESpiralHeatExchanger:"shape=mxgraph.pid.heat_exchangers.spiral_heat_exchanger",PEUTubeHeatExchangerBlock:"shape=mxgraph.pid.heat_exchangers.u-tube_heat_exchanger",
PEDoublePipeHeatBlock:"shape=mxgraph.pid.heat_exchangers.double_pipe_heat_exchanger",PEShellAndTubeHeat1Block:"shape=mxgraph.pid.heat_exchangers.shell_and_tube_heat_exchanger_1",PEShellAndTubeHeat2Block:"shape=mxgraph.pid.heat_exchangers.shell_and_tube_heat_exchanger_2",PEShellAndTubeHeat3Block:"shape=mxgraph.pid.heat_exchangers.shell_and_tube_heat_exchanger_1;direction=north",PESinglePassHeatBlock:"shape=mxgraph.pid.heat_exchangers.single_pass_heat_exchanger",PEHeaterBlock:"shape=mxgraph.pid.heat_exchangers.heater",
PEEjectorInjectorBlock:"shape=mxgraph.pid.fittings.injector",PECompressorTurbineBlock:"shape=mxgraph.pid.engines.turbine;flipH=1",PETripleFanBlades2Block:"shape=mxgraph.pid2misc.fan;fanType=common",PEFanBlades2Block:"shape=mxgraph.pid2misc.fan;fanType=common",PECentrifugalPumpBlock:"shape=mxgraph.pid.pumps.centrifugal_pump_1",PECentrifugalPump:"shape=mxgraph.pid.pumps.centrifugal_pump_1",PECentrifugalPump2:"shape=mxgraph.pid.pumps.centrifugal_pump_2",PECentrifugalPump3:"shape=mxgraph.pid.pumps.centrifugal_pump_1;flipH=1",
PEGearPumpBlock:"shape=mxgraph.pid.pumps.gear_pump",PEHorizontalPump:"shape=mxgraph.pid.pumps.horizontal_pump",PEProgressiveCavityPump:"shape=mxgraph.pid.pumps.cavity_pump;flipH=1;flipV=1",PEScrewPump:"shape=mxgraph.pid.pumps.screw_pump",PEScrewPump2:"shape=mxgraph.pid.pumps.screw_pump_2;flipH=1",PESumpPump:"shape=mxgraph.pid.pumps.sump_pump",PEVacuumPump:"shape=mxgraph.pid.pumps.vacuum_pump",PEVerticalPump:"shape=mxgraph.pid.pumps.vertical_pump",PEVerticalPump2:"shape=mxgraph.pid.pumps.vertical_pump",
PEIndicatorBlock:"shape=mxgraph.pid2inst.discInst;mounting=room",PEIndicator2Block:"shape=mxgraph.pid2inst.indicator;mounting=room;indType=inst",PEIndicator3Block:"shape=mxgraph.pid2inst.discInst;mounting=field",PEIndicator4Block:"shape=mxgraph.pid2inst.indicator;mounting=field;indType=inst",PESharedIndicatorBlock:"shape=mxgraph.pid2inst.sharedCont;mounting=room",PESharedIndicator2Block:"shape=mxgraph.pid2inst.indicator;mounting=room;indType=ctrl",PEProgrammableIndicatorBlock:"shape=mxgraph.pid2inst.progLogCont;mounting=room",
PEGateValveBlock:"shape=mxgraph.pid2valves.valve;valveType=gate",PEGlobeValveBlock:"shape=mxgraph.pid2valves.valve;valveType=globe",PEControlValveBlock:"shape=mxgraph.pid2valves.valve;valveType=gate;actuator=diaph",PENeedleValveBlock:"shape=mxgraph.pid2valves.valve;valveType=needle",PEButterflyValve2Block:"shape=mxgraph.pid2valves.valve;valveType=butterfly",PEDiaphragmBlock:"shape=mxgraph.pid2valves.valve;valveType=ball",PECheckValveBlock:"shape=mxgraph.pid2valves.valve;valveType=check",PECheckValve2Block:"shape=mxgraph.pid2valves.valve;valveType=check",
...
VennPlainColor2:"shape=ellipse;fillOpacity=35",VennPlainColor3:"shape=ellipse;fillOpacity=35",VennPlainColor4:"shape=ellipse;fillOpacity=35",VennPlainColor5:"shape=ellipse;fillOpacity=35",VennPlainColor6:"shape=ellipse;fillOpacity=35",VennPlainColor7:"shape=ellipse;fillOpacity=35",VennPlainColor8:"shape=ellipse;fillOpacity=35",iOS7DeviceiPhone5Portrait:"shape=mxgraph.ios.iPhone;bgStyle=bgGreen",iOS7DeviceiPhone5Landscape:"shape=mxgraph.ios.iPhone;bgStyle=bgGreen",iOS7DeviceiPadPortrait:"shape=mxgraph.ios.iPad;bgStyle=bgGreen",
iOS7DeviceiPadLandscape:"shape=mxgraph.ios.iPad;bgStyle=bgGreen",iOS7DeviceiPhone6Portrait:"shape=mxgraph.ios.iPhone;bgStyle=bgGreen",iOS7DeviceiPhone6Landscape:"shape=mxgraph.ios.iPhone;bgStyle=bgGreen",iOS7DeviceiPhone6PlusPortrait:"shape=mxgraph.ios.iPhone;bgStyle=bgGreen",iOS7DeviceiPhone6PlusLandscape:"shape=mxgraph.ios.iPhone;bgStyle=bgGreen",iOS7StatusBariPhone:"shape=mxgraph.ios7ui.appBar",iOS7iPhoneKeyboard:"shape=mxgraph.ios7.misc.keyboard_(letters)",iOS7StatusBariPad:"shape=mxgraph.ios7ui.appBar",
iOS7iPadKeyboard:"shape=mxgraph.ios7.misc.keyboard_(letters)",iOS7ProgressBar:"shape=mxgraph.ios7ui.downloadBar",iOS7Slider:"shape=mxgraph.ios7ui.searchBox",iOS7SearchBar:"shape=mxgraph.ios7ui.searchBox",iOS7Button:"",iOS7TextField:"",iOS7TextView:"",iOS7Toggle:"shape=mxgraph.ios7ui.onOffButton;buttonState=on;strokeColor=#38D145;strokeColor2=#aaaaaa;fillColor=#38D145;fillColor2=#ffffff",iOS7Stepper:"shape=mxgraph.ios7.misc.adjust;fillColor=#ffffff;gradientColor=none",iOS7PageControls:"shape=mxgraph.ios7ui.pageControl;fillColor=#666666;strokeColor=#bbbbbb",
iOS7Block:"","iOS7IconArrow left":"shape=mxgraph.ios7.misc.left",iOS7IconArrow:"shape=mxgraph.ios7.misc.right","iOS7IconArrow up":"shape=mxgraph.ios7.misc.up","iOS7IconArrow down":"shape=mxgraph.ios7.misc.down",iOS7IconWifi:"shape=mxgraph.ios7.icons.wifi",iOS7IconBluetooth:"shape=mxgraph.ios7.icons.bluetooth",iOS7IconBattery:"shape=mxgraph.ios7.icons.battery",iOS7IconSiri:"shape=mxgraph.ios7.icons.microphone",iOS7IconCheck:"shape=mxgraph.ios7.icons.select",iOS7IconCreate:"shape=mxgraph.ios7.icons.add",
...
Image_ipad_mark_as_read:"shape=ellipse",Image_ipad_pin_green:"shape=mxgraph.ios.iPin;fillColor2=#00dd00;fillColor3=#004400;strokeColor=#006600",Image_ipad_pin_red:"shape=mxgraph.ios.iPin;fillColor2=#dd0000;fillColor3=#440000;strokeColor=#660000",Image_ipad_radio_off:"shape=ellipse",Image_ipad_checkbox_off:"absoluteArcSize=1;arcSize=6;rounded=1",Image_ipad_indicator:"absoluteArcSize=1;arcSize=6;rounded=1;fillColor=#e8878E;gradientColor=#BD1421;strokeColor=#ffffff",Image_iphone_iphone_4:"shape=mxgraph.ios.iPhone;bgStyle=bgGreen",
Image_iphone_bg_black:"shape=rect",Image_iphone_bg_gray:"shape=rect",Image_iphone_bg_stripe_drk:"shape=mxgraph.ios.iBgStriped;strokeColor=#18211b;fillColor=#5D7585;strokeColor2=#657E8F",Image_iphone_bg_stripe_lt:"shape=mxgraph.ios.iBgStriped;strokeColor=#18211b;fillColor=#5D7585;strokeColor2=#657E8F",Image_iphone_bg_white:"shape=rect",Image_iphone_top_bar_app:"shape=mxgraph.ios.iAppBar",Image_iphone_top_bar_home:"shape=mxgraph.ios.iTopBar2;opacity=50;fillColor=#999999;strokeColor=#cccccc;strokeWidth=1",
Image_iphone_bar_top:"shape=rect",Image_iphone_bar_semi_trans_black:"shape=rect",Image_iphone_bar_semi_trans_blue:"shape=rect",Image_iphone_search:"shape=mxgraph.mockup.forms.searchBox;mainText=;flipH=1",Image_iphone_gray_grad_list:"absoluteArcSize=1;arcSize=6;rounded=1",Image_iphone_alpha_list:"shape=mxgraph.ios.iAlphaList",Image_iphone_button_black:"absoluteArcSize=1;arcSize=6;rounded=1",Image_iphone_button_blue:"absoluteArcSize=1;arcSize=6;rounded=1",Image_iphone_button_grayblue:"absoluteArcSize=1;arcSize=6;rounded=1",
Image_iphone_button_red:"absoluteArcSize=1;arcSize=6;rounded=1",Image_iphone_button_lg_light:"absoluteArcSize=1;arcSize=6;rounded=1",Image_iphone_button_lg_dark:"absoluteArcSize=1;arcSize=6;rounded=1",Image_iphone_button_lg_green:"absoluteArcSize=1;arcSize=6;rounded=1",Image_iphone_button_lg_red:"absoluteArcSize=1;arcSize=6;rounded=1",Image_iphone_button_lg_yellow:"absoluteArcSize=1;arcSize=6;rounded=1",Image_iphone_button_xl_green:"absoluteArcSize=1;arcSize=6;rounded=1",Image_iphone_back_button:"shape=mxgraph.ios.iButtonBack;strokeColor=#444444;buttonText=;fillColor=#dddddd;fillColor2=#3D5565",
Image_iphone_prev_next:"shape=mxgraph.ios.iPrevNext;strokeColor=#444444;fillColor=#dddddd;fillColor2=#3D5565;fillColor3=#ffffff",Image_iphone_sort_handle:"shape=mxgraph.ios7.icons.options",Image_iphone_slider:"shape=mxgraph.ios.iSlider;barPos=60",Image_iphone_dropdown:"shape=mxgraph.ios.iComboBox;buttonText=;fillColor=#dddddd;fillColor2=#3D5565",Image_iphone_email_name:"absoluteArcSize=1;arcSize=6;rounded=1",Image_iphone_switch_off:"shape=mxgraph.android.switch_off;fillColor=#666666",Image_iphone_keyboard_button_blue:"absoluteArcSize=1;arcSize=6;rounded=1",
...
Image_iphone_arrow:"shape=mxgraph.ios7.misc.more",Image_iphone_checkmark:"shape=mxgraph.ios7.misc.check",Image_iphone_check_off:"shape=ellipse",Image_iphone_location_dot:"shape=ellipse",Image_iphone_mark_as_read:"shape=ellipse",Image_iphone_pin_green:"shape=mxgraph.ios.iPin;fillColor2=#00dd00;fillColor3=#004400;strokeColor=#006600",Image_iphone_pin_red:"shape=mxgraph.ios.iPin;fillColor2=#dd0000;fillColor3=#440000;strokeColor=#660000",Image_iphone_radio_off:"shape=ellipse",Image_iphone_checkbox_off:"absoluteArcSize=1;arcSize=6;rounded=1",
Image_iphone_indicator:"absoluteArcSize=1;arcSize=6;rounded=1;fillColor=#e8878E;gradientColor=#BD1421;strokeColor=#ffffff",Image_iphone_thread_count:"absoluteArcSize=1;arcSize=6;rounded=1"},A=function(a,d,f){f.includes(a)||f.push(a);if(a in d){var b=d[a];b.id=a;if(null!=b.Members)for(var h in b.Members)f=A(h,d,f)}return f};EditorUi.prototype.pasteLucidChart=function(a,d,f,b){var h=this.editor.graph;h.getModel().beginUpdate();try{var g=function(a,b){var d=null!=b.Endpoint1.Block?c[b.Endpoint1.Block]:
null,g=null!=b.Endpoint2.Block?c[b.Endpoint2.Block]:null,f;f=new mxCell("",new mxGeometry(0,0,100,100),"html=1;");f.geometry.relative=!0;f.edge=!0;x(f,a);var k=q(a).Properties,l=null!=k?k.TextAreas:a.TextAreas;if(null!=l){for(var m=0;null!=l["t"+m];){var n=l["t"+m];f=u(n,f);m++}for(m=1;null!=l["m"+m];)n=l["m"+m],f=u(n,f,a),m++;null!=l.Text&&(f=u(l,f,a));l=null!=k?k.TextAreas:a.TextAreas;null!=l.Message&&(f=u(l.Message,f,a))}null==d&&null!=b.Endpoint1&&f.geometry.setTerminalPoint(new mxPoint(Math.round(.6*
b.Endpoint1.x),Math.round(.6*b.Endpoint1.y)),!0);null==g&&null!=b.Endpoint2&&f.geometry.setTerminalPoint(new mxPoint(Math.round(.6*b.Endpoint2.x),Math.round(.6*b.Endpoint2.y)),!1);e.push(h.addCell(f,null,null,d,g))},e=[],c={},m=[],l=[],p=0;if(null!=a.Groups)for(var n in a.Groups){var k=a.Groups[n];k.id=n;if(1==k.Hidden&&null!=k.Members){l.includes(n)||l.push(n);for(var t in k.Members)l=A(t,a.Groups,l)}}if(null!=a.Blocks)for(n in a.Blocks)k=a.Blocks[n],k.id=n,l.includes(n)||(c[k.id]=z(k),m.push(k));
else for(p=0;p<a.Objects.length;p++)k=a.Objects[p],k.IsBlock&&null!=k.Action&&null!=k.Action.Properties&&(c[k.id]=z(k)),m.push(k);m.sort(function(a,b){a=q(a);b=q(b);return null!=a.Properties&&null!=b.Properties?a.Properties.ZOrder-b.Properties.ZOrder:0});for(p=0;p<m.length;p++){var k=m[p],r=c[k.id];null!=r?e.push(h.addCell(r)):k.IsLine&&null!=k.Action&&null!=k.Action.Properties&&g(k,k.Action.Properties)}if(null!=a.Lines)for(n in a.Lines)l.includes(n)||(k=a.Lines[n],g(k,k));if(b&&null!=d&&null!=f){h.isGridEnabled()&&
(d=h.snap(d),f=h.snap(f));var w=h.getBoundingBoxFromGeometry(e,!0);null!=w&&h.moveCells(e,d-w.x,f-w.y)}h.setSelectionCells(e)}finally{h.getModel().endUpdate()}h.isSelectionEmpty()||(h.scrollCellToVisible(h.getSelectionCell()),null!=this.hoverIcons&&this.hoverIcons.update(h.view.getState(h.getSelectionCell())))}})();