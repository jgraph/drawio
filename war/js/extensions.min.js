(function(){function t(a){var d=null!=a.Text?a.Text:null!=a.Value?a.Value:a.Lane_0;null==d&&null!=a.State?null!=a.State.t&&(d=a.State):null==d&&null!=a.Note&&null!=a.Note.t&&(d=a.Note);null==d&&null!=a.TextAreas&&null!=a.TextAreas.Text&&null!=a.TextAreas.Text.Value&&null!=a.TextAreas.Text.Value.t&&(d=a.TextAreas.Text.Value);if(null!=d){if(null!=d.t)return d.t=d.t.replace(/</g,"&lt;"),d.t=d.t.replace(/>/g,"&gt;"),d.t;if(null!=d.Value&&null!=d.Value.t)return d.Value.t=d.Value.t.replace(/</g,"&lt;"),
d.Value.t=d.Value.t.replace(/>/g,"&gt;"),d.Value.t}return""}function u(a){return null!=a.Action?a.Action:a}function q(a){if(null!=a.Text){if(null!=a.Text.m)return a.Text.m}else if(null!=a.TextAreas&&null!=a.TextAreas.Text&&null!=a.TextAreas.Text.Value&&null!=a.TextAreas.Text.Value.m)return a.TextAreas.Text.Value.m;return null}function y(a,d){var f=u(d);if(null!=f){var c=x[f.Class]+";";null!=c&&(a.style+=c);c=null!=f.Properties?f.Properties:f;if(null!=c){a.value=t(c);var m=a.style,h;a:{h=q(c);if(null!=
h)for(var b=0;b<h.length;){var g=h[b];if("s"==g.n&&null!=g.v){h="fontSize="+Math.round(.6*g.v)+";";break a}b++}h="fontSize=10;"}a:{b=q(c);if(null!=b)for(g=0;g<b.length;){var e=b[g];if("c"==e.n&&null!=e.v){b=e.v;"#"!=b.charAt(0)&&(b="#"+b);b=b.substring(0,7);b=mxConstants.STYLE_FONTCOLOR+"="+b+";";break a}g++}b=""}h+=b;a:{b=q(c);if(null!=b){var g=0,n=!1;if(null!=b)for(e=0;!n&&e<b.length;){var l=b[e];"b"==l.n&&null!=l.v&&l.v&&(n=!0,g+=1);e++}n=!1;if(null!=b)for(e=0;!n&&e<b.length;)l=b[e],"i"==l.n&&
null!=l.v&&l.v&&(n=!0,g+=2),e++;n=!1;if(null!=b)for(e=0;!n&&e<b.length;)l=b[e],"u"==l.n&&null!=l.v&&l.v&&(n=!0,g+=4),e++;if(0<g){b="fontStyle="+g+";";break a}}b=""}h+=b;b=q(c);g=!1;if(null!=b)for(e=0;!g&&e<b.length;)l=b[e],"a"==l.n&&null!=l.v&&(g=!0,a.style+="align="+l.v+";"),e++;b=g?"":p(mxConstants.STYLE_ALIGN,c.TextAlign,"center");h+=b;a:{b=q(c);if(null!=b&&null!=b)for(g=0;g<b.length;){e=b[g];if("il"==e.n&&null!=e.v){b="spacingLeft="+e.v+";";break a}g++}b=""}h+=b;a:{b=q(c);if(null!=b)for(g=0;g<
b.length;){e=b[g];if("ir"==e.n&&null!=e.v){b="spacingRight="+e.v+";";break a}g++}b=""}h+=b;a:{b=q(c);if(null!=b)for(g=0;g<b.length;){e=b[g];if("mt"==e.n&&null!=e.v){b="spacingTop="+e.v+";";break a}g++}b=""}h+=b;a:{b=q(c);if(null!=b)for(g=0;g<b.length;){e=b[g];if("mb"==e.n&&null!=e.v){b="spacingBottom="+e.v+";";break a}g++}b=""}h+=b;b="number"===typeof c.InsetMargin?"spacing="+parseInt(c.InsetMargin)+";":"";h+=b;b=null!=c.Text_VAlign&&"string"===typeof c.Text_VAlign?"verticalAlign="+c.Text_VAlign+
";":p(mxConstants.STYLE_VERTICAL_ALIGN,c.TextVAlign,"middle");h+=b;b=D.includes(f.Class)?"Venn"==f.Class.substring(0,4)?p(mxConstants.STYLE_STROKECOLOR,c.FillColor.substring(0,7),"#FFFFFF"):"":0==c.LineWidth?mxConstants.STYLE_STROKECOLOR+"=none;":p(mxConstants.STYLE_STROKECOLOR,c.LineColor.substring(0,7),"#000000");h+=b;b="";E.includes(f.Class)||(b+=p(mxConstants.STYLE_OPACITY,c.Opacity,"100"));"string"===typeof c.LineColor&&7<c.LineColor.length&&(g="0x"+c.LineColor.substring(c.LineColor.length-2,
c.LineColor.length),b+="strokeOpacity="+Math.round(parseInt(g)/2.55)+";");"string"===typeof c.FillColor&&7<c.FillColor.length&&(g="0x"+c.FillColor.substring(c.FillColor.length-2,c.FillColor.length),b+="fillOpacity="+Math.round(parseInt(g)/2.55)+";");h+=b;a:{if(null!=c.Rounding&&!F.includes(f.Class)){if(0<c.Rounding){b="rounded=1;absoluteArcSize=1;arcSize="+.6*c.Rounding+";";break a}}else if(null==c.Rounding&&G.includes(f.Class)){b="rounded=1;absoluteArcSize=1;arcSize=8;";break a}b=""}h+=b;a:{if(null!=
c.Rotation&&(b=mxUtils.toDegree(parseFloat(c.Rotation)),"AdvancedSwimLaneBlockRotated"==f.Class?(b+=90,a.geometry.rotate90()):H.includes(f.Class)&&(b-=90,a.geometry.rotate90(),a.geometry.rotate90(),a.geometry.rotate90()),0!=b)){b="rotation="+b+";";break a}b=""}g=c.FlipX?"flipH=1;":"";h=h+b+g;b=c.FlipY?"flipV=1;":"";g=null!=c.Shadow?mxConstants.STYLE_SHADOW+"=1;":"";h=h+b+g;a:{if(null!=c.FillColor&&!I.includes(f.Class))if("object"===typeof c.FillColor){if(null!=c.FillColor.cs&&1<c.FillColor.cs.length){b=
p(mxConstants.STYLE_FILLCOLOR,c.FillColor.cs[0].c.substring(0,7))+p(mxConstants.STYLE_GRADIENTCOLOR,c.FillColor.cs[1].c.substring(0,7));break a}}else{b="string"===typeof c.FillColor?p(mxConstants.STYLE_FILLCOLOR,c.FillColor.substring(0,7),"#FFFFFF"):p(mxConstants.STYLE_FILLCOLOR,"none");break a}b=""}g="dashed"==c.StrokeStyle?"dashed=1;":"dotted"==c.StrokeStyle?"dashed=1;dashPattern=1 4;":"";h=h+b+g+p(mxConstants.STYLE_STROKEWIDTH,.6*parseFloat(c.LineWidth),"1");f="ImageSearchBlock2"==f.Class?"image="+
c.URL+";":"";a.style=m+(h+f);if(a.edge){a.style+="rounded=1;arcSize=6;";if("diagonal"!=c.Shape)if(null!=c.ElbowPoints)for(a.geometry.points=[],f=0;f<c.ElbowPoints.length;f++)a.geometry.points.push(new mxPoint(Math.round(.6*c.ElbowPoints[f].x+0),Math.round(.6*c.ElbowPoints[f].y+0)));else"elbow"==c.Shape?a.style=null!=c.Endpoint1.Block&&null!=c.Endpoint1.Block?a.style+"edgeStyle=orthogonalEdgeStyle;":a.style+"edgeStyle=elbowEdgeStyle;":null!=c.Endpoint1.Block&&null!=c.Endpoint1.Block&&(a.style+="edgeStyle=orthogonalEdgeStyle;",
"curve"==c.Shape&&(a.style+="curved=1;"));null!=c.Endpoint1.Style&&(a.style+="startArrow="+z[c.Endpoint1.Style]+";");null!=c.Endpoint2.Style&&(a.style+="endArrow="+z[c.Endpoint2.Style].replace(/startSize/g,"endSize")+";");A(a,c.Endpoint1,!0);A(a,c.Endpoint2,!1)}}}}function B(a){var d=u(a).Properties.BoundingBox;null!=a.Class&&"AWS"===a.Class.substring(0,3)&&(d.h-=20);v=new mxCell("",new mxGeometry(Math.round(.6*d.x+0),Math.round(.6*d.y+0),Math.round(.6*d.w),Math.round(.6*d.h)),"html=1;whiteSpace=wrap;");
v.vertex=!0;y(v,a);return v}function w(a,d,f){f=2*(parseFloat(a.Location)-.5);a=new mxCell(t(a),new mxGeometry(f,0,0,0),"text;html=1;resizable=0;labelBackgroundColor=#ffffff;");a.geometry.relative=!0;a.vertex=!0;d.insert(a);return d}function p(a,d,f,c){null!=d&&null!=c&&(d=c(d));return null!=d&&d!=f?a+"="+d+";":""}function A(a,d,f){null!=d&&null!=d.LinkX&&null!=d.LinkY&&(a.style+=(f?"exitX":"entryX")+"="+d.LinkX+";"+(f?"exitY":"entryY")+"="+d.LinkY+";"+(f?"exitPerimeter":"entryPerimeter")+"=0;")}
function J(a){var d=u(a).Properties,f=d.BoundingBox,c=.6*f.w,m=.6*f.h;v=new mxCell("",new mxGeometry(Math.round(.6*f.x+0),Math.round(.6*f.y+0),Math.round(c),Math.round(m)),"html=1;whiteSpace=wrap;");v.vertex=!0;switch(a.Class){case "BraceNoteBlock":v.style="strokeColor=none;fillColor=none;",f=new mxCell("",new mxGeometry(0,0,.125*m,m),"shape=curlyBracket;rounded=1;flipH=1;"),f.vertex=!0,v.insert(f),c=new mxCell("",new mxGeometry(.125*m,0,c-.125*m,m),"strokeColor=none;fillColor=none;"),c.vertex=!0,
c.value=t(d),v.insert(c),u(a)}return v}var F=["GSDFDProcessBlock","RoundedRectangleContainerBlock","UI2ButtonBlock","UMLStateBlock"],G=["ProcessBlock","UMLActivationBlock"],D="VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8 UMLEndBlock DefaultTextBlockNew".split(" "),I=
"AWSAndroidBlock3 AWSiOSBlock3 AWSJavaBlock3 AWSJavaScript AWSNetBlock3 AWSNodeJSBlock3 AWSPHPBlock3 AWSPythonBlock3 AWSRubyBlock3 AWSXamarin AWSCLIBlock3 AWSEclipseToolkitBlock3 AWSVisualStudioToolkitBlock3 AWSWindowsPowershellToolkitBlock3 DefaultTextBlock RectangleContainerBlock UMLStartBlock UMLEndBlock DefaultTextBlockNew UMLHForkJoinBlock".split(" "),E="VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8".split(" "),
H=["AEUSBBlock","AGSCutandpasteBlock","iOSDeviceiPadLandscape","iOSDeviceiPadProLandscape"],z={None:"none",Arrow:"block;endFill=1","Hollow Arrow":"block;endFill=0","Open Arrow":"open;","CFN ERD Zero Or More Arrow":"ERzeroToMany;startSize=10","CFN ERD One Or More Arrow":"ERoneToMany;startSize=10","CFN ERD Many Arrow":"ERmany;startSize=10","CFN ERD Exactly One Arrow":"ERmandOne;startSize=10","CFN ERD Zero Or One Arrow":"ERzeroToOne;startSize=10","CFN ERD One Arrow":"ERone;startSize=16",Generalization:"block;endFill=0;startSize=12",
"Big Open Arrow":"open;startSize=10",Asynch1:"openAsync;flipH=1;startSize=10",Asynch2:"openAsync;startSize=10",Aggregation:"diamond;endFill=0;startSize=16",Composition:"diamond;endFill=1;startSize=16",BlockEnd:"none;endFill=1;startSize=16"},x={DefaultTextBlockNew:"text;strokeColor=none;fillColor=none",DefaultTextBlock:"text;strokeColor=none;fillColor=none",DefaultSquareBlock:"",DefaultNoteBlock:"shape=note;size=15",DefaultNoteBlockV2:"shape=note;size=15",HotspotBlock:"strokeColor=none;opacity=50",
...
iOSButton:"",iOSSegmentedControl:"mxCompositeShape",iOSStepper:"shape=mxgraph.ios7.misc.adjust",iOSToggle:"shape=mxgraph.ios7ui.onOffButton;buttonState=on;strokeColor2=#aaaaaa;fillColor2=#ffffff",iOSSlider:"shape=mxgraph.ios7ui.slider;barPos=20;strokeColor2=#a0a0a0",iOSProgressBar:"shape=mxgraph.ios.iCloudProgressBar;barPos=20",iOSPageControls:"shape=mxgraph.ios.iCloudProgressBar;barPos=20",iOSSearchBar:"mxCompositeShape",iOSNavBar:"mxCompositeShape",iOSTabs:"mxCompositeShape",iOSUniversalKeyboard:"shape=mxgraph.ios.iKeybLett",
...
SMAthletics:"mxCompositeShape",SMLogin:"mxCompositeShape",SMPrint:"mxCompositeShape",SMScript:"mxCompositeShape",SMSearch:"mxCompositeShape",SMSettings:"mxCompositeShape",SMSitemap:"mxCompositeShape",SMSuccess:"mxCompositeShape",SMVideo:"mxCompositeShape",SMAudio:"mxCompositeShape",SMBlog:"mxCompositeShape",SMCalendar:"mxCompositeShape",SMChart:"mxCompositeShape",SMCloud:"mxCompositeShape",SMDocument:"mxCompositeShape",SMDownload:"mxCompositeShape",SMError:"mxCompositeShape",SMForm:"mxCompositeShape",
...
Image_iphone_mark_as_read:"shape=ellipse",Image_iphone_pin_green:"shape=mxgraph.ios.iPin;fillColor2=#00dd00;fillColor3=#004400;strokeColor=#006600",Image_iphone_pin_red:"shape=mxgraph.ios.iPin;fillColor2=#dd0000;fillColor3=#440000;strokeColor=#660000",Image_iphone_radio_off:"shape=ellipse",Image_iphone_checkbox_off:"",Image_iphone_indicator:"fillColor=#e8878E;gradientColor=#BD1421;strokeColor=#ffffff",Image_iphone_thread_count:""},C=function(a,d,f){f.includes(a)||f.push(a);if(a in d){var c=d[a];c.id=
a;if(null!=c.Members)for(var m in c.Members)f=C(m,d,f)}return f};EditorUi.prototype.pasteLucidChart=function(a,d,f,c){var m=this.editor.graph;m.getModel().beginUpdate();try{var h=function(a,c){var d=null!=c.Endpoint1.Block?g[c.Endpoint1.Block]:null,f=null!=c.Endpoint2.Block?g[c.Endpoint2.Block]:null,e;e=new mxCell("",new mxGeometry(0,0,100,100),"html=1;");e.geometry.relative=!0;e.edge=!0;y(e,a);var k=u(a).Properties,h=null!=k?k.TextAreas:a.TextAreas;if(null!=h){for(var l=0;null!=h["t"+l];){var n=
h["t"+l];e=w(n,e);l++}for(l=1;null!=h["m"+l];)n=h["m"+l],e=w(n,e,a),l++;null!=h.Text&&(e=w(h,e,a));h=null!=k?k.TextAreas:a.TextAreas;null!=h.Message&&(e=w(h.Message,e,a))}null==d&&null!=c.Endpoint1&&e.geometry.setTerminalPoint(new mxPoint(Math.round(.6*c.Endpoint1.x),Math.round(.6*c.Endpoint1.y)),!0);null==f&&null!=c.Endpoint2&&e.geometry.setTerminalPoint(new mxPoint(Math.round(.6*c.Endpoint2.x),Math.round(.6*c.Endpoint2.y)),!1);b.push(m.addCell(e,null,null,d,f))},b=[],g={},e=[],n=[],l=0;if(null!=
a.Groups)for(var r in a.Groups){var k=a.Groups[r];k.id=r;if(1==k.Hidden&&null!=k.Members){n.includes(r)||n.push(r);for(var p in k.Members)n=C(p,a.Groups,n)}}if(null!=a.Blocks)for(r in a.Blocks)k=a.Blocks[r],k.id=r,n.includes(r)||(p=!1,null!=x[k.Class]&&"mxCompositeShape"==x[k.Class]&&(g[k.id]=J(k),e.push(k),p=!0),p||(g[k.id]=B(k),e.push(k)));else for(l=0;l<a.Objects.length;l++)k=a.Objects[l],k.IsBlock&&null!=k.Action&&null!=k.Action.Properties&&(g[k.id]=B(k)),e.push(k);e.sort(function(a,b){a=u(a);
b=u(b);return null!=a.Properties&&null!=b.Properties?a.Properties.ZOrder-b.Properties.ZOrder:0});for(l=0;l<e.length;l++){var k=e[l],q=g[k.id];null!=q?b.push(m.addCell(q)):k.IsLine&&null!=k.Action&&null!=k.Action.Properties&&h(k,k.Action.Properties)}if(null!=a.Lines)for(r in a.Lines)n.includes(r)||(k=a.Lines[r],h(k,k));if(c&&null!=d&&null!=f){m.isGridEnabled()&&(d=m.snap(d),f=m.snap(f));var t=m.getBoundingBoxFromGeometry(b,!0);null!=t&&m.moveCells(b,d-t.x,f-t.y)}m.setSelectionCells(b)}finally{m.getModel().endUpdate()}m.isSelectionEmpty()||
(m.scrollCellToVisible(m.getSelectionCell()),null!=this.hoverIcons&&this.hoverIcons.update(m.view.getState(m.getSelectionCell())))}})();