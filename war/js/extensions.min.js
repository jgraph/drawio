(function(){function t(a){var g=null!=a.Text?a.Text:null!=a.Value?a.Value:a.Lane_0,e=null;null==g&&null!=a.State&&null!=a.State.t&&(e=a.State.t,e=e.replace(/</g,"&lt;"),e=e.replace(/>/g,"&gt;"));return null!=g&&null!=g.t?(g.t=g.t.replace(/</g,"&lt;"),g.t=g.t.replace(/>/g,"&gt;"),g.t):null!=e?e:""}function q(a){return null!=a.Action?a.Action:a}function x(a,g){var e=q(g);if(null!=e){var b=B[e.Class];null!=b&&(a.style+=b);b=null!=e.Properties?e.Properties:e;if(null!=b){a.value=t(b);var h=!1,d;d=null!=
b.Text&&null!=b.Text.m?b.Text.m:null;if(null!=d)for(var f=0;!h&&f<d.length;){var c=d[f];"s"==c.n&&null!=c.v&&(h=!0,c=c.v,c=Math.round(.6*c),a.style+="fontSize="+c+";");f++}0==h&&(a.style+="fontSize=10;");h=!1;if(null!=d){for(f=0;!h&&f<d.length;)c=d[f],"c"==c.n&&null!=c.v&&(h=!0,c=c.v,"#"!=c.charAt(0)&&(c="#"+c),c=c.substring(0,7),a.style+=mxConstants.STYLE_FONTCOLOR+"="+c+";"),f++;var h=0,m=!1;if(null!=d)for(f=0;!m&&f<d.length;)c=d[f],"b"==c.n&&null!=c.v&&c.v&&(m=!0,h+=1),f++;m=!1;if(null!=d)for(f=
0;!m&&f<d.length;)c=d[f],"i"==c.n&&null!=c.v&&c.v&&(m=!0,h+=2),f++;m=!1;if(null!=d)for(f=0;!m&&f<d.length;)c=d[f],"u"==c.n&&null!=c.v&&c.v&&(m=!0,h+=4),f++;0<h&&(a.style+="fontStyle="+h+";");h=!1;if(null!=d)for(f=0;!h&&f<d.length;)c=d[f],"a"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="align="+c+";"),f++;h=!1;if(null!=d)for(f=0;!h&&f<d.length;)c=d[f],"il"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="spacingLeft="+c+";"),f++;h=!1;if(null!=d)for(f=0;!h&&f<d.length;)c=d[f],"ir"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+=
"spacingRight="+c+";"),f++;h=!1;if(null!=d)for(f=0;!h&&f<d.length;)c=d[f],"mt"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="spacingTop="+c+";"),f++;h=!1;if(null!=d)for(f=0;!h&&f<d.length;)c=d[f],"mb"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="spacingBottom="+c+";"),f++;"number"===typeof b.InsetMargin&&(a.style+="spacing="+parseInt(b.InsetMargin)+";");"string"===typeof b.LineColor&&7<b.LineColor.length&&(d="0x"+b.LineColor.substring(b.LineColor.length-2,b.LineColor.length),a.style+="strokeOpacity="+Math.round(parseInt(d)/
2.55)+";");"string"===typeof b.FillColor&&7<b.FillColor.length&&(d="0x"+b.FillColor.substring(b.FillColor.length-2,b.FillColor.length),a.style+="fillOpacity="+Math.round(parseInt(d)/2.55)+";");null!=b.Text_VAlign&&"string"===typeof b.Text_VAlign&&(a.style+="verticalAlign="+b.Text_VAlign+";")}"ImageSearchBlock2"==e.Class&&(a.style+="image="+b.URL+";");a.style+=l(mxConstants.STYLE_STROKEWIDTH,.6*parseFloat(b.LineWidth),"1");C.includes(e.Class)?"Venn"==e.Class.substring(0,4)&&(a.style+=l(mxConstants.STYLE_STROKECOLOR,
b.FillColor.substring(0,7),"#FFFFFF")):a.style=0==b.LineWidth?a.style+(mxConstants.STYLE_STROKECOLOR+"=none;"):a.style+l(mxConstants.STYLE_STROKECOLOR,b.LineColor.substring(0,7),"#000000");a.style+=l(mxConstants.STYLE_ALIGN,b.TextAlign,"center");a.style+=l(mxConstants.STYLE_VERTICAL_ALIGN,b.TextVAlign,"middle");D.includes(e.Class)||(a.style+=l(mxConstants.STYLE_OPACITY,b.Opacity,"100"));null!=b.Rotation&&(d=mxUtils.toDegree(parseFloat(b.Rotation)),"AdvancedSwimLaneBlockRotated"==e.Class?(d+=90,a.geometry.rotate90()):
E.includes(e.Class)&&(d-=90,a.geometry.rotate90(),a.geometry.rotate90(),a.geometry.rotate90()),a.style+="rotation="+d+";");b.FlipX&&(a.style+="flipH=1;");b.FlipY&&(a.style+="flipV=1;");null!=b.Shadow&&(a.style+=mxConstants.STYLE_SHADOW+"=1;");"dashed"==b.StrokeStyle?a.style+="dashed=1;":"dotted"==b.StrokeStyle&&(a.style+="dashed=1;dashPattern=1 4;");null==b.FillColor||F.includes(e.Class)||("object"===typeof b.FillColor?null!=b.FillColor.cs&&1<b.FillColor.cs.length&&(a.style+=l(mxConstants.STYLE_FILLCOLOR,
b.FillColor.cs[0].c.substring(0,7)),a.style+=l(mxConstants.STYLE_GRADIENTCOLOR,b.FillColor.cs[1].c.substring(0,7))):a.style="string"===typeof b.FillColor?a.style+l(mxConstants.STYLE_FILLCOLOR,b.FillColor.substring(0,7),"#FFFFFF"):a.style+l(mxConstants.STYLE_FILLCOLOR,"none"));if(a.edge){a.style+="rounded=1;arcSize=6;";if("diagonal"!=b.Shape)if(null!=b.ElbowPoints)for(a.geometry.points=[],f=0;f<b.ElbowPoints.length;f++)a.geometry.points.push(new mxPoint(Math.round(.6*b.ElbowPoints[f].x+0),Math.round(.6*
b.ElbowPoints[f].y+0)));else"elbow"==b.Shape?a.style=null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block?a.style+"edgeStyle=orthogonalEdgeStyle;":a.style+"edgeStyle=elbowEdgeStyle;":null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block&&(a.style+="edgeStyle=orthogonalEdgeStyle;","curve"==b.Shape&&(a.style+="curved=1;"));null!=b.Endpoint1.Style&&(a.style+="startArrow="+r[b.Endpoint1.Style]+";");null!=b.Endpoint2.Style&&(e=r[b.Endpoint2.Style],e=e.replace(/startSize/g,"endSize"),a.style+="endArrow="+e+";");
y(a,b.Endpoint1,!0);y(a,b.Endpoint2,!1)}}}}function z(a){var g=q(a).Properties.BoundingBox;null!=a.Class&&"AWS"===a.Class.substring(0,3)&&(g.h-=20);v=new mxCell("",new mxGeometry(Math.round(.6*g.x+0),Math.round(.6*g.y+0),Math.round(.6*g.w),Math.round(.6*g.h)),"html=1;whiteSpace=wrap;");v.vertex=!0;x(v,a);return v}function u(a,g){var e=2*(parseFloat(a.Location)-.5),e=new mxCell(t(a),new mxGeometry(e,0,0,0),"text;html=1;resizable=0;align=center;verticalAlign=middle;labelBackgroundColor=#ffffff;");e.geometry.relative=
!0;e.vertex=!0;g.insert(e);return g}function l(a,g,e,b){null!=g&&null!=b&&(g=b(g));return null!=g&&g!=e?a+"="+g+";":""}function y(a,g,e){null!=g&&null!=g.LinkX&&null!=g.LinkY&&(a.style+=(e?"exitX":"entryX")+"="+g.LinkX+";"+(e?"exitY":"entryY")+"="+g.LinkY+";"+(e?"exitPerimeter":"entryPerimeter")+"=0;")}var C="VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8 UMLEndBlock DefaultTextBlockNew".split(" "),
...
HotspotBlock:"strokeColor=none;opacity=50;",ImageSearchBlock2:"shape=image;",ProcessBlock:"rounded=1;absoluteArcSize=1;arcSize=6;",DecisionBlock:"rhombus;rounded=1;arcSize=6;",TerminatorBlock:"rounded=1;arcSize=50;",PredefinedProcessBlock:"shape=process;absoluteArcSize=1;rounded=1;arcSize=6;",DocumentBlock:"shape=document;",MultiDocumentBlock:"shape=mxgraph.flowchart.multi-document;",ManualInputBlock:"shape=manualInput;size=15;rounded=1;arcSize=6;",PreparationBlock:"shape=hexagon;rounded=1;arcSize=6;",
DataBlock:"shape=parallelogram;rounded=1;arcSize=6;",DataBlockNew:"shape=parallelogram;rounded=1;arcSize=6;",DatabaseBlock:"shape=cylinder;",DirectAccessStorageBlock:"shape=mxgraph.flowchart.direct_data;",InternalStorageBlock:"shape=internalStorage;rounded=1;arcSize=6;dx=10;dy=10;",PaperTapeBlock:"shape=tape;size=0.2;",ManualOperationBlockNew:"shape=trapezoid;rounded=1;arcSize=6;flipV=1;",DelayBlock:"shape=delay;",StoredDataBlock:"shape=dataStorage;",MergeBlock:"triangle;direction=south;rounded=1;arcSize=6;",
ConnectorBlock:"ellipse;",OrBlock:"shape=mxgraph.flowchart.summing_function;",SummingJunctionBlock:"shape=mxgraph.flowchart.or;",DisplayBlock:"shape=display;",OffPageLinkBlock:"shape=offPageConnector;rounded=1;arcSize=6;",BraceNoteBlock:"shape=curlyBracket;rounded=1;",NoteBlock:"shape=mxgraph.flowchart.annotation_1;",AdvancedSwimLaneBlock:"swimlane;rounded=1;absoluteArcSize=1;arcSize=6;",AdvancedSwimLaneBlockRotated:"swimlane;horizontal=0;rounded=1;absoluteArcSize=1;arcSize=6;",RectangleContainerBlock:"fillColor=none;container=1;absoluteArcSize=1;rounded=1;arcSize=6;",
DiamondContainerBlock:"shape=rhombus;fillColor=none;container=1;",RoundedRectangleContainerBlock:"absoluteArcSize=1;arcSize=6;rounded=1;fillColor=none;container=1;",CircleContainerBlock:"shape=ellipse;fillColor=none;container=1;",PillContainerBlock:"rounded=1;arcSize=50;fillColor=none;container=1;",IsoscelesTriangleBlock:"triangle;direction=north;",RightTriangleBlock:"shape=mxgraph.basic.orthogonal_triangle;",PentagonBlock:"shape=mxgraph.basic.pentagon;",HexagonBlock:"shape=hexagon;rounded=1;arcSize=6;",
OctagonBlock:"shape=mxgraph.basic.octagon;",CrossBlock:"shape=cross;size=0.6;",CloudBlock:"ellipse;shape=cloud;",HeartBlock:"shape=mxgraph.basic.heart;",RightArrowBlock:"shape=singleArrow;arrowWidth=0.5;arrowSize=0.3;",DoubleArrowBlock:"shape=doubleArrow;arrowWidth=0.5;arrowSize=0.3;",CalloutBlock:"shape=mxgraph.basic.rectangular_callout;",ShapeCircleBlock:"ellipse;",ShapePolyStarBlock:"shape=mxgraph.basic.star;",ShapeDiamondBlock:"rhombus;rounded=1;arcSize=6;",UI2HotspotBlock:"opacity=50;strokeColor=none;absoluteArcSize=1;arcSize=6rounded=1;",
...
DFDExternalEntityBlock2:"absoluteArcSize=1;arcSize=6;rounded=1;",YDMDFDProcessBlock:"shape=ellipse;",YDMDFDDataStoreBlock:"shape=partialRectangle;right=0;left=0;",GSDFDProcessBlock:"shape=swimlane;rounded=1;absoluteArcSize=1;arcSize=6;",GSDFDProcessBlock2:"absoluteArcSize=1;arcSize=6;rounded=1;",GSDFDDataStoreBlock2:"shape=partialRectangle;right=0;",OrgBlock:"absoluteArcSize=1;arcSize=6;rounded=1;",VSMCustomerSupplierBlock:"shape=mxgraph.lean_mapping.outside_sources;",VSMDedicatedProcessBlock:"shape=mxgraph.lean_mapping.manufacturing_process;",
VSMSharedProcessBlock:"shape=mxgraph.lean_mapping.manufacturing_process_shared;",VSMWorkcellBlock:"shape=mxgraph.lean_mapping.work_cell;",VSMInventoryBlock:"shape=mxgraph.lean_mapping.inventory_box;",VSMPhysicalPullBlock:"shape=mxgraph.lean_mapping.physical_pull;direction=south;",VSMFIFOLaneBlock:"shape=mxgraph.lean_mapping.fifo_sequence_flow;fontStyle=0;fontSize=20",VSMExternalShipmentAirplaneBlock:"shape=mxgraph.lean_mapping.airplane_7;",VSMExternalShipmentForkliftBlock:"shape=mxgraph.lean_mapping.move_by_forklift;",
VSMExternalShipmentTruckBlock:"shape=mxgraph.lean_mapping.truck_shipment;",VSMExternalShipmentBoatBlock:"shape=mxgraph.lean_mapping.boat_shipment;",VSMProductionControlBlock:"shape=mxgraph.lean_mapping.manufacturing_process;",VSMOtherInformationBlock:"absoluteArcSize=1;arcSize=6;rounded=1;",VSMSequencedPullBallBlock:"shape=mxgraph.lean_mapping.sequenced_pull_ball;",VSMMRPERPBlock:"shape=mxgraph.lean_mapping.mrp_erp;whiteSpace=wrap;",VSMLoadLevelingBlock:"shape=mxgraph.lean_mapping.load_leveling;",
...
EE_NAND:"shape=mxgraph.electrical.logic_gates.nand;",EE_NOR:"shape=mxgraph.electrical.logic_gates.nor;",EE_XOR:"shape=mxgraph.electrical.logic_gates.xor;",EE_NXOR:"shape=mxgraph.electrical.logic_gates.xnor;",EE_DTypeRSFlipFlop:"shape=mxgraph.electrical.logic_gates.d_type_rs_flip-flop;",EE_DTypeFlipFlop:"shape=mxgraph.electrical.logic_gates.d_type_flip-flop;",EE_DTypeFlipFlopWithClear:"shape=mxgraph.electrical.logic_gates.d_type_flip-flop_with_clear;",EE_RSLatch:"shape=mxgraph.electrical.logic_gates.rs_latch;",
EE_SyncRSLatch:"shape=mxgraph.electrical.logic_gates.synchronous_rs_latch;",EE_TTypeFlipFlop:"shape=mxgraph.electrical.logic_gates.t_type_flip-flop;",EE_Plus:"shape=mxgraph.ios7.misc.flagged;",EE_Negative:"shape=line;",EE_InverterContact:"shape=ellipse;",EE_Voltmeter:"shape=mxgraph.electrical.instruments.voltmeter;",EE_Ammeter:"shape=mxgraph.electrical.instruments.ampermeter;",EE_SineWave:"shape=mxgraph.electrical.waveforms.sine_wave;",EE_Sawtooth:"shape=mxgraph.electrical.waveforms.sawtooth;",EE_SquareWave:"shape=mxgraph.electrical.waveforms.square_wave;",
EIChannelBlock:"shape=mxgraph.eip.messageChannel;",EIMessageRouterBlock:"shape=mxgraph.eip.content_based_router;",EIMessageTranslatorBlock:"shape=mxgraph.eip.message_translator;",EIMessagingBridgeBlock:"shape=mxgraph.eip.messaging_bridge;",EIContentBasedRouterBlock:"shape=mxgraph.eip.content_based_router;",EIMessageFilterBlock:"shape=mxgraph.eip.message_filter;",EIDynamicRouterBlock:"shape=mxgraph.eip.dynamic_router;",EIRecipientListBlock:"shape=mxgraph.eip.recipient_list;",EISplitterBlock:"shape=mxgraph.eip.splitter;",
EIAggregatorBlock:"shape=mxgraph.eip.aggregator;",EIResequencerBlock:"shape=mxgraph.eip.resequencer;",EIComposedMessageBlock:"shape=mxgraph.eip.composed_message_processor;",EIRoutingSlipBlock:"shape=mxgraph.eip.routing_slip;",EIProcessManagerBlock:"shape=mxgraph.eip.process_manager;",EIEnvelopeWrapperBlock:"shape=mxgraph.eip.envelope_wrapper;",EIContentEnricherBlock:"shape=mxgraph.eip.content_enricher;",EIContentFilterBlock:"shape=mxgraph.eip.content_filter;",EIClaimCheckBlock:"shape=mxgraph.eip.claim_check;",
EINormalizerBlock:"shape=mxgraph.eip.normalizer;",EIMessagingGatewayBlock:"shape=mxgraph.eip.messaging_gateway;",EITransactionalClientBlock:"shape=mxgraph.eip.transactional_client;",EIPollingConsumerBlock:"shape=mxgraph.eip.polling_consumer;",EIEventDrivenConsumerBlock:"shape=mxgraph.eip.event_driven_consumer;",EICompetingConsumersBlock:"shape=mxgraph.eip.competing_consumers;",EIMessageDispatcherBlock:"shape=mxgraph.eip.message_dispatcher;",EISelectiveConsumerBlock:"shape=mxgraph.eip.selective_consumer;",
EIServiceActivatorBlock:"shape=mxgraph.eip.service_activator;",EIDetourBlock:"shape=mxgraph.eip.detour;",EIWireTapBlock:"shape=mxgraph.eip.wire_tap;",EIMessageStoreBlock:"shape=mxgraph.eip.message_store;",EISmartProxyBlock:"shape=mxgraph.eip.smart_proxy;",EITestMessageBlock:"shape=mxgraph.eip.test_message;",EIChannelPurgerBlock:"shape=mxgraph.eip.channel_purger;",GCPIconComputeEngineBlock:"strokeColor=none;shape=mxgraph.gcp.compute.compute_engine;",GCPIconAppEngineBlock:"strokeColor=none;shape=mxgraph.gcp.compute.app_engine;",
GCPIconContainerEngineBlock:"strokeColor=none;shape=mxgraph.gcp.compute.container_engine;",GCPIconContainerRegistryBlock:"strokeColor=none;shape=mxgraph.gcp.compute.container_registry;",GCPIconCloudFunctionsBlock:"strokeColor=none;shape=mxgraph.gcp.compute.cloud_functions;",GCPIconCloudStorageBlock:"strokeColor=none;shape=mxgraph.gcp.storage_databases.cloud_storage;",GCPIconCloudSQLBlock:"strokeColor=none;shape=mxgraph.gcp.storage_databases.cloud_sql;",GCPIconCloudBigtableBlock:"strokeColor=none;shape=mxgraph.gcp.storage_databases.cloud_bigtable;",
GCPIconCloudDatastoreBlock:"strokeColor=none;shape=mxgraph.gcp.storage_databases.cloud_datastore;",GCPIconPersistentDiskBlock:"strokeColor=none;shape=mxgraph.gcp.storage_databases.persistent_disk;",GCPIconCloudVirtualNetworkBlock:"strokeColor=none;shape=mxgraph.gcp.networking.cloud_virtual_network;",GCPIconCloudLoadBalancingBlock:"strokeColor=none;shape=mxgraph.gcp.networking.cloud_load_balancing;",GCPIconCloudCDNBlock:"strokeColor=none;shape=mxgraph.gcp.networking.cloud_cdn;",GCPIconCloudInterconnectBlock:"strokeColor=none;shape=mxgraph.gcp.networking.cloud_interconnect;",
GCPIconCloudDNSBlock:"strokeColor=none;shape=mxgraph.gcp.networking.cloud_dns;",GCPIconBigQueryBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.bigquery;",GCPIconCloudDataflowBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.cloud_dataflow;",GCPIconCloudDataprocBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.cloud_dataproc;",GCPIconCloudDatalabBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.cloud_datalab;",GCPIconCloudPubSubBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.cloud_pubsub;",
GCPIconGenomicsBlock:"strokeColor=none;shape=mxgraph.gcp.big_data.genomics;",GCPIconCloudMachineLearningServicesBlock:"strokeColor=none;shape=mxgraph.gcp.machine_learning.cloud_machine_learning;",GCPIconVisionAPIBlock:"strokeColor=none;shape=mxgraph.gcp.machine_learning.vision_api;",GCPIconSpeechAPIBlock:"strokeColor=none;shape=mxgraph.gcp.machine_learning.speech_api;",GCPIconNaturalLanguageAPIBlock:"strokeColor=none;shape=mxgraph.gcp.machine_learning.natural_language_api;",GCPIconTranslateAPIBlock:"strokeColor=none;shape=mxgraph.gcp.machine_learning.translation_api;",
...
fpCubicleDouble14x8:"shape=mxgraph.floorplan.wallU;wallThickness=3;",fpCubicleEnclosed11x9:"shape=mxgraph.floorplan.wallU;wallThickness=3;",fpTableConferenceOval:"shape=ellipse;",fpTableConferenceBoat:"absoluteArcSize=1;arcSize=6;rounded=1;",fpTableConferenceRectangle:"absoluteArcSize=1;arcSize=6;rounded=1;",fpTableDiningRound:"shape=ellipse;",fpTableDiningSquare:"absoluteArcSize=1;arcSize=6;rounded=1;",fpChairOffice:"shape=mxgraph.floorplan.office_chair;",fpChairExecutive:"shape=mxgraph.floorplan.office_chair;",
fpChairLobby:"shape=mxgraph.floorplan.office_chair;",fpChairDining:"shape=mxgraph.floorplan.chair;",fpChairBarstool:"shape=ellipse;",fpCabinetBasic:"absoluteArcSize=1;arcSize=6;rounded=1;",fpCabinetDoubleWide:"absoluteArcSize=1;arcSize=6;rounded=1;",fpCabinetDoubleWithShelves:"absoluteArcSize=1;arcSize=6;rounded=1;",fpCabinetShelvesBasic:"absoluteArcSize=1;arcSize=6;rounded=1;",fpCabinetShelvesDouble:"absoluteArcSize=1;arcSize=6;rounded=1;",fpCabinetBasicWithShelves:"absoluteArcSize=1;arcSize=6;rounded=1;",
fpCabinetsAboveDeskShelves:"absoluteArcSize=1;arcSize=6;rounded=1;",fpRestroomToiletPrivate:"shape=mxgraph.floorplan.toilet;",fpRestroomToiletPublic:"shape=mxgraph.floorplan.toilet;",fpRestroomBathtub:"shape=mxgraph.floorplan.bathtub;direction=south;",fpRestroomShower:"shape=mxgraph.floorplan.shower;flipH=1;",fpRestroomPedastalSink:"shape=mxgraph.floorplan.sink_1;",fpRestroomCountertop:"absoluteArcSize=1;arcSize=6;rounded=1;",fpRestroomMirror:"shape=line;strokeWidth=3;",fpBedDouble:"shape=mxgraph.floorplan.bed_double;",
...
fpApplianceDishwasher:"shape=rect;",fpKitchenSink:"shape=mxgraph.floorplan.sink_2;",fpKitchenDoubleSink:"shape=mxgraph.floorplan.sink_double;",fpKitchenCountertop:"absoluteArcSize=1;arcSize=6;rounded=1;",fpKitchenCountertopCorner:"shape=mxgraph.floorplan.desk_corner;",fpCouchLoveSeat:"shape=mxgraph.floorplan.couch;",fpCouchSofa:"shape=mxgraph.floorplan.couch;",fpCouchOttoman:"absoluteArcSize=1;arcSize=6;rounded=1;",fpMiscDesktopComputer:"shape=mxgraph.floorplan.workstation;",fpMiscLaptopComputer:"shape=mxgraph.floorplan.laptop;",
fpComputerMonitor:"shape=mxgraph.floorplan.flat_tv;",fpCRTTelevision:"shape=mxgraph.floorplan.flat_tv;",fpMiscIndoorPlant:"shape=mxgraph.floorplan.plant;",fpPiano:"shape=mxgraph.floorplan.piano;",PEAxialCompressor:"shape=mxgraph.pid.compressors.centrifugal_compressor_-_turbine_driven;",PECentrifugalCompressor:"shape=mxgraph.pid.compressors.centrifugal_compressor;",PECentrifugalCompressor2:"shape=mxgraph.pid.compressors.centrifugal_compressor_-_turbine_driven;",PEReciprocationCompressor:"shape=mxgraph.pid.compressors.reciprocating_compressor;",
PERotaryCompressorBlock:"shape=mxgraph.pid.compressors.rotary_compressor;",PERotaryCompressor2Block:"shape=mxgraph.pid.compressors.compressor_and_silencers;",PEConveyorBlock:"shape=mxgraph.pid2misc.conveyor;",PEElevator1Block:"shape=mxgraph.pid.misc.bucket_elevator;flipH=1;",PEAgitatorMixerBlock:"shape=mxgraph.pid.agitators.agitator_(propeller);",PEDrumBlock:"shape=mxgraph.pid.vessels.drum_or_condenser;",PETankEquipmentBlock:"shape=mxgraph.pid.vessels.tank;",PEMixingReactorBlock:"shape=mxgraph.pid.vessels.mixing_reactor;",
PEPlateTowerBlock:"shape=mxgraph.pid2misc.column;columnType=baffle;",PEPackedTowerBlock:"shape=mxgraph.pid2misc.column;columnType=fixed;",PEFurnaceBlock:"shape=mxgraph.pid.vessels.furnace;",PEMidArrow:"shape=triangle;",PEButtWeld:"shape=mxgraph.sysml.x;",PETopToTop:"shape=mxgraph.pid.vessels.container,_tank,_cistern;",PENuclear:"shape=mxgraph.electrical.waveforms.sine_wave;",PEMechanicalLink:"shape=ellipse;",PESolderedSolvent:"shape=ellipse;",PEDoubleContainment:"shape=hexagon;",PEFlange:"shape=mxgraph.pid.piping.double_flange;",
...
PETriangleSeparator:"shape=triangle;direction=west;",PETundish:"shape=mxgraph.ios7.misc.left;",PEOpenVent:"shape=mxgraph.pid.vessels.vent_(bent);",PERemovableSpool:"shape=mxgraph.pid.piping.removable_spool;",PEYTypeStrainer:"shape=mxgraph.pid.piping.y-type_strainer;",PEDiverterValve:"shape=mxgraph.pid.piping.diverter_valve;",PEPulsationDampener:"shape=mxgraph.pid.piping.pulsation_dampener;",PEDuplexStrainer:"shape=mxgraph.pid.piping.duplex_strainer;",PEBasketStrainer:"shape=mxgraph.pid.piping.basket_strainer;",
PEVentSilencer:"shape=mxgraph.pid.piping.vent_silencer;",PEInlineSilencer:"shape=mxgraph.pid.piping.in-line_silencer;",PESteamTrap:"shape=mxgraph.pid.piping.steam_trap;",PEDesuperheater:"shape=mxgraph.pid.piping.desuper_heater;",PEEjectorOrEductor:"shape=mxgraph.pid.fittings.injector;",PEExhaustHead:"shape=mxgraph.pid.piping.exhaust_head;",PERotaryValve:"shape=mxgraph.pid.piping.rotary_valve;",PEExpansionJoint:"shape=mxgraph.pid.piping.expansion_joint;",PEVesselBlock:"shape=rect;",PEOpenTankBlock:"shape=mxgraph.pid.vessels.container,_tank,_cistern;",
PEOpenTopTank:"shape=mxgraph.pid.vessels.container,_tank,_cistern;",PEClosedTankBlock:"shape=rect;",PEStorageSphereBlock:"shape=mxgraph.pid.vessels.storage_sphere;",PEColumnBlock:"shape=mxgraph.pid.vessels.pressurized_vessel;",PEBagBlock:"shape=mxgraph.pid.vessels.bag;",PEGasCylinderBlock:"shape=mxgraph.pid.vessels.gas_bottle;",PEGasHolderBlock:"shape=mxgraph.pid.vessels.gas_holder;",PEClarifierBlock:"shape=mxgraph.pid.vessels.bunker_(conical_bottom);",PETrayColumnBlock:"shape=mxgraph.pid2misc.column;columnType=tray;",
...
Image_ipad_keyboard_landscape:"shape=mxgraph.ios.iKeybLett;",Image_ipad_slider:"shape=mxgraph.ios.iSlider;barPos=20;",Image_ipad_add_icon_blue:"shape=mxgraph.ios.iAddIcon;fillColor=#8BbEff;fillColor2=#135Ec8;strokeColor=#ffffff;",Image_ipad_add_icon_green:"shape=mxgraph.ios.iAddIcon;fillColor=#7AdF78;fillColor2=#1A9917;strokeColor=#ffffff;",Image_ipad_remove_icon:"shape=mxgraph.ios.iDeleteIcon;fillColor=#e8878E;fillColor2=#BD1421;strokeColor=#ffffff;",Image_ipad_arrow_icon:"shape=mxgraph.ios.iArrowIcon;fillColor=#8BbEff;fillColor2=#135Ec8;strokeColor=#ffffff;",
Image_ipad_arrow:"shape=mxgraph.ios7.misc.more;",Image_ipad_checkmark:"shape=mxgraph.ios7.misc.check;",Image_ipad_check_off:"shape=ellipse;",Image_ipad_location_dot:"shape=ellipse;",Image_ipad_mark_as_read:"shape=ellipse;",Image_ipad_pin_green:"shape=mxgraph.ios.iPin;fillColor2=#00dd00;fillColor3=#004400;strokeColor=#006600;",Image_ipad_pin_red:"shape=mxgraph.ios.iPin;fillColor2=#dd0000;fillColor3=#440000;strokeColor=#660000;",Image_ipad_radio_off:"shape=ellipse;",Image_ipad_checkbox_off:"absoluteArcSize=1;arcSize=6;rounded=1;",
Image_ipad_indicator:"absoluteArcSize=1;arcSize=6;rounded=1;fillColor=#e8878E;gradientColor=#BD1421;strokeColor=#ffffff;",Image_iphone_iphone_4:"shape=mxgraph.ios.iPhone;bgStyle=bgGreen;",Image_iphone_bg_black:"shape=rect;",Image_iphone_bg_gray:"shape=rect;",Image_iphone_bg_stripe_drk:"shape=mxgraph.ios.iBgStriped;strokeColor=#18211b;fillColor=#5D7585;strokeColor2=#657E8F;",Image_iphone_bg_stripe_lt:"shape=mxgraph.ios.iBgStriped;strokeColor=#18211b;fillColor=#5D7585;strokeColor2=#657E8F;",Image_iphone_bg_white:"shape=rect;",
Image_iphone_top_bar_app:"shape=mxgraph.ios.iAppBar;",Image_iphone_top_bar_home:"shape=mxgraph.ios.iTopBar2;opacity=50;fillColor=#999999;strokeColor=#cccccc;strokeWidth=1;",Image_iphone_bar_top:"shape=rect;",Image_iphone_bar_semi_trans_black:"shape=rect;",Image_iphone_bar_semi_trans_blue:"shape=rect;",Image_iphone_search:"shape=mxgraph.mockup.forms.searchBox;mainText=;flipH=1;",Image_iphone_gray_grad_list:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_alpha_list:"shape=mxgraph.ios.iAlphaList;",
Image_iphone_button_black:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_button_blue:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_button_grayblue:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_button_red:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_button_lg_light:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_button_lg_dark:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_button_lg_green:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_button_lg_red:"absoluteArcSize=1;arcSize=6;rounded=1;",
Image_iphone_button_lg_yellow:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_button_xl_green:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_back_button:"shape=mxgraph.ios.iButtonBack;strokeColor=#444444;buttonText=;fillColor=#dddddd;fillColor2=#3D5565;",Image_iphone_prev_next:"shape=mxgraph.ios.iPrevNext;strokeColor=#444444;fillColor=#dddddd;fillColor2=#3D5565;fillColor3=#ffffff;",Image_iphone_sort_handle:"shape=mxgraph.ios7.icons.options;",Image_iphone_slider:"shape=mxgraph.ios.iSlider;barPos=60;",
Image_iphone_dropdown:"shape=mxgraph.ios.iComboBox;buttonText=;fillColor=#dddddd;fillColor2=#3D5565;",Image_iphone_email_name:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_switch_off:"shape=mxgraph.android.switch_off;fillColor=#666666;",Image_iphone_keyboard_button_blue:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_keyboard_letters:"shape=mxgraph.ios.iKeybLett;",Image_iphone_keyboard_landscape:"shape=mxgraph.ios.iKeybLett;",Image_iphone_add_icon_blue:"shape=mxgraph.ios.iAddIcon;fillColor=#8BbEff;fillColor2=#135Ec8;strokeColor=#ffffff;",
...
Image_iphone_mark_as_read:"shape=ellipse;",Image_iphone_pin_green:"shape=mxgraph.ios.iPin;fillColor2=#00dd00;fillColor3=#004400;strokeColor=#006600;",Image_iphone_pin_red:"shape=mxgraph.ios.iPin;fillColor2=#dd0000;fillColor3=#440000;strokeColor=#660000;",Image_iphone_radio_off:"shape=ellipse;",Image_iphone_checkbox_off:"absoluteArcSize=1;arcSize=6;rounded=1;",Image_iphone_indicator:"absoluteArcSize=1;arcSize=6;rounded=1;fillColor=#e8878E;gradientColor=#BD1421;strokeColor=#ffffff;",Image_iphone_thread_count:"absoluteArcSize=1;arcSize=6;rounded=1;"},
A=function(a,g,e){e.includes(a)||e.push(a);if(a in g){var b=g[a];b.id=a;if(null!=b.Members)for(var h in b.Members)e=A(h,g,e)}return e};EditorUi.prototype.pasteLucidChart=function(a,g,e,b){var h=this.editor.graph;h.getModel().beginUpdate();try{var d=function(a,b){var e=null!=b.Endpoint1.Block?c[b.Endpoint1.Block]:null,g=null!=b.Endpoint2.Block?c[b.Endpoint2.Block]:null,d;d=new mxCell("",new mxGeometry(0,0,100,100),"html=1;");d.geometry.relative=!0;d.edge=!0;x(d,a);var k=q(a).Properties,l=null!=k?k.TextAreas:
a.TextAreas;if(null!=l){for(var m=0;null!=l["t"+m];){var n=l["t"+m];d=u(n,d);m++}for(m=1;null!=l["m"+m];)n=l["m"+m],d=u(n,d),m++;l=null!=k?k.TextAreas:a.TextAreas;null!=l.Message&&(d=u(l.Message,d));null!=l.Text&&(d=u(l.Text,d))}null==e&&null!=b.Endpoint1&&d.geometry.setTerminalPoint(new mxPoint(Math.round(.6*b.Endpoint1.x),Math.round(.6*b.Endpoint1.y)),!0);null==g&&null!=b.Endpoint2&&d.geometry.setTerminalPoint(new mxPoint(Math.round(.6*b.Endpoint2.x),Math.round(.6*b.Endpoint2.y)),!1);f.push(h.addCell(d,
null,null,e,g))},f=[],c={},m=[],l=[],p=0;if(null!=a.Groups)for(var n in a.Groups){var k=a.Groups[n];k.id=n;if(1==k.Hidden&&null!=k.Members){l.includes(n)||l.push(n);for(var t in k.Members)l=A(t,a.Groups,l)}}if(null!=a.Blocks)for(n in a.Blocks)k=a.Blocks[n],k.id=n,l.includes(n)||(c[k.id]=z(k),m.push(k));else for(p=0;p<a.Objects.length;p++)k=a.Objects[p],k.IsBlock&&null!=k.Action&&null!=k.Action.Properties&&(c[k.id]=z(k)),m.push(k);m.sort(function(a,b){a=q(a);b=q(b);return null!=a.Properties&&null!=
b.Properties?a.Properties.ZOrder-b.Properties.ZOrder:0});for(p=0;p<m.length;p++){var k=m[p],r=c[k.id];null!=r?f.push(h.addCell(r)):k.IsLine&&null!=k.Action&&null!=k.Action.Properties&&d(k,k.Action.Properties)}if(null!=a.Lines)for(n in a.Lines)l.includes(n)||(k=a.Lines[n],d(k,k));if(b&&null!=g&&null!=e){h.isGridEnabled()&&(g=h.snap(g),e=h.snap(e));var w=h.getBoundingBoxFromGeometry(f,!0);null!=w&&h.moveCells(f,g-w.x,e-w.y)}h.setSelectionCells(f)}finally{h.getModel().endUpdate()}h.isSelectionEmpty()||
(h.scrollCellToVisible(h.getSelectionCell()),null!=this.hoverIcons&&this.hoverIcons.update(h.view.getState(h.getSelectionCell())))}})();