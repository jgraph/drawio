(function(){function p(a){var c=null!=a.Text?a.Text:null!=a.Value?a.Value:a.Lane_0;null==c&&null!=a.State?null!=a.State.t&&(c=a.State):null==c&&null!=a.Note?null!=a.Note.t&&(c=a.Note):null!=a.t&&(c=a);null==c&&null!=a.TextAreas&&null!=a.TextAreas.Text&&null!=a.TextAreas.Text.Value&&null!=a.TextAreas.Text.Value.t&&(c=a.TextAreas.Text.Value);if(null!=c){if(null!=c.t)return c.t=c.t.replace(/</g,"&lt;"),c.t=c.t.replace(/>/g,"&gt;"),c.t;if(null!=c.Value&&null!=c.Value.t)return c.Value.t=c.Value.t.replace(/</g,
"&lt;"),c.Value.t=c.Value.t.replace(/>/g,"&gt;"),c.Value.t}return""}function t(a){return null!=a.Action?a.Action:a}function l(a){if(null!=a.Text){if(null!=a.Text.m)return a.Text.m}else if(null!=a.TextAreas){if(null!=a.TextAreas.Text&&null!=a.TextAreas.Text.Value&&null!=a.TextAreas.Text.Value.m)return a.TextAreas.Text.Value.m}else if(null!=a.m)return a.m;return null}function u(a){a=l(a);if(null!=a)for(var c=0;c<a.length;){var b=a[c];if("s"==b.n&&null!=b.v)return"fontSize="+Math.round(.6*b.v)+";";c++}return"fontSize=10;"}
function r(a){a=l(a);if(null!=a)for(var c=0;c<a.length;){var b=a[c];if("c"==b.n&&null!=b.v)return a=b.v,"#"!=a.charAt(0)&&(a="#"+a),a=a.substring(0,7),mxConstants.STYLE_FONTCOLOR+"="+a+";";c++}return""}function x(a){a=l(a);if(null!=a){var c=0,b=!1;if(null!=a)for(var d=0;!b&&d<a.length;){var e=a[d];"b"==e.n&&null!=e.v&&e.v&&(b=!0,c+=1);d++}b=!1;if(null!=a)for(d=0;!b&&d<a.length;)e=a[d],"i"==e.n&&null!=e.v&&e.v&&(b=!0,c+=2),d++;b=!1;if(null!=a)for(d=0;!b&&d<a.length;)e=a[d],"u"==e.n&&null!=e.v&&e.v&&
(b=!0,c+=4),d++;if(0<c)return"fontStyle="+c+";"}return""}function y(a,c){var b=l(a),d=!1;if(null!=b)for(var e=0;!d&&e<b.length;){var f=b[e];"a"==f.n&&null!=f.v&&(d=!0,c.style+="align="+f.v+";");e++}return d?"":h(mxConstants.STYLE_ALIGN,a.TextAlign,"center")}function z(a){a=l(a);if(null!=a&&null!=a)for(var c=0;c<a.length;){var b=a[c];if("il"==b.n&&null!=b.v)return"spacingLeft="+b.v+";";c++}return""}function A(a){a=l(a);if(null!=a)for(var c=0;c<a.length;){var b=a[c];if("ir"==b.n&&null!=b.v)return"spacingRight="+
b.v+";";c++}return""}function B(a){a=l(a);if(null!=a)for(var c=0;c<a.length;){var b=a[c];if("mt"==b.n&&null!=b.v)return"spacingTop="+b.v+";";c++}return""}function C(a){a=l(a);if(null!=a)for(var c=0;c<a.length;){var b=a[c];if("mb"==b.n&&null!=b.v)return"spacingBottom="+b.v+";";c++}return""}function D(a){return"number"===typeof a.InsetMargin?"spacing="+parseInt(a.InsetMargin)+";":""}function E(a){return null!=a.Text_VAlign&&"string"===typeof a.Text_VAlign?"verticalAlign="+a.Text_VAlign+";":h(mxConstants.STYLE_VERTICAL_ALIGN,
a.TextVAlign,"middle")}function F(a,c){return T.includes(c.Class)?"Venn"==c.Class.substring(0,4)?h(mxConstants.STYLE_STROKECOLOR,a.FillColor.substring(0,7),"#FFFFFF"):"":0==a.LineWidth?mxConstants.STYLE_STROKECOLOR+"=none;":h(mxConstants.STYLE_STROKECOLOR,a.LineColor.substring(0,7),"#000000")}function G(a,c){var b="";U.includes(c.Class)||(b+=h(mxConstants.STYLE_OPACITY,a.Opacity,"100"));if("string"===typeof a.LineColor&&7<a.LineColor.length)var d="0x"+a.LineColor.substring(a.LineColor.length-2,a.LineColor.length),
b=b+("strokeOpacity="+Math.round(parseInt(d)/2.55)+";");"string"===typeof a.FillColor&&7<a.FillColor.length&&(d="0x"+a.FillColor.substring(a.FillColor.length-2,a.FillColor.length),b+="fillOpacity="+Math.round(parseInt(d)/2.55)+";");return b}function M(a,c){if(null!=a.Rounding&&!V.includes(c.Class)){if(0<a.Rounding)return"rounded=1;absoluteArcSize=1;arcSize="+.6*a.Rounding+";"}else if(null==a.Rounding&&W.includes(c.Class))return"rounded=1;absoluteArcSize=1;arcSize=8;";return""}function H(a,c,b){return null!=
a.Rotation&&(a=mxUtils.toDegree(parseFloat(a.Rotation)),"AdvancedSwimLaneBlockRotated"==c.Class?(a+=90,b.geometry.rotate90()):X.includes(c.Class)&&(a-=90,b.geometry.rotate90(),b.geometry.rotate90(),b.geometry.rotate90()),0!=a)?"rotation="+a+";":""}function I(a){return null!=a.Shadow?mxConstants.STYLE_SHADOW+"=1;":""}function N(a,c){if(null!=a.FillColor&&!Y.includes(c.Class))if("object"===typeof a.FillColor){if(null!=a.FillColor.cs&&1<a.FillColor.cs.length)return h(mxConstants.STYLE_FILLCOLOR,a.FillColor.cs[0].c.substring(0,
7))+h(mxConstants.STYLE_GRADIENTCOLOR,a.FillColor.cs[1].c.substring(0,7))}else return"string"===typeof a.FillColor?h(mxConstants.STYLE_FILLCOLOR,a.FillColor.substring(0,7),"#FFFFFF"):h(mxConstants.STYLE_FILLCOLOR,"none");return""}function J(a){return"dashed"==a.StrokeStyle?"dashed=1;":"dotted"==a.StrokeStyle?"dashed=1;dashPattern=1 4;":""}function K(a){return h(mxConstants.STYLE_STROKEWIDTH,.6*parseFloat(a.LineWidth),"1")}function O(a,c){var b=t(c);if(null!=b){var d=L[b.Class]+";";null!=d&&(a.style+=
d);d=null!=b.Properties?b.Properties:b;if(null!=d){a.value=p(d);var e=a.style,f=u(d)+r(d)+x(d)+y(d,a)+z(d)+A(d)+B(d)+C(d)+D(d)+E(d)+F(d,b)+G(d,b)+M(d,b)+H(d,b,a)+(d.FlipX?"flipH=1;":"")+(d.FlipY?"flipV=1;":"")+I(d)+N(d,b)+J(d)+K(d);b="ImageSearchBlock2"==b.Class?"image="+d.URL+";":"";a.style=e+(f+b);if(a.edge){a.style+="rounded=1;arcSize=6;";if("diagonal"!=d.Shape)if(null!=d.ElbowPoints)for(a.geometry.points=[],b=0;b<d.ElbowPoints.length;b++)a.geometry.points.push(new mxPoint(Math.round(.6*d.ElbowPoints[b].x+
0),Math.round(.6*d.ElbowPoints[b].y+0)));else"elbow"==d.Shape?a.style=null!=d.Endpoint1.Block&&null!=d.Endpoint1.Block?a.style+"edgeStyle=orthogonalEdgeStyle;":a.style+"edgeStyle=elbowEdgeStyle;":null!=d.Endpoint1.Block&&null!=d.Endpoint1.Block&&(a.style+="edgeStyle=orthogonalEdgeStyle;","curve"==d.Shape&&(a.style+="curved=1;"));null!=d.Endpoint1.Style&&(a.style+="startArrow="+P[d.Endpoint1.Style]+";");null!=d.Endpoint2.Style&&(a.style+="endArrow="+P[d.Endpoint2.Style].replace(/startSize/g,"endSize")+
";");Q(a,d.Endpoint1,!0);Q(a,d.Endpoint2,!1)}}}}function R(a){var c=t(a).Properties.BoundingBox;null!=a.Class&&"AWS"===a.Class.substring(0,3)&&(c.h-=20);v=new mxCell("",new mxGeometry(Math.round(.6*c.x+0),Math.round(.6*c.y+0),Math.round(.6*c.w),Math.round(.6*c.h)),"html=1;whiteSpace=wrap;");v.vertex=!0;O(v,a);return v}function w(a,c,b){b=2*(parseFloat(a.Location)-.5);a=new mxCell(p(a),new mxGeometry(b,0,0,0),"text;html=1;resizable=0;labelBackgroundColor=#ffffff;");a.geometry.relative=!0;a.vertex=
!0;c.insert(a);return c}function h(a,c,b,d){null!=c&&null!=d&&(c=d(c));return null!=c&&c!=b?a+"="+c+";":""}function Q(a,c,b){null!=c&&null!=c.LinkX&&null!=c.LinkY&&(a.style+=(b?"exitX":"entryX")+"="+c.LinkX+";"+(b?"exitY":"entryY")+"="+c.LinkY+";"+(b?"exitPerimeter":"entryPerimeter")+"=0;")}function Z(a){var c=t(a),b=c.Properties,d=b.BoundingBox,e=.6*d.w,f=.6*d.h;v=new mxCell("",new mxGeometry(Math.round(.6*d.x+0),Math.round(.6*d.y+0),Math.round(e),Math.round(f)),"html=1;whiteSpace=wrap;");v.vertex=
!0;switch(a.Class){case "BraceNoteBlock":a=!1;null!=b.BraceDirection&&"Right"==b.BraceDirection&&(a=!0);a?(a=new mxCell("",new mxGeometry(e-.125*f,0,.125*f,f),"shape=curlyBracket;rounded=1;"),e=new mxCell("",new mxGeometry(0,0,e-.125*f,f),"strokeColor=none;fillColor=none;")):(a=new mxCell("",new mxGeometry(0,0,.125*f,f),"shape=curlyBracket;rounded=1;flipH=1;"),e=new mxCell("",new mxGeometry(.125*f,0,e-.125*f,f),"strokeColor=none;fillColor=none;"));v.style="strokeColor=none;fillColor=none;";v.style+=
H(b,c,v);a.vertex=!0;v.insert(a);a.style+=F(b,c)+G(b,c)+I(b)+J(b)+K(b);e.vertex=!0;e.value=p(b);v.insert(e);e.style+=u(b)+r(b)+x(b)+y(b,e)+z(b)+A(b)+B(b)+C(b)+D(b)+E(b);break;case "AdvancedSwimLaneBlockRotated":case "AdvancedSwimLaneBlock":a=0;null!=b.Lanes&&(a=b.Lanes.length);v.style="strokeColor=none;fillColor=none;";for(var d=0,n=[],k=0;k<a;k++){var h=parseFloat(b.Lanes[k].p);n.push(new mxCell("",new mxGeometry(e*d,0,e*h,f),"shape=swimlane;startSize=25;"));n[k].vertex=!0;v.insert(n[k]);n[k].value=
p(b["Lane_"+k]);n[k].style+=u(b["Lane_"+k])+r(b["Lane_"+k])+x(b["Lane_"+k])+y(b["Lane_"+k],n[k])+z(b["Lane_"+k])+A(b["Lane_"+k])+B(b["Lane_"+k])+C(b["Lane_"+k])+D(b["Lane_"+k])+E(b["Lane_"+k])+F(b,c)+G(b,c)+M(b,c)+H(b,c,n[k])+(b.FlipX?"flipH=1;":"")+(b.FlipY?"flipV=1;":"")+I(b)+N(b,c)+J(b)+K(b);d+=h}break;case "AndroidDevice":if(null!=b.AndroidDeviceName){v.style="fillColor=#000000;strokeColor=#000000;";d=a=c=null;if("Tablet"==b.AndroidDeviceName||"Mini Tablet"==b.AndroidDeviceName)v.style+="shape=mxgraph.android.tab2;",
c=new mxCell("",new mxGeometry(.112*e,.077*f,.77*e,.85*f),""),b.KeyboardShown&&(a=new mxCell("",new mxGeometry(.112*e,.727*f,.77*e,.2*f),"shape=mxgraph.android.keyboard;")),b.FullScreen||(d=new mxCell("",new mxGeometry(.112*e,.077*f,.77*e,.03*f),"shape=mxgraph.android.statusBar;strokeColor=#33b5e5;fillColor=#000000;fontColor=#33b5e5;fontSize="+.015*f+";"));else if("Large Phone"==b.AndroidDeviceName||"Phone"==b.AndroidDeviceName)v.style+="shape=mxgraph.android.phone2;",c=new mxCell("",new mxGeometry(.04*
e,.092*f,.92*e,.816*f),""),b.KeyboardShown&&(a=new mxCell("",new mxGeometry(.04*e,.708*f,.92*e,.2*f),"shape=mxgraph.android.keyboard;")),b.FullScreen||(d=new mxCell("",new mxGeometry(.04*e,.092*f,.92*e,.03*f),"shape=mxgraph.android.statusBar;strokeColor=#33b5e5;fillColor=#000000;fontColor=#33b5e5;fontSize="+.015*f+";"));c.vertex=!0;v.insert(c);"Dark"==b.Scheme?c.style+="fillColor=#111111;":"Light"==b.Scheme&&(c.style+="fillColor=#ffffff;");null!=a&&(a.vertex=!0,v.insert(a));null!=d&&(d.vertex=!0,
v.insert(d))}}return v}var V=["GSDFDProcessBlock","RoundedRectangleContainerBlock","UI2ButtonBlock","UMLStateBlock"],W=["ProcessBlock","UMLActivationBlock"],T="VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8 UMLEndBlock DefaultTextBlockNew".split(" "),Y="AWSAndroidBlock3 AWSiOSBlock3 AWSJavaBlock3 AWSJavaScript AWSNetBlock3 AWSNodeJSBlock3 AWSPHPBlock3 AWSPythonBlock3 AWSRubyBlock3 AWSXamarin AWSCLIBlock3 AWSEclipseToolkitBlock3 AWSVisualStudioToolkitBlock3 AWSWindowsPowershellToolkitBlock3 DefaultTextBlock RectangleContainerBlock UMLStartBlock UMLEndBlock DefaultTextBlockNew UMLHForkJoinBlock".split(" "),
...
DoubleArrowBlock:"shape=doubleArrow;arrowWidth=0.5;arrowSize=0.3",CalloutBlock:"shape=mxgraph.basic.rectangular_callout",ShapeCircleBlock:"ellipse",ShapePolyStarBlock:"shape=mxgraph.basic.star",ShapeDiamondBlock:"rhombus",UI2HotspotBlock:"opacity=50;strokeColor=none",AndroidDevice:"mxCompositeShape",AndroidAlertDialog:"mxCompositeShape",AndroidDateDialog:"mxCompositeShape",AndroidTimeDialog:"mxCompositeShape",AndroidListItems:"mxCompositeShape",AndroidProgressBar:"mxCompositeShape",AndroidImageBlock:"mxCompositeShape",
AndroidTextBlock:"mxCompositeShape",AndroidActionBar:"mxCompositeShape",AndroidBrowserBar:"mxCompositeShape",AndroidButton:"mxCompositeShape",AndroidTextBox:"mxCompositeShape",AndroidRadioButton:"mxCompositeShape",AndroidCheckBox:"mxCompositeShape",AndroidToggle:"mxCompositeShape",AndroidSlider:"mxCompositeShape",AndroidIconCheck:"shape=mxgraph.ios7.misc.check",AndroidIconCancel:"shape=mxgraph.atlassian.x",AndroidIconCollapse:"shape=mxgraph.ios7.misc.up",AndroidIconExpand:"shape=mxgraph.ios7.misc.down",
...
iOSDeviceiPhone6s:"shape=mxgraph.ios7.misc.iphone",iOSDeviceiPhone6sPlus:"shape=mxgraph.ios7.misc.iphone",iOSDeviceiPadPortrait:"shape=mxgraph.ios7.misc.ipad7inch",iOSDeviceiPadLandscape:"shape=mxgraph.ios7.misc.ipad7inch",iOSDeviceiPadProPortrait:"shape=mxgraph.ios7.misc.ipad7inch",iOSDeviceiPadProLandscape:"shape=mxgraph.ios7.misc.ipad10inch",iOSButton:"",iOSSegmentedControl:"mxCompositeShape",iOSStepper:"shape=mxgraph.ios7.misc.adjust",iOSToggle:"shape=mxgraph.ios7ui.onOffButton;buttonState=on;strokeColor2=#aaaaaa;fillColor2=#ffffff",
iOSSlider:"shape=mxgraph.ios7ui.slider;barPos=20;strokeColor2=#a0a0a0",iOSProgressBar:"shape=mxgraph.ios.iCloudProgressBar;barPos=20",iOSPageControls:"shape=mxgraph.ios.iCloudProgressBar;barPos=20",iOSSearchBar:"mxCompositeShape",iOSNavBar:"mxCompositeShape",iOSTabs:"mxCompositeShape",iOSUniversalKeyboard:"shape=mxgraph.ios.iKeybLett",iOSDatePicker:"mxCompositeShape",iOSTimePicker:"mxCompositeShape",iOSCountdownPicker:"mxCompositeShape",iOSBasicCell:"mxCompositeShape",iOSSubtitleCell:"mxCompositeShape",
iOSRightDetailCell:"mxCompositeShape",iOSLeftDetailCell:"mxCompositeShape",iOSTableGroupedSectionBreak:"mxCompositeShape",iOSTablePlainHeaderFooter:"mxCompositeShape",MindMapBlock:"",MindMapStadiumBlock:"arcSize=50",MindMapCloud:"shape=cloud",MindMapCircle:"shape=ellipse",MindMapIsoscelesTriangleBlock:"shape=triangle;direction=north",MindMapDiamondBlock:"shape=rhombus",MindMapPentagonBlock:"shape=mxgraph.basic.pentagon",MindMapHexagonBlock:"shape=hexagon",MindMapOctagonBlock:"shape=mxgraph.basic.octagon",
MindMapCrossBlock:"shape=mxgraph.basic.cross2;dx=20",ERDEntityBlock:"mxCompositeShape",ERDEntityBlock2:"mxCompositeShape",ERDEntityBlock3:"mxCompositeShape",ERDEntityBlock4:"mxCompositeShape",SMPage:"mxCompositeShape",SMHome:"mxCompositeShape",SMGallery:"mxCompositeShape",SMShopping:"mxCompositeShape",SMMap:"mxCompositeShape",SMAthletics:"mxCompositeShape",SMLogin:"mxCompositeShape",SMPrint:"mxCompositeShape",SMScript:"mxCompositeShape",SMSearch:"mxCompositeShape",SMSettings:"mxCompositeShape",SMSitemap:"mxCompositeShape",
SMSuccess:"mxCompositeShape",SMVideo:"mxCompositeShape",SMAudio:"mxCompositeShape",SMBlog:"mxCompositeShape",SMCalendar:"mxCompositeShape",SMChart:"mxCompositeShape",SMCloud:"mxCompositeShape",SMDocument:"mxCompositeShape",SMDownload:"mxCompositeShape",SMError:"mxCompositeShape",SMForm:"mxCompositeShape",SMGame:"mxCompositeShape",SMJobs:"mxCompositeShape",SMLucid:"mxCompositeShape",SMNewspress:"mxCompositeShape",SMPhoto:"mxCompositeShape",SMPortfolio:"mxCompositeShape",SMPricing:"mxCompositeShape",
SMProfile:"mxCompositeShape",SMSlideshow:"mxCompositeShape",SMUpload:"mxCompositeShape",UMLClassBlock:"",UMLActiveClassBlock:"shape=process",UMLPackageBlock:"shape=folder;tabPosition=left",UMLNoteBlock:"shape=note;size=15",UMLTextBlock:"shape=text;strokeColor=none;fillColor=none",UMLActorBlock:"shape=umlActor;labelPosition=center;verticalLabelPosition=bottom;verticalAlign=top;whiteSpace=nowrap",UMLUseCaseBlock:"shape=ellipse",UMLCircleContainerBlock:"shape=ellipse;container=1",UMLRectangleContainerBlock:"container=1",
...
VSMTimelineBlock:"mxCompositeShape",VSMQualityProblemBlock:"shape=mxgraph.lean_mapping.quality_problem",VSMProductionKanbanSingleBlock:"shape=mxgraph.lean_mapping.production_kanban",VSMWithdrawalKanbanBlock:"shape=mxgraph.lean_mapping.withdrawal_kanban",VSMSignalKanbanBlock:"shape=mxgraph.lean_mapping.signal_kanban",VSMKanbanPostBlock:"shape=mxgraph.lean_mapping.kanban_post",VSMShipmentArrow:"shape=singleArrow;arrowWidth=0.5;arrowSize=0.13",VSMPushArrow:"shape=mxgraph.lean_mapping.push_arrow",VSMElectronicInformationArrow:"shape=mxgraph.lean_mapping.electronic_info_flow_edge;",
...
Image_iphone_mark_as_read:"shape=ellipse",Image_iphone_pin_green:"shape=mxgraph.ios.iPin;fillColor2=#00dd00;fillColor3=#004400;strokeColor=#006600",Image_iphone_pin_red:"shape=mxgraph.ios.iPin;fillColor2=#dd0000;fillColor3=#440000;strokeColor=#660000",Image_iphone_radio_off:"shape=ellipse",Image_iphone_checkbox_off:"",Image_iphone_indicator:"fillColor=#e8878E;gradientColor=#BD1421;strokeColor=#ffffff",Image_iphone_thread_count:""},S=function(a,c,b){b.includes(a)||b.push(a);if(a in c){var d=c[a];d.id=
a;if(null!=d.Members)for(var e in d.Members)b=S(e,c,b)}return b};EditorUi.prototype.pasteLucidChart=function(a,c,b,d){var e=this.editor.graph;e.getModel().beginUpdate();try{var f=function(a,b){var c=null!=b.Endpoint1.Block?k[b.Endpoint1.Block]:null,d=null!=b.Endpoint2.Block?k[b.Endpoint2.Block]:null,f;f=new mxCell("",new mxGeometry(0,0,100,100),"html=1;");f.geometry.relative=!0;f.edge=!0;O(f,a);var g=t(a).Properties,h=null!=g?g.TextAreas:a.TextAreas;if(null!=h){for(var l=0;null!=h["t"+l];){var m=
h["t"+l];f=w(m,f);l++}for(l=1;null!=h["m"+l];)m=h["m"+l],f=w(m,f,a),l++;null!=h.Text&&(f=w(h,f,a));h=null!=g?g.TextAreas:a.TextAreas;null!=h.Message&&(f=w(h.Message,f,a))}null==c&&null!=b.Endpoint1&&f.geometry.setTerminalPoint(new mxPoint(Math.round(.6*b.Endpoint1.x),Math.round(.6*b.Endpoint1.y)),!0);null==d&&null!=b.Endpoint2&&f.geometry.setTerminalPoint(new mxPoint(Math.round(.6*b.Endpoint2.x),Math.round(.6*b.Endpoint2.y)),!1);n.push(e.addCell(f,null,null,c,d))},n=[],k={},h=[],l=[],q=0;if(null!=
a.Groups)for(var m in a.Groups){var g=a.Groups[m];g.id=m;if(1==g.Hidden&&null!=g.Members){l.includes(m)||l.push(m);for(var p in g.Members)l=S(p,a.Groups,l)}}if(null!=a.Blocks)for(m in a.Blocks)g=a.Blocks[m],g.id=m,l.includes(m)||(p=!1,null!=L[g.Class]&&"mxCompositeShape"==L[g.Class]&&(k[g.id]=Z(g),h.push(g),p=!0),p||(k[g.id]=R(g),h.push(g)));else for(q=0;q<a.Objects.length;q++)g=a.Objects[q],g.IsBlock&&null!=g.Action&&null!=g.Action.Properties&&(k[g.id]=R(g)),h.push(g);h.sort(function(a,b){a=t(a);
b=t(b);return null!=a.Properties&&null!=b.Properties?a.Properties.ZOrder-b.Properties.ZOrder:0});for(q=0;q<h.length;q++){var g=h[q],u=k[g.id];null!=u?n.push(e.addCell(u)):g.IsLine&&null!=g.Action&&null!=g.Action.Properties&&f(g,g.Action.Properties)}if(null!=a.Lines)for(m in a.Lines)l.includes(m)||(g=a.Lines[m],f(g,g));if(d&&null!=c&&null!=b){e.isGridEnabled()&&(c=e.snap(c),b=e.snap(b));var r=e.getBoundingBoxFromGeometry(n,!0);null!=r&&e.moveCells(n,c-r.x,b-r.y)}e.setSelectionCells(n)}finally{e.getModel().endUpdate()}e.isSelectionEmpty()||
