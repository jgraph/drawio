...
m(mxConstants.STYLE_STROKEWIDTH,b.LineWidth,"1");"VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8".split(" ").includes(e.Class)||(a.style+=m(mxConstants.STYLE_STROKECOLOR,b.LineColor.substring(0,7),"#000000"));a.style+=m(mxConstants.STYLE_ALIGN,b.TextAlign,"center");a.style+=
m(mxConstants.STYLE_VERTICAL_ALIGN,b.TextVAlign,"middle");"VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8".split(" ").includes(e.Class)||(a.style+=m(mxConstants.STYLE_OPACITY,b.Opacity,"100"));null!=b.Rotation&&(g=mxUtils.toDegree(parseFloat(b.Rotation)),d=["AEUSBBlock",
"AGSCutandpasteBlock","iOSDeviceiPadLandscape","iOSDeviceiPadProLandscape"],"AdvancedSwimLaneBlockRotated"==e.Class?(g+=90,a.geometry.rotate90()):d.includes(e.Class)&&(g-=90,a.geometry.rotate90(),a.geometry.rotate90(),a.geometry.rotate90()),a.style+="rotation="+g+";");b.FlipX&&(a.style+="flipH=1;");b.FlipY&&(a.style+="flipV=1;");null!=b.Shadow&&(a.style+=mxConstants.STYLE_SHADOW+"=1;");"dashed"==b.StrokeStyle?a.style+="dashed=1;":"dotted"==b.StrokeStyle&&(a.style+="dashed=1;dashPattern=1 4;");null==
b.FillColor||"AWSAndroidBlock3 AWSiOSBlock3 AWSJavaBlock3 AWSJavaScript AWSNetBlock3 AWSNodeJSBlock3 AWSPHPBlock3 AWSPythonBlock3 AWSRubyBlock3 AWSXamarin AWSCLIBlock3 AWSEclipseToolkitBlock3 AWSVisualStudioToolkitBlock3 AWSWindowsPowershellToolkitBlock3 DefaultTextBlock".split(" ").includes(e.Class)||("object"===typeof b.FillColor?null!=b.FillColor.cs&&1<b.FillColor.cs.length&&(a.style+=m(mxConstants.STYLE_FILLCOLOR,b.FillColor.cs[0].c.substring(0,7)),a.style+=m(mxConstants.STYLE_GRADIENTCOLOR,b.FillColor.cs[1].c.substring(0,
7))):a.style="string"===typeof b.FillColor?a.style+m(mxConstants.STYLE_FILLCOLOR,b.FillColor.substring(0,7),"#FFFFFF"):a.style+m(mxConstants.STYLE_FILLCOLOR,"none"));if(a.edge){a.style+="rounded=1;arcSize=5;";if("diagonal"!=b.Shape)if(null!=b.ElbowPoints)for(a.geometry.points=[],d=0;d<b.ElbowPoints.length;d++)a.geometry.points.push(new mxPoint(Math.round(.6*b.ElbowPoints[d].x+0),Math.round(.6*b.ElbowPoints[d].y+0)));else"elbow"==b.Shape?a.style=null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block?a.style+
"edgeStyle=orthogonalEdgeStyle;":a.style+"edgeStyle=elbowEdgeStyle;":null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block&&(a.style+="edgeStyle=orthogonalEdgeStyle;","curve"==b.Shape&&(a.style+="curved=1;"));null!=b.Endpoint1.Style&&("None"==b.Endpoint1.Style?a.style+="startArrow=none;":"Arrow"==b.Endpoint1.Style?a.style+="startArrow=block;endFill=1;":"Hollow Arrow"==b.Endpoint1.Style?a.style+="startArrow=block;endFill=0;":"Open Arrow"==b.Endpoint1.Style&&(a.style+="startArrow=open;"));null!=b.Endpoint2.Style&&
("None"==b.Endpoint2.Style?a.style+="endArrow=none;":"Arrow"==b.Endpoint2.Style?a.style+="endArrow=block;endFill=1;":"Hollow Arrow"==b.Endpoint2.Style?a.style+="endArrow=block;endFill=0;":"Open Arrow"==b.Endpoint2.Style&&(a.style+="endArrow=open;"));r(a,b.Endpoint1,!0);r(a,b.Endpoint2,!1)}}}}function x(a){var h=q(a).Properties.BoundingBox;null!=a.Class&&"AWS"===a.Class.substring(0,3)&&(h.h-=20);v=new mxCell("",new mxGeometry(Math.round(.6*h.x+0),Math.round(.6*h.y+0),Math.round(.6*h.w),Math.round(.6*
h.h)),"html=1;whiteSpace=wrap;");v.vertex=!0;w(v,a);return v}function m(a,h,e,b){null!=h&&null!=b&&(h=b(h));return null!=h&&h!=e?a+"="+h+";":""}function r(a,h,e){null!=h&&(null!=h.LinkX&&null!=h.LinkY&&(a.style+=(e?"exitX":"entryX")+"="+h.LinkX+";"+(e?"exitY":"entryY")+"="+h.LinkY+";"+(e?"exitPerimeter":"entryPerimeter")+"=0;"),"Arrow"==h.Style?a.style+=(e?"startArrow":"endArrow")+"=block;":"Hollow Arrow"==h.Style?(a.style+=(e?"startArrow":"endArrow")+"=block;",a.style+=(e?"startFill":"endFill")+
"=0;"):"Open Arrow"==h.Style&&(a.style+=(e?"startArrow":"endArrow")+"=open;",a.style+=(e?"startSize":"endSize")+"=12;"))}var A={DefaultTextBlockNew:"text;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;",DefaultTextBlock:"text;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;",DefaultSquareBlock:"rounded=1;arcSize=5;",DefaultNoteBlock:"shape=note;size=15;",DefaultNoteBlockV2:"shape=note;size=15;",HotspotBlock:"strokeColor=none;opacity=50;",ImageSearchBlock2:"shape=image;",
ProcessBlock:"rounded=1;arcSize=5;",DecisionBlock:"rhombus;rounded=1;arcSize=5;",TerminatorBlock:"rounded=1;arcSize=50;",PredefinedProcessBlock:"shape=process;rounded=1;arcSize=5;",DocumentBlock:"shape=document;",MultiDocumentBlock:"shape=mxgraph.flowchart.multi-document;",ManualInputBlock:"shape=manualInput;size=15;rounded=1;arcSize=5;",PreparationBlock:"shape=hexagon;rounded=1;arcSize=5;",DataBlock:"shape=parallelogram;rounded=1;arcSize=5;",DataBlockNew:"shape=parallelogram;rounded=1;arcSize=5;",
DatabaseBlock:"shape=cylinder;",DirectAccessStorageBlock:"shape=mxgraph.flowchart.direct_data;",InternalStorageBlock:"shape=internalStorage;rounded=1;arcSize=5;dx=10;dy=10;",PaperTapeBlock:"shape=tape;size=0.2;",ManualOperationBlockNew:"shape=trapezoid;rounded=1;arcSize=5;flipV=1;",DelayBlock:"shape=delay;",StoredDataBlock:"shape=dataStorage;",MergeBlock:"triangle;direction=south;rounded=1;arcSize=5;",ConnectorBlock:"ellipse;",OrBlock:"shape=mxgraph.flowchart.summing_function;",SummingJunctionBlock:"shape=mxgraph.flowchart.or;",
DisplayBlock:"shape=display;",OffPageLinkBlock:"shape=offPageConnector;rounded=1;arcSize=5;",BraceNoteBlock:"shape=curlyBracket;rounded=1;",NoteBlock:"shape=mxgraph.flowchart.annotation_1;",AdvancedSwimLaneBlock:"swimlane;rounded=1;arcSize=5;",AdvancedSwimLaneBlockRotated:"swimlane;horizontal=0;rounded=1;arcSize=5;",RectangleContainerBlock:"fillColor=none;container=1;rounded=1;arcSize=5;",DiamondContainerBlock:"shape=rhombus;fillColor=none;container=1;",RoundedRectangleContainerBlock:"rounded=1;fillColor=none;container=1;",
...
DoubleArrowBlock:"shape=doubleArrow;arrowWidth=0.5;arrowSize=0.3;",CalloutBlock:"shape=mxgraph.basic.rectangular_callout;",ShapeCircleBlock:"ellipse;",ShapePolyStarBlock:"shape=mxgraph.basic.star;",ShapeDiamondBlock:"rhombus;rounded=1;arcSize=5;",UI2HotspotBlock:"shape=rect;opacity=50;strokeColor=none;rounded=1;",AndroidIconCheck:"shape=mxgraph.ios7.misc.check;",AndroidIconCancel:"shape=mxgraph.atlassian.x;",AndroidIconCollapse:"shape=mxgraph.ios7.misc.up;",AndroidIconExpand:"shape=mxgraph.ios7.misc.down;",
...
iOSDeviceiPhone6s:"shape=mxgraph.ios7.misc.iphone;",iOSDeviceiPhone6sPlus:"shape=mxgraph.ios7.misc.iphone;",iOSDeviceiPadPortrait:"shape=mxgraph.ios7.misc.ipad7inch;",iOSDeviceiPadLandscape:"shape=mxgraph.ios7.misc.ipad7inch;",iOSDeviceiPadProPortrait:"shape=mxgraph.ios7.misc.ipad7inch;",iOSDeviceiPadProLandscape:"shape=mxgraph.ios7.misc.ipad10inch;",iOSButton:"shape=rect;",iOSStepper:"shape=mxgraph.ios7.misc.adjust;",iOSToggle:"shape=mxgraph.ios7ui.onOffButton;buttonState=on;strokeColor2=#aaaaaa;fillColor2=#ffffff;",
iOSSlider:"shape=mxgraph.ios7ui.slider;barPos=20;strokeColor2=#a0a0a0;",iOSProgressBar:"shape=mxgraph.ios.iCloudProgressBar;barPos=20;",iOSPageControls:"shape=mxgraph.ios.iCloudProgressBar;barPos=20;",iOSUniversalKeyboard:"shape=mxgraph.ios.iKeybLett;",MindMapBlock:"shape=rect;rounded=1;",MindMapStadiumBlock:"shape=rect;rounded=1;arcSize=50;",MindMapCloud:"shape=cloud;",MindMapCircle:"shape=ellipse;",MindMapIsoscelesTriangleBlock:"shape=triangle;direction=north;",MindMapDiamondBlock:"shape=rhombus;",
MindMapPentagonBlock:"shape=mxgraph.basic.pentagon;",MindMapHexagonBlock:"shape=hexagon;",MindMapOctagonBlock:"shape=mxgraph.basic.octagon;",MindMapCrossBlock:"shape=mxgraph.basic.cross2;dx=20;",UMLClassBlock:"rounded=1;",UMLActiveClassBlock:"shape=mxgraph.flowchart.predefined_process;",UMLPackageBlock:"shape=folder;tabPosition=left;",UMLNoteBlock:"shape=note;size=15;",UMLTextBlock:"shape=text;strokeColor=none;fillColor=none;",UMLActorBlock:"shape=umlActor;",UMLUseCaseBlock:"shape=ellipse;",UMLCircleContainerBlock:"shape=ellipse;container=1;",
...
fpCubicleDouble14x8:"shape=mxgraph.floorplan.wallU;wallThickness=3;",fpCubicleEnclosed11x9:"shape=mxgraph.floorplan.wallU;wallThickness=3;",fpTableConferenceOval:"shape=ellipse;",fpTableConferenceBoat:"shape=rect;rounded=1;",fpTableConferenceRectangle:"shape=rect;rounded=1;",fpTableDiningRound:"shape=ellipse;",fpTableDiningSquare:"shape=rect;rounded=1;",fpChairOffice:"shape=mxgraph.floorplan.office_chair;",fpChairExecutive:"shape=mxgraph.floorplan.office_chair;",fpChairLobby:"shape=mxgraph.floorplan.office_chair;",
fpChairDining:"shape=mxgraph.floorplan.chair;",fpChairBarstool:"shape=ellipse;",fpCabinetBasic:"shape=rect;rounded=1;",fpCabinetDoubleWide:"shape=rect;rounded=1;",fpCabinetDoubleWithShelves:"shape=rect;rounded=1;",fpCabinetShelvesBasic:"shape=rect;rounded=1;",fpCabinetShelvesDouble:"shape=rect;rounded=1;",fpCabinetBasicWithShelves:"shape=rect;rounded=1;",fpCabinetsAboveDeskShelves:"shape=rect;rounded=1;",fpRestroomToiletPrivate:"shape=mxgraph.floorplan.toilet;",fpRestroomToiletPublic:"shape=mxgraph.floorplan.toilet;",
...
fpBedBunk:"shape=mxgraph.floorplan.bed_double;",fpBedBassinet:"shape=mxgraph.pid.fittings.compensator;",fpApplianceWasher:"shape=rect;",fpApplianceDryer:"shape=rect;",fpApplianceWaterHeater:"shape=ellipse;",fpApplianceStoveOven:"shape=mxgraph.floorplan.range_1;",fpStoveOvenSixBurner:"shape=mxgraph.floorplan.range_2;",fpApplianceDishwasher:"shape=rect;",fpKitchenSink:"shape=mxgraph.floorplan.sink_2;",fpKitchenDoubleSink:"shape=mxgraph.floorplan.sink_double;",fpKitchenCountertop:"shape=rect;rounded=1;",
fpKitchenCountertopCorner:"shape=mxgraph.floorplan.desk_corner;",fpCouchLoveSeat:"shape=mxgraph.floorplan.couch;",fpCouchSofa:"shape=mxgraph.floorplan.couch;",fpCouchOttoman:"shape=rect;rounded=1;",fpMiscDesktopComputer:"shape=mxgraph.floorplan.workstation;",fpMiscLaptopComputer:"shape=mxgraph.floorplan.laptop;",fpComputerMonitor:"shape=mxgraph.floorplan.flat_tv;",fpCRTTelevision:"shape=mxgraph.floorplan.flat_tv;",fpMiscIndoorPlant:"shape=mxgraph.floorplan.plant;",fpPiano:"shape=mxgraph.floorplan.piano;",
PEAxialCompressor:"shape=mxgraph.pid.compressors.centrifugal_compressor_-_turbine_driven;",PECentrifugalCompressor:"shape=mxgraph.pid.compressors.centrifugal_compressor;",PECentrifugalCompressor2:"shape=mxgraph.pid.compressors.centrifugal_compressor_-_turbine_driven;",PEReciprocationCompressor:"shape=mxgraph.pid.compressors.reciprocating_compressor;",PERotaryCompressorBlock:"shape=mxgraph.pid.compressors.rotary_compressor;",PERotaryCompressor2Block:"shape=mxgraph.pid.compressors.compressor_and_silencers;",
PEConveyorBlock:"shape=mxgraph.pid2misc.conveyor;",PEElevator1Block:"shape=mxgraph.pid.misc.bucket_elevator;flipH=1;",PEAgitatorMixerBlock:"shape=mxgraph.pid.agitators.agitator_(propeller);",PEDrumBlock:"shape=mxgraph.pid.vessels.drum_or_condenser;",PETankEquipmentBlock:"shape=mxgraph.pid.vessels.tank;",PEMixingReactorBlock:"shape=mxgraph.pid.vessels.mixing_reactor;",PEPlateTowerBlock:"shape=mxgraph.pid2misc.column;columnType=baffle;",PEPackedTowerBlock:"shape=mxgraph.pid2misc.column;columnType=fixed;",
...
PEBreather:"shape=mxgraph.pid.piping.breather;",PEElectronicallyInsulated:"shape=mxgraph.pid.piping.double_flange;",PEReducer:"shape=mxgraph.pid.piping.concentric_reducer;",PEInlineMixer:"shape=mxgraph.pid.piping.in-line_mixer;",PEFlameArrester:"shape=mxgraph.pid.piping.flame_arrestor;",PEDetonationArrester:"shape=mxgraph.pid.piping.detonation_arrestor;",PETriangleSeparator:"shape=triangle;direction=west;",PETundish:"shape=mxgraph.ios7.misc.left;",PEOpenVent:"shape=mxgraph.pid.vessels.vent_(bent);",
PERemovableSpool:"shape=mxgraph.pid.piping.removable_spool;",PEYTypeStrainer:"shape=mxgraph.pid.piping.y-type_strainer;",PEDiverterValve:"shape=mxgraph.pid.piping.diverter_valve;",PEPulsationDampener:"shape=mxgraph.pid.piping.pulsation_dampener;",PEDuplexStrainer:"shape=mxgraph.pid.piping.duplex_strainer;",PEBasketStrainer:"shape=mxgraph.pid.piping.basket_strainer;",PEVentSilencer:"shape=mxgraph.pid.piping.vent_silencer;",PEInlineSilencer:"shape=mxgraph.pid.piping.in-line_silencer;",PESteamTrap:"shape=mxgraph.pid.piping.steam_trap;",
PEDesuperheater:"shape=mxgraph.pid.piping.desuper_heater;",PEEjectorOrEductor:"shape=mxgraph.pid.fittings.injector;",PEExhaustHead:"shape=mxgraph.pid.piping.exhaust_head;",PERotaryValve:"shape=mxgraph.pid.piping.rotary_valve;",PEExpansionJoint:"shape=mxgraph.pid.piping.expansion_joint;",PEVesselBlock:"shape=rect;",PEOpenTankBlock:"shape=mxgraph.pid.vessels.container,_tank,_cistern;",PEOpenTopTank:"shape=mxgraph.pid.vessels.container,_tank,_cistern;",PEClosedTankBlock:"shape=rect;",PEStorageSphereBlock:"shape=mxgraph.pid.vessels.storage_sphere;",
PEColumnBlock:"shape=mxgraph.pid.vessels.pressurized_vessel;",PEBagBlock:"shape=mxgraph.pid.vessels.bag;",PEGasCylinderBlock:"shape=mxgraph.pid.vessels.gas_bottle;",PEGasHolderBlock:"shape=mxgraph.pid.vessels.gas_holder;",PEClarifierBlock:"shape=mxgraph.pid.vessels.bunker_(conical_bottom);",PETrayColumnBlock:"shape=mxgraph.pid2misc.column;columnType=tray;",PEReactionVesselBlock:"shape=mxgraph.pid.vessels.reactor;",PEBin:"shape=mxgraph.pid.vessels.tank_(conical_bottom);",PEDomeRoofTank:"shape=mxgraph.pid.vessels.tank_(dished_roof);",
...
Image_iphone_indicator:"shape=rect;rounded=1;fillColor=#e8878E;gradientColor=#BD1421;strokeColor=#ffffff;",Image_iphone_thread_count:"shape=rect;rounded=1;"},y=function(a,h,e){e.includes(a)||e.push(a);if(a in h){var b=h[a];b.id=a;if(null!=b.Members)for(var f in b.Members)e=y(f,h,e)}return e};EditorUi.prototype.pasteLucidChart=function(a,h,e,b){var f=this.editor.graph;f.getModel().beginUpdate();try{var g=function(a,b){var g=null!=b.Endpoint1.Block?c[b.Endpoint1.Block]:null,h=null!=b.Endpoint2.Block?
c[b.Endpoint2.Block]:null,e=new mxCell("",new mxGeometry(0,0,100,100),"html=1;");e.geometry.relative=!0;e.edge=!0;w(e,a);var k=q(a).Properties,k=null!=k?k.TextAreas:a.TextAreas;if(null!=k)for(var m=0;null!=k["t"+m];){var k=k["t"+m],l=2*(parseFloat(k.Location)-.5),l=new mxCell(u(k),new mxGeometry(l,0,0,0),"text;html=1;resizable=0;align=center;verticalAlign=middle;labelBackgroundColor=#ffffff;");l.geometry.relative=!0;l.vertex=!0;e.insert(l);m++}null==g&&null!=b.Endpoint1&&e.geometry.setTerminalPoint(new mxPoint(Math.round(.6*
b.Endpoint1.x),Math.round(.6*b.Endpoint1.y)),!0);null==h&&null!=b.Endpoint2&&e.geometry.setTerminalPoint(new mxPoint(Math.round(.6*b.Endpoint2.x),Math.round(.6*b.Endpoint2.y)),!1);d.push(f.addCell(e,null,null,g,h))},d=[],c={},l=[],m=[],p=0;if(null!=a.Groups)for(var n in a.Groups){var k=a.Groups[n];k.id=n;if(1==k.Hidden&&null!=k.Members){m.includes(n)||m.push(n);for(var r in k.Members)m=y(r,a.Groups,m)}}if(null!=a.Blocks)for(n in a.Blocks)k=a.Blocks[n],k.id=n,m.includes(n)||(c[k.id]=x(k),l.push(k));
else for(p=0;p<a.Objects.length;p++)k=a.Objects[p],k.IsBlock&&null!=k.Action&&null!=k.Action.Properties&&(c[k.id]=x(k)),l.push(k);l.sort(function(a,b){a=q(a);b=q(b);return null!=a.Properties&&null!=b.Properties?a.Properties.ZOrder-b.Properties.ZOrder:0});for(p=0;p<l.length;p++){var k=l[p],z=c[k.id];null!=z?d.push(f.addCell(z)):k.IsLine&&null!=k.Action&&null!=k.Action.Properties&&g(k,k.Action.Properties)}if(null!=a.Lines)for(n in a.Lines)k=a.Lines[n],g(k,k);if(b&&null!=h&&null!=e){f.isGridEnabled()&&
(h=f.snap(h),e=f.snap(e));var t=f.getBoundingBoxFromGeometry(d,!0);null!=t&&f.moveCells(d,h-t.x,e-t.y)}f.setSelectionCells(d)}finally{f.getModel().endUpdate()}f.isSelectionEmpty()||(f.scrollCellToVisible(f.getSelectionCell()),null!=this.hoverIcons&&this.hoverIcons.update(f.view.getState(f.getSelectionCell())))}})();