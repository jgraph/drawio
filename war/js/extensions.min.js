(function(){function t(a){var d=null!=a.Text?a.Text:null!=a.Value?a.Value:a.Lane_0,f=null;null==d&&null!=a.State&&null!=a.State.t&&(f=a.State.t);return null!=d&&null!=d.t?d.t:null!=f?f:""}function q(a){return null!=a.Action?a.Action:a}function x(a,d){var f=q(d);if(null!=f){var b=B[f.Class];null!=b&&(a.style+=b);b=null!=f.Properties?f.Properties:f;if(null!=b){a.value=t(b);var g=!1;if(null!=b.Text&&null!=b.Text.m)for(var h=b.Text.m,e=0;!g&&e<h.length;){var c=h[e];"s"==c.n&&null!=c.v&&(g=!0,c=c.v,c=
Math.round(.6*c),a.style+="fontSize="+c+";");e++}0==g&&(a.style+="fontSize=10;");g=!1;if(null!=b.Text){if(null!=b.Text.m)for(h=b.Text.m,e=0;!g&&e<h.length;)c=h[e],"c"==c.n&&null!=c.v&&(g=!0,c=c.v,"#"!=c.charAt(0)&&(c="#"+c),c=c.substring(0,7),a.style+=mxConstants.STYLE_FONTCOLOR+"="+c+";"),e++;var g=0,m=!1;if(null!=b.Text.m)for(h=b.Text.m,e=0;!m&&e<h.length;)c=h[e],"b"==c.n&&null!=c.v&&c.v&&(m=!0,g+=1),e++;m=!1;if(null!=b.Text.m)for(h=b.Text.m,e=0;!m&&e<h.length;)c=h[e],"i"==c.n&&null!=c.v&&c.v&&
(m=!0,g+=2),e++;m=!1;if(null!=b.Text.m)for(h=b.Text.m,e=0;!m&&e<h.length;)c=h[e],"u"==c.n&&null!=c.v&&c.v&&(m=!0,g+=4),e++;0<g&&(a.style+="fontStyle="+g+";");g=!1;if(null!=b.Text&&null!=b.Text.m)for(h=b.Text.m,e=0;!g&&e<h.length;)c=h[e],"a"==c.n&&null!=c.v&&(g=!0,c=c.v,a.style+="align="+c+";"),e++;g=!1;if(null!=b.Text&&null!=b.Text.m)for(h=b.Text.m,e=0;!g&&e<h.length;)c=h[e],"il"==c.n&&null!=c.v&&(g=!0,c=c.v,a.style+="spacingLeft="+c+";"),e++;g=!1;if(null!=b.Text&&null!=b.Text.m)for(h=b.Text.m,e=
0;!g&&e<h.length;)c=h[e],"ir"==c.n&&null!=c.v&&(g=!0,c=c.v,a.style+="spacingRight="+c+";"),e++;g=!1;if(null!=b.Text&&null!=b.Text.m)for(h=b.Text.m,e=0;!g&&e<h.length;)c=h[e],"mt"==c.n&&null!=c.v&&(g=!0,c=c.v,a.style+="spacingTop="+c+";"),e++;g=!1;if(null!=b.Text&&null!=b.Text.m)for(h=b.Text.m,e=0;!g&&e<h.length;)c=h[e],"mb"==c.n&&null!=c.v&&(g=!0,c=c.v,a.style+="spacingBottom="+c+";"),e++;"number"===typeof b.InsetMargin&&(a.style+="spacing="+parseInt(b.InsetMargin)+";");"string"===typeof b.LineColor&&
7<b.LineColor.length&&(h="0x"+b.LineColor.substring(b.LineColor.length-2,b.LineColor.length),a.style+="strokeOpacity="+Math.round(parseInt(h)/2.55)+";");"string"===typeof b.FillColor&&7<b.FillColor.length&&(h="0x"+b.FillColor.substring(b.FillColor.length-2,b.FillColor.length),a.style+="fillOpacity="+Math.round(parseInt(h)/2.55)+";");null!=b.Text_VAlign&&"string"===typeof b.Text_VAlign&&(a.style+="verticalAlign="+b.Text_VAlign+";")}"ImageSearchBlock2"==f.Class&&(a.style+="image="+b.URL+";");a.style+=
l(mxConstants.STYLE_STROKEWIDTH,.6*parseFloat(b.LineWidth),"1");"VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8".split(" ").includes(f.Class)?"Venn"==f.Class.substring(0,4)&&(a.style+=l(mxConstants.STYLE_STROKECOLOR,b.FillColor.substring(0,7),"#FFFFFF")):a.style=0==b.LineWidth?
a.style+(mxConstants.STYLE_STROKECOLOR+"=none;"):a.style+l(mxConstants.STYLE_STROKECOLOR,b.LineColor.substring(0,7),"#000000");a.style+=l(mxConstants.STYLE_ALIGN,b.TextAlign,"center");a.style+=l(mxConstants.STYLE_VERTICAL_ALIGN,b.TextVAlign,"middle");"VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8".split(" ").includes(f.Class)||
(a.style+=l(mxConstants.STYLE_OPACITY,b.Opacity,"100"));null!=b.Rotation&&(h=mxUtils.toDegree(parseFloat(b.Rotation)),e=["AEUSBBlock","AGSCutandpasteBlock","iOSDeviceiPadLandscape","iOSDeviceiPadProLandscape"],"AdvancedSwimLaneBlockRotated"==f.Class?(h+=90,a.geometry.rotate90()):e.includes(f.Class)&&(h-=90,a.geometry.rotate90(),a.geometry.rotate90(),a.geometry.rotate90()),a.style+="rotation="+h+";");b.FlipX&&(a.style+="flipH=1;");b.FlipY&&(a.style+="flipV=1;");null!=b.Shadow&&(a.style+=mxConstants.STYLE_SHADOW+
...
b.ElbowPoints[e].x+0),Math.round(.6*b.ElbowPoints[e].y+0)));else"elbow"==b.Shape?a.style=null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block?a.style+"edgeStyle=orthogonalEdgeStyle;":a.style+"edgeStyle=elbowEdgeStyle;":null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block&&(a.style+="edgeStyle=orthogonalEdgeStyle;","curve"==b.Shape&&(a.style+="curved=1;"));null!=b.Endpoint1.Style&&(a.style+="startArrow="+r[b.Endpoint1.Style]+";");null!=b.Endpoint2.Style&&(f=r[b.Endpoint2.Style],f=f.replace(/startSize/g,"endSize"),
a.style+="endArrow="+f+";");y(a,b.Endpoint1,!0);y(a,b.Endpoint2,!1)}}}}function z(a){var d=q(a).Properties.BoundingBox;null!=a.Class&&"AWS"===a.Class.substring(0,3)&&(d.h-=20);v=new mxCell("",new mxGeometry(Math.round(.6*d.x+0),Math.round(.6*d.y+0),Math.round(.6*d.w),Math.round(.6*d.h)),"html=1;whiteSpace=wrap;");v.vertex=!0;x(v,a);return v}function u(a,d){var f=2*(parseFloat(a.Location)-.5),f=new mxCell(t(a),new mxGeometry(f,0,0,0),"text;html=1;resizable=0;align=center;verticalAlign=middle;labelBackgroundColor=#ffffff;");
f.geometry.relative=!0;f.vertex=!0;d.insert(f);return d}function l(a,d,f,b){null!=d&&null!=b&&(d=b(d));return null!=d&&d!=f?a+"="+d+";":""}function y(a,d,f){null!=d&&null!=d.LinkX&&null!=d.LinkY&&(a.style+=(f?"exitX":"entryX")+"="+d.LinkX+";"+(f?"exitY":"entryY")+"="+d.LinkY+";"+(f?"exitPerimeter":"entryPerimeter")+"=0;")}var r={None:"none",Arrow:"block;endFill=1","Hollow Arrow":"block;endFill=0","Open Arrow":"open;","CFN ERD Zero Or More Arrow":"ERzeroToMany;startSize=10","CFN ERD One Or More Arrow":"ERoneToMany;startSize=10",
"CFN ERD Many Arrow":"ERmany;startSize=10","CFN ERD Exactly One Arrow":"ERmandOne;startSize=10","CFN ERD Zero Or One Arrow":"ERzeroToOne;startSize=10","CFN ERD One Arrow":"ERone;startSize=16",Generalization:"block;endFill=0;startSize=12","Big Open Arrow":"open;startSize=10",Asynch1:"openAsync;flipH=1;startSize=10",Asynch2:"openAsync;startSize=10",Aggregation:"diamond;endFill=0;startSize=16",Composition:"diamond;endFill=1;startSize=16",BlockEnd:"none;endFill=1;startSize=16"},B={DefaultTextBlockNew:"text;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;",
DefaultTextBlock:"text;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;",DefaultSquareBlock:"rounded=1;arcSize=5;",DefaultNoteBlock:"shape=note;size=15;",DefaultNoteBlockV2:"shape=note;size=15;",HotspotBlock:"strokeColor=none;opacity=50;",ImageSearchBlock2:"shape=image;",ProcessBlock:"rounded=1;arcSize=5;",DecisionBlock:"rhombus;rounded=1;arcSize=5;",TerminatorBlock:"rounded=1;arcSize=50;",PredefinedProcessBlock:"shape=process;rounded=1;arcSize=5;",DocumentBlock:"shape=document;",
MultiDocumentBlock:"shape=mxgraph.flowchart.multi-document;",ManualInputBlock:"shape=manualInput;size=15;rounded=1;arcSize=5;",PreparationBlock:"shape=hexagon;rounded=1;arcSize=5;",DataBlock:"shape=parallelogram;rounded=1;arcSize=5;",DataBlockNew:"shape=parallelogram;rounded=1;arcSize=5;",DatabaseBlock:"shape=cylinder;",DirectAccessStorageBlock:"shape=mxgraph.flowchart.direct_data;",InternalStorageBlock:"shape=internalStorage;rounded=1;arcSize=5;dx=10;dy=10;",PaperTapeBlock:"shape=tape;size=0.2;",
ManualOperationBlockNew:"shape=trapezoid;rounded=1;arcSize=5;flipV=1;",DelayBlock:"shape=delay;",StoredDataBlock:"shape=dataStorage;",MergeBlock:"triangle;direction=south;rounded=1;arcSize=5;",ConnectorBlock:"ellipse;",OrBlock:"shape=mxgraph.flowchart.summing_function;",SummingJunctionBlock:"shape=mxgraph.flowchart.or;",DisplayBlock:"shape=display;",OffPageLinkBlock:"shape=offPageConnector;rounded=1;arcSize=5;",BraceNoteBlock:"shape=curlyBracket;rounded=1;",NoteBlock:"shape=mxgraph.flowchart.annotation_1;",
