(function(){function h(d){var c=null!=d.Text?d.Text:null!=d.Value?d.Value:d.Lane_0;null==c&&null!=d.State?null!=d.State.t&&(c=d.State):null==c&&null!=d.Note?null!=d.Note.t&&(c=d.Note):null!=d.t&&(c=d);null==c&&null!=d.TextAreas&&null!=d.TextAreas.Text&&null!=d.TextAreas.Text.Value&&null!=d.TextAreas.Text.Value.t&&(c=d.TextAreas.Text.Value);if(null!=c){if(null!=c.t)return c.t=c.t.replace(/</g,"&lt;"),c.t=c.t.replace(/>/g,"&gt;"),c.t;if(null!=c.Value&&null!=c.Value.t)return c.Value.t=c.Value.t.replace(/</g,
"&lt;"),c.Value.t=c.Value.t.replace(/>/g,"&gt;"),c.Value.t}return""}function y(d){return null!=d.Action?d.Action:d}function x(d){if(null!=d.Text){if(null!=d.Text.m)return d.Text.m}else if(null!=d.TextAreas){if(null!=d.TextAreas.Text&&null!=d.TextAreas.Text.Value&&null!=d.TextAreas.Text.Value.m)return d.TextAreas.Text.Value.m}else if(null!=d.m)return d.m;return null}function k(d){return r(d)+q(d)+p(d)+z(d)+A(d)+B(d)+C(d)+D(d)+E(d)+F(d)}function r(d){d=x(d);if(null!=d)for(var c=0;c<d.length;){var a=
d[c];if("s"==a.n&&null!=a.v)return"fontSize="+Math.round(.6*a.v)+";";c++}return"fontSize=10;"}function q(d){d=x(d);if(null!=d)for(var c=0;c<d.length;){var a=d[c];if("c"==a.n&&null!=a.v)return d=a.v,"#"!=d.charAt(0)&&(d="#"+d),d=d.substring(0,7),mxConstants.STYLE_FONTCOLOR+"="+d+";";c++}return""}function p(d){d=x(d);if(null!=d){var c=0,a=!1;if(null!=d)for(var g=0;!a&&g<d.length;){var e=d[g];"b"==e.n&&null!=e.v&&e.v&&(a=!0,c+=1);g++}a=!1;if(null!=d)for(g=0;!a&&g<d.length;)e=d[g],"i"==e.n&&null!=e.v&&
e.v&&(a=!0,c+=2),g++;a=!1;if(null!=d)for(g=0;!a&&g<d.length;)e=d[g],"u"==e.n&&null!=e.v&&e.v&&(a=!0,c+=4),g++;if(0<c)return"fontStyle="+c+";"}return""}function z(d){d=x(d);if(null!=d)for(var c=0;c<d.length;){var a=d[c];if("a"==a.n&&null!=a.v)return"align="+a.v+";";c++}return"align=center;"}function A(d){var c=x(d);if(null!=c)for(var a=0;a<c.length;){var g=c[a];if("il"==g.n){if(null!=g.v)return"spacingLeft="+.6*g.v+";"}else if("s"==g.n&&"align=center;"!=z(d)&&null!=g.v)return"spacingLeft="+.6*g.v+
";";a++}return""}function B(d){d=x(d);if(null!=d)for(var c=0;c<d.length;){var a=d[c];if("ir"==a.n&&null!=a.v)return"spacingRight="+a.v+";";c++}return""}function C(d){d=x(d);if(null!=d)for(var c=0;c<d.length;){var a=d[c];if("mt"==a.n&&null!=a.v)return"spacingTop="+a.v+";";c++}return""}function D(d){d=x(d);if(null!=d)for(var c=0;c<d.length;){var a=d[c];if("mb"==a.n&&null!=a.v)return"spacingBottom="+a.v+";";c++}return""}function E(d){return"number"===typeof d.InsetMargin?"spacing="+parseInt(d.InsetMargin)+
";":""}function F(d){return null!=d.Text_VAlign&&"string"===typeof d.Text_VAlign?"verticalAlign="+d.Text_VAlign+";":w(mxConstants.STYLE_VERTICAL_ALIGN,d.TextVAlign,"middle")}function H(d,c){return T.includes(c.Class)?"Venn"==c.Class.substring(0,4)?w(mxConstants.STYLE_STROKECOLOR,d.FillColor.substring(0,7),"#FFFFFF"):"":0==d.LineWidth?mxConstants.STYLE_STROKECOLOR+"=none;":w(mxConstants.STYLE_STROKECOLOR,d.LineColor.substring(0,7),"#000000")}function u(d,c){var a="";U.includes(c.Class)||(a+=w(mxConstants.STYLE_OPACITY,
d.Opacity,"100"));if("string"===typeof d.LineColor&&7<d.LineColor.length)var g="0x"+d.LineColor.substring(d.LineColor.length-2,d.LineColor.length),a=a+("strokeOpacity="+Math.round(parseInt(g)/2.55)+";");"string"===typeof d.FillColor&&7<d.FillColor.length&&(g="0x"+d.FillColor.substring(d.FillColor.length-2,d.FillColor.length),a+="fillOpacity="+Math.round(parseInt(g)/2.55)+";");return a}function I(d,c){if(null!=d.Rounding&&!V.includes(c.Class)){if(0<d.Rounding)return"rounded=1;absoluteArcSize=1;arcSize="+
.6*d.Rounding+";"}else if(null==d.Rounding&&W.includes(c.Class))return"rounded=1;absoluteArcSize=1;arcSize=8;";return""}function J(d,c,a){return null!=d.Rotation&&(d=mxUtils.toDegree(parseFloat(d.Rotation)),"AdvancedSwimLaneBlockRotated"==c.Class?(d+=90,a.geometry.rotate90()):X.includes(c.Class)&&(d-=90,a.geometry.rotate90(),a.geometry.rotate90(),a.geometry.rotate90()),0!=d)?"rotation="+d+";":""}function K(d){return null!=d.Shadow?mxConstants.STYLE_SHADOW+"=1;":""}function t(d,c){if(null!=d.FillColor&&
!Y.includes(c.Class))if("object"===typeof d.FillColor){if(null!=d.FillColor.cs&&1<d.FillColor.cs.length)return w(mxConstants.STYLE_FILLCOLOR,d.FillColor.cs[0].c.substring(0,7))+w(mxConstants.STYLE_GRADIENTCOLOR,d.FillColor.cs[1].c.substring(0,7))}else return"string"===typeof d.FillColor?w(mxConstants.STYLE_FILLCOLOR,d.FillColor.substring(0,7),"#FFFFFF"):w(mxConstants.STYLE_FILLCOLOR,"none");return""}function L(d){return"dashed"==d.StrokeStyle?"dashed=1;":"dotted"==d.StrokeStyle?"dashed=1;dashPattern=1 4;":
""}function M(d){return w(mxConstants.STYLE_STROKEWIDTH,.6*parseFloat(d.LineWidth),"1")}function O(d,c){var a=y(c);if(null!=a){var g=N[a.Class]+";";null!=g&&(d.style+=g);g=null!=a.Properties?a.Properties:a;if(null!=g){d.value=h(g);var e=d.style,f=r(g)+q(g)+p(g)+z(g,d)+A(g)+B(g)+C(g)+D(g)+E(g)+F(g)+H(g,a)+u(g,a)+I(g,a)+J(g,a,d)+(g.FlipX?"flipH=1;":"")+(g.FlipY?"flipV=1;":"")+K(g)+t(g,a)+L(g)+M(g);a="ImageSearchBlock2"==a.Class?"image="+g.URL+";":"";d.style=e+(f+a);if(d.edge){d.style+="rounded=1;arcSize=6;";
if("diagonal"!=g.Shape)if(null!=g.ElbowPoints)for(d.geometry.points=[],a=0;a<g.ElbowPoints.length;a++)d.geometry.points.push(new mxPoint(Math.round(.6*g.ElbowPoints[a].x+0),Math.round(.6*g.ElbowPoints[a].y+0)));else"elbow"==g.Shape?d.style=null!=g.Endpoint1.Block&&null!=g.Endpoint1.Block?d.style+"edgeStyle=orthogonalEdgeStyle;":d.style+"edgeStyle=elbowEdgeStyle;":null!=g.Endpoint1.Block&&null!=g.Endpoint1.Block&&(d.style+="edgeStyle=orthogonalEdgeStyle;","curve"==g.Shape&&(d.style+="curved=1;"));
null!=g.Endpoint1.Style&&(d.style+="startArrow="+P[g.Endpoint1.Style]+";");null!=g.Endpoint2.Style&&(d.style+="endArrow="+P[g.Endpoint2.Style].replace(/startSize/g,"endSize")+";");Q(d,g.Endpoint1,!0);Q(d,g.Endpoint2,!1)}}}}function R(d){var c=y(d).Properties.BoundingBox;null!=d.Class&&"AWS"===d.Class.substring(0,3)&&(c.h-=20);v=new mxCell("",new mxGeometry(Math.round(.6*c.x+0),Math.round(.6*c.y+0),Math.round(.6*c.w),Math.round(.6*c.h)),"html=1;whiteSpace=wrap;");v.vertex=!0;O(v,d);return v}function G(d,
c,a){a=2*(parseFloat(d.Location)-.5);d=new mxCell(h(d),new mxGeometry(a,0,0,0),"text;html=1;resizable=0;labelBackgroundColor=#ffffff;");d.geometry.relative=!0;d.vertex=!0;c.insert(d);return c}function w(d,c,a,g){null!=c&&null!=g&&(c=g(c));return null!=c&&c!=a?d+"="+c+";":""}function Q(d,c,a){null!=c&&null!=c.LinkX&&null!=c.LinkY&&(d.style+=(a?"exitX":"entryX")+"="+c.LinkX+";"+(a?"exitY":"entryY")+"="+c.LinkY+";"+(a?"exitPerimeter":"entryPerimeter")+"=0;")}function Z(d){var c=y(d),a=c.Properties,g=
a.BoundingBox,e=Math.round(.6*g.w),f=Math.round(.6*g.h),b=Math.round(.6*g.x+0),g=Math.round(.6*g.y+0);v=new mxCell("",new mxGeometry(b,g,e,f),"html=1;whiteSpace=wrap;");v.vertex=!0;switch(d.Class){case "BraceNoteBlock":b=!1;null!=a.BraceDirection&&"Right"==a.BraceDirection&&(b=!0);b?(b=new mxCell("",new mxGeometry(e-.125*f,0,.125*f,f),"shape=curlyBracket;rounded=1;"),e=new mxCell("",new mxGeometry(0,0,e-.125*f,f),"strokeColor=none;fillColor=none;")):(b=new mxCell("",new mxGeometry(0,0,.125*f,f),"shape=curlyBracket;rounded=1;flipH=1;"),
e=new mxCell("",new mxGeometry(.125*f,0,e-.125*f,f),"strokeColor=none;fillColor=none;"));v.style="strokeColor=none;fillColor=none;";v.style+=J(a,c,v);b.vertex=!0;v.insert(b);b.style+=H(a,c)+u(a,c)+K(a)+L(a)+M(a);e.vertex=!0;e.value=h(a);v.insert(e);e.style+=r(a)+q(a)+p(a)+z(a,e)+A(a)+B(a)+C(a)+D(a)+E(a)+F(a);break;case "AdvancedSwimLaneBlockRotated":case "AdvancedSwimLaneBlock":g=0;null!=a.Lanes&&(g=a.Lanes.length);v.style="strokeColor=none;fillColor=none;";var m=0;d=[];for(b=0;b<g;b++){var l=parseFloat(a.Lanes[b].p);
d.push(new mxCell("",new mxGeometry(e*m,0,e*l,f),"shape=swimlane;startSize=25;"));d[b].vertex=!0;v.insert(d[b]);d[b].value=h(a["Lane_"+b]);d[b].style+=r(a["Lane_"+b])+q(a["Lane_"+b])+p(a["Lane_"+b])+z(a["Lane_"+b],d[b])+A(a["Lane_"+b])+B(a["Lane_"+b])+C(a["Lane_"+b])+D(a["Lane_"+b])+E(a["Lane_"+b])+F(a["Lane_"+b])+H(a,c)+u(a,c)+I(a,c)+J(a,c,d[b])+(a.FlipX?"flipH=1;":"")+(a.FlipY?"flipV=1;":"")+K(a)+t(a,c)+L(a)+M(a);m+=l}break;case "AndroidDevice":if(null!=a.AndroidDeviceName){v.style="fillColor=#000000;strokeColor=#000000;";
g=b=c=null;if("Tablet"==a.AndroidDeviceName||"Mini Tablet"==a.AndroidDeviceName)v.style+="shape=mxgraph.android.tab2;",c=new mxCell("",new mxGeometry(.112*e,.077*f,.77*e,.85*f),""),a.KeyboardShown&&(b=new mxCell("",new mxGeometry(.112*e,.727*f,.77*e,.2*f),"shape=mxgraph.android.keyboard;")),a.FullScreen||(g=new mxCell("",new mxGeometry(.112*e,.077*f,.77*e,.03*f),"shape=mxgraph.android.statusBar;strokeColor=#33b5e5;fillColor=#000000;fontColor=#33b5e5;fontSize="+.015*f+";"));else if("Large Phone"==
a.AndroidDeviceName||"Phone"==a.AndroidDeviceName)v.style+="shape=mxgraph.android.phone2;",c=new mxCell("",new mxGeometry(.04*e,.092*f,.92*e,.816*f),""),a.KeyboardShown&&(b=new mxCell("",new mxGeometry(.04*e,.708*f,.92*e,.2*f),"shape=mxgraph.android.keyboard;")),a.FullScreen||(g=new mxCell("",new mxGeometry(.04*e,.092*f,.92*e,.03*f),"shape=mxgraph.android.statusBar;strokeColor=#33b5e5;fillColor=#000000;fontColor=#33b5e5;fontSize="+.015*f+";"));c.vertex=!0;v.insert(c);"Dark"==a.Scheme?c.style+="fillColor=#111111;":
"Light"==a.Scheme&&(c.style+="fillColor=#ffffff;");null!=b&&(b.vertex=!0,v.insert(b));null!=g&&(g.vertex=!0,v.insert(g))}break;case "AndroidAlertDialog":b=new mxCell("",new mxGeometry(0,0,e,30),"strokeColor=none;fillColor=none;spacingLeft=9;");b.vertex=!0;v.insert(b);c=new mxCell("",new mxGeometry(0,25,e,10),"shape=line;strokeColor=#33B5E5;");c.vertex=!0;v.insert(c);g=new mxCell("",new mxGeometry(0,30,e,f-30),"strokeColor=none;fillColor=none;verticalAlign=top;");g.vertex=!0;v.insert(g);c=new mxCell("",
new mxGeometry(0,f-25,.5*e,25),"fillColor=none;");c.vertex=!0;v.insert(c);f=new mxCell("",new mxGeometry(.5*e,f-25,.5*e,25),"fillColor=none;");f.vertex=!0;v.insert(f);b.value=h(a.DialogTitle);b.style+=k(a.DialogTitle);g.value=h(a.DialogText);g.style+=k(a.DialogText);c.value=h(a.Button_0);c.style+=k(a.Button_0);f.value=h(a.Button_1);f.style+=k(a.Button_1);"Dark"==a.Scheme?(v.style+="strokeColor=#353535;fillColor=#282828;shadow=1;",c.style+="strokeColor=#353535;",f.style+="strokeColor=#353535;"):(v.style+=
"strokeColor=none;fillColor=#ffffff;shadow=1;",c.style+="strokeColor=#E2E2E2;",f.style+="strokeColor=#E2E2E2;");break;case "AndroidDateDialog":case "AndroidTimeDialog":b=new mxCell("",new mxGeometry(0,0,e,30),"strokeColor=none;fillColor=none;spacingLeft=9;");b.vertex=!0;v.insert(b);b.value=h(a.DialogTitle);b.style+=k(a.DialogTitle);c=new mxCell("",new mxGeometry(0,25,e,10),"shape=line;strokeColor=#33B5E5;");c.vertex=!0;v.insert(c);c=new mxCell("",new mxGeometry(0,f-25,.5*e,25),"fillColor=none;");
c.vertex=!0;v.insert(c);c.value=h(a.Button_0);c.style+=k(a.Button_0);f=new mxCell("",new mxGeometry(.5*e,f-25,.5*e,25),"fillColor=none;");f.vertex=!0;v.insert(f);f.value=h(a.Button_1);f.style+=k(a.Button_1);b=new mxCell("",new mxGeometry(.5*e-4,41,8,4),"shape=triangle;direction=north;");b.vertex=!0;v.insert(b);g=new mxCell("",new mxGeometry(.25*e-4,41,8,4),"shape=triangle;direction=north;");g.vertex=!0;v.insert(g);m=new mxCell("",new mxGeometry(.75*e-4,41,8,4),"shape=triangle;direction=north;");m.vertex=
!0;v.insert(m);l=new mxCell("",new mxGeometry(.375*e,50,.2*e,15),"strokeColor=none;fillColor=none;");l.vertex=!0;v.insert(l);l.value=h(a.Label_1);l.style+=k(a.Label_1);l=new mxCell("",new mxGeometry(.125*e,50,.2*e,15),"strokeColor=none;fillColor=none;");l.vertex=!0;v.insert(l);l.value=h(a.Label_0);l.style+=k(a.Label_0);"AndroidDateDialog"==d.Class&&(l=new mxCell("",new mxGeometry(.625*e,50,.2*e,15),"strokeColor=none;fillColor=none;"),l.vertex=!0,v.insert(l),l.value=h(a.Label_2),l.style+=k(a.Label_2));
l=new mxCell("",new mxGeometry(.43*e,60,.14*e,10),"shape=line;strokeColor=#33B5E5;");l.vertex=!0;v.insert(l);l=new mxCell("",new mxGeometry(.18*e,60,.14*e,10),"shape=line;strokeColor=#33B5E5;");l.vertex=!0;v.insert(l);l=new mxCell("",new mxGeometry(.68*e,60,.14*e,10),"shape=line;strokeColor=#33B5E5;");l.vertex=!0;v.insert(l);l=new mxCell("",new mxGeometry(.375*e,65,.2*e,15),"strokeColor=none;fillColor=none;");l.vertex=!0;v.insert(l);l.value=h(a.Label_4);l.style+=k(a.Label_4);"AndroidTimeDialog"==
d.Class&&(d=new mxCell("",new mxGeometry(.3*e,65,.1*e,15),"strokeColor=none;fillColor=none;"),d.vertex=!0,v.insert(d),d.value=h(a.Label_Colon),d.style+=k(a.Label_Colon));d=new mxCell("",new mxGeometry(.125*e,65,.2*e,15),"strokeColor=none;fillColor=none;");d.vertex=!0;v.insert(d);d.value=h(a.Label_3);d.style+=k(a.Label_3);d=new mxCell("",new mxGeometry(.625*e,65,.2*e,15),"strokeColor=none;fillColor=none;");d.vertex=!0;v.insert(d);d.value=h(a.Label_5);d.style+=k(a.Label_5);d=new mxCell("",new mxGeometry(.43*
e,75,.14*e,10),"shape=line;strokeColor=#33B5E5;");d.vertex=!0;v.insert(d);d=new mxCell("",new mxGeometry(.18*e,75,.14*e,10),"shape=line;strokeColor=#33B5E5;");d.vertex=!0;v.insert(d);d=new mxCell("",new mxGeometry(.68*e,75,.14*e,10),"shape=line;strokeColor=#33B5E5;");d.vertex=!0;v.insert(d);d=new mxCell("",new mxGeometry(.375*e,80,.2*e,15),"strokeColor=none;fillColor=none;");d.vertex=!0;v.insert(d);d.value=h(a.Label_7);d.style+=k(a.Label_7);d=new mxCell("",new mxGeometry(.125*e,80,.2*e,15),"strokeColor=none;fillColor=none;");
d.vertex=!0;v.insert(d);d.value=h(a.Label_6);d.style+=k(a.Label_6);d=new mxCell("",new mxGeometry(.625*e,80,.2*e,15),"strokeColor=none;fillColor=none;");d.vertex=!0;v.insert(d);d.value=h(a.Label_8);d.style+=k(a.Label_8);d=new mxCell("",new mxGeometry(.5*e-4,99,8,4),"shape=triangle;direction=south;");d.vertex=!0;v.insert(d);l=new mxCell("",new mxGeometry(.25*e-4,99,8,4),"shape=triangle;direction=south;");l.vertex=!0;v.insert(l);e=new mxCell("",new mxGeometry(.75*e-4,99,8,4),"shape=triangle;direction=south;");
e.vertex=!0;v.insert(e);"Dark"==a.Scheme?(v.style+="strokeColor=#353535;fillColor=#282828;shadow=1;",c.style+="strokeColor=#353535;",f.style+="strokeColor=#353535;",b.style+="strokeColor=none;fillColor=#7E7E7E;",g.style+="strokeColor=none;fillColor=#7E7E7E;",m.style+="strokeColor=none;fillColor=#7E7E7E;",d.style+="strokeColor=none;fillColor=#7E7E7E;",l.style+="strokeColor=none;fillColor=#7E7E7E;",e.style+="strokeColor=none;fillColor=#7E7E7E;"):(v.style+="strokeColor=none;fillColor=#ffffff;shadow=1;",
c.style+="strokeColor=#E2E2E2;",f.style+="strokeColor=#E2E2E2;",b.style+="strokeColor=none;fillColor=#939393;",g.style+="strokeColor=none;fillColor=#939393;",m.style+="strokeColor=none;fillColor=#939393;",d.style+="strokeColor=none;fillColor=#939393;",l.style+="strokeColor=none;fillColor=#939393;",e.style+="strokeColor=none;fillColor=#939393;");break;case "AndroidListItems":g=0;a.ShowHeader&&(g=8,c=new mxCell("",new mxGeometry(0,0,e,g),"strokeColor=none;fillColor=none;"),c.vertex=!0,v.insert(c),c.value=
h(a.Header),c.style+=k(a.Header),f-=g,c=new mxCell("",new mxGeometry(0,g-2,e,4),"shape=line;strokeColor=#999999;"),c.vertex=!0,v.insert(c));m=parseInt(a.Items);0<m&&(f/=m);d=[];c=[];for(b=0;b<m;b++)d[b]=new mxCell("",new mxGeometry(0,g+b*f,e,f),"strokeColor=none;fillColor=none;"),d[b].vertex=!0,v.insert(d[b]),d[b].value=h(a["Item_"+b]),d[b].style+=k(a["Item_"+b]),0<b&&(c[b]=new mxCell("",new mxGeometry(0,g+b*f-2,e,4),"shape=line;"),c[b].vertex=!0,v.insert(c[b]),c[b].style="Dark"==a.Scheme?c[b].style+
"strokeColor=#ffffff;":c[b].style+"strokeColor=#D9D9D9;");v.style="Dark"==a.Scheme?v.style+"strokeColor=none;fillColor=#111111;":v.style+"strokeColor=none;fillColor=#ffffff;";break;case "AndroidTabs":g=parseInt(a.Tabs);0<g&&(e/=g);m=[];c=[];for(b=0;b<g;b++)m[b]=new mxCell("",new mxGeometry(b*e,0,e,f),"strokeColor=none;fillColor=none;"),m[b].vertex=!0,v.insert(m[b]),m[b].value=h(a["Tab_"+b]),m[b].style+=k(a["Tab_"+b]),0<b&&(c[b]=new mxCell("",new mxGeometry(b*e-2,.2*f,4,.6*f),"shape=line;direction=north;"),
c[b].vertex=!0,v.insert(c[b]),c[b].style="Dark"==a.Scheme?c[b].style+"strokeColor=#484848;":c[b].style+"strokeColor=#CCCCCC;");e=new mxCell("",new mxGeometry(a.Selected*e+2,f-3,e-4,3),"strokeColor=none;fillColor=#33B5E5;");e.vertex=!0;v.insert(e);v.style="Dark"==a.Scheme?v.style+"strokeColor=none;fillColor=#333333;":v.style+"strokeColor=none;fillColor=#DDDDDD;";break;case "AndroidProgressBar":v=new mxCell("",new mxGeometry(Math.round(b),Math.round(g+.25*f),Math.round(e),Math.round(.5*f)),"html=1;whiteSpace=wrap;");
v.vertex=!0;e=new mxCell("",new mxGeometry(0,0,e*a.BarPosition,Math.round(.5*f)),"strokeColor=none;fillColor=#33B5E5;");e.vertex=!0;v.insert(e);v.style="Dark"==a.Scheme?v.style+"strokeColor=none;fillColor=#474747;":v.style+"strokeColor=none;fillColor=#BBBBBB;";break;case "AndroidImageBlock":v.style="Dark"==a.Scheme?v.style+"shape=mxgraph.mockup.graphics.simpleIcon;strokeColor=#7E7E7E;fillColor=#111111;":v.style+"shape=mxgraph.mockup.graphics.simpleIcon;strokeColor=#939393;fillColor=#ffffff;";break;
...
"fillColor=#474747;";break;case "White":v.style+="fillColor=#ffffff;"}if(a.HighlightShow)switch(e=a.HighlightTop?new mxCell("",new mxGeometry(0,0,e,2),"strokeColor=none;"):new mxCell("",new mxGeometry(0,f-2,e,2),"strokeColor=none;"),e.vertex=!0,v.insert(e),a.HighlightColor){case "Blue":e.style+="fillColor=#33B5E5;";break;case "Dark Gray":e.style+="fillColor=#B0B0B0;";break;case "White":e.style+="fillColor=#ffffff;"}if(a.VlignShow)switch(e=new mxCell("",new mxGeometry(20,5,2,f-10),"shape=line;direction=north;"),
e.vertex=!0,v.insert(e),a.VlignColor){case "Blue":e.style+="strokeColor=#244C5A;";break;case "White":e.style+="strokeColor=#ffffff;"}break;case "AndroidButton":v.value=h(a.Label);v.style+=k(a.Label)+"shape=partialRectangle;left=0;right=0;";v.style="Dark"==a.Scheme?v.style+"fillColor=#474747;strokeColor=#C6C5C6;bottom=0;":v.style+"fillColor=#DFE0DF;strokeColor=#C6C5C6;top=0;";break;case "AndroidTextBox":v.value=h(a.Label);v.style+=k(a.Label);e=new mxCell("",new mxGeometry(2,f-6,e-4,4),"shape=partialRectangle;top=0;fillColor=none;");
e.vertex=!0;v.insert(e);v.style="Dark"==a.Scheme?v.style+"fillColor=#111111;strokeColor=none;":v.style+"fillColor=#ffffff;strokeColor=none;";e.style=a.TextFocused?e.style+"strokeColor=#33B5E5;":e.style+"strokeColor=#A9A9A9;";break;case "AndroidRadioButton":c=null;a.Checked&&(c=new mxCell("",new mxGeometry(.15*e,.15*f,.7*e,.7*f),"shape=ellipse;fillColor=#33B5E5;strokeWidth=0.6;"),c.vertex=!0,v.insert(c));"Dark"==a.Scheme?(v.style+="shape=ellipse;strokeWidth=0.6;strokeColor=#272727;",a.Checked?(c.style+=
"strokeColor=#1F5C73;",v.style+="fillColor=#193C49;"):v.style+="fillColor=#111111;"):(v.style+="shape=ellipse;strokeWidth=0.6;fillColor=#ffffff;strokeColor=#5C5C5C;",a.Checked&&(c.style+="strokeColor=#999999;"));break;case "AndroidCheckBox":a.Checked&&(e=new mxCell("",new mxGeometry(.25*e,.05*-f,e,.8*f),"shape=mxgraph.ios7.misc.check;strokeColor=#33B5E5;strokeWidth=2;"),e.vertex=!0,v.insert(e));v.style="Dark"==a.Scheme?v.style+"strokeWidth=0.6;strokeColor=#272727;fillColor=#111111;":v.style+"strokeWidth=0.6;strokeColor=#5C5C5C;fillColor=#ffffff;";
...
"strokeColor=none;fillColor=none;";0<g&&(e/=g);m=[];for(b=0;b<g;b++)m[b]=new mxCell("",new mxGeometry(b*e,0,e,f),"strokeColor="+a.FillColor+";"),m[b].vertex=!0,v.insert(m[b]),m[b].value=h(a["Tab_"+b]),m[b].style+=k(a["Tab_"+b]),m[b].style=a.Selected==b?m[b].style+t(a,c):m[b].style+"fillColor=none;";break;case "iOSSlider":v.style+="shape=mxgraph.ios7ui.slider;strokeColor="+a.FillColor+";fillColor=#ffffff;strokeWidth=2;barPos="+100*a.BarPosition+";";break;case "iOSProgressBar":v=new mxCell("",new mxGeometry(Math.round(b),
Math.round(g+.25*f),Math.round(e),Math.round(.5*f)),"html=1;whiteSpace=wrap;strokeColor=none;fillColor=#B5B5B5;");v.vertex=!0;e=new mxCell("",new mxGeometry(0,0,e*a.BarPosition,Math.round(.5*f)),"strokeColor=none;"+t(a,c));e.vertex=!0;v.insert(e);break;case "iOSPageControls":v.style+="shape=mxgraph.ios7ui.pageControl;"+t(a,c)+"strokeColor=#D6D6D6;";break;case "iOSStatusBar":v.style+="shape=mxgraph.ios7ui.appBar;"+t(a,c)+"strokeColor=#000000;";c=new mxCell(h(a.Text),new mxGeometry(.35*e,0,.3*e,f),
"strokeColor=none;fillColor=none;");c.vertex=!0;v.insert(c);c.style+=k(a.Text);c=new mxCell(h(a.Carrier),new mxGeometry(.09*e,0,.2*e,f),"strokeColor=none;fillColor=none;");c.vertex=!0;v.insert(c);c.style+=k(a.Carrier);break;case "iOSSearchBar":v.style+="strokeColor=none;"+t(a,c)+u(a,c)+I(a,c)+k(a.Search);v.value=h(a.Search);c=new mxCell("",new mxGeometry(.3*e,.3*f,.4*f,.4*f),"shape=mxgraph.ios7.icons.looking_glass;strokeColor=#000000;fillColor=none;");c.vertex=!0;v.insert(c);break;case "iOSNavBar":v.style+=
"shape=partialRectangle;top=0;right=0;left=0;strokeColor=#979797;"+t(a,c)+u(a,c)+k(a.Title);v.value=h(a.Title);c=new mxCell(h(a.LeftText),new mxGeometry(.03*e,0,.3*e,f),"strokeColor=none;fillColor=none;");c.vertex=!0;v.insert(c);c.style+=k(a.LeftText);c=new mxCell(h(a.RightText),new mxGeometry(.65*e,0,.3*e,f),"strokeColor=none;fillColor=none;");c.vertex=!0;v.insert(c);c.style+=k(a.RightText);c=new mxCell("",new mxGeometry(.02*e,.2*f,.3*f,.5*f),"shape=mxgraph.ios7.misc.left;strokeColor=#007AFF;strokeWidth=2;");
c.vertex=!0;v.insert(c);break;case "iOSTabs":g=parseInt(a.Tabs);v.style+="shape=partialRectangle;right=0;left=0;bottom=0;strokeColor=#979797;"+t(a,c)+u(a,c);0<g&&(e/=g);m=[];for(b=0;b<g;b++)m[b]=new mxCell("",new mxGeometry(b*e,0,e,f),"strokeColor=none;"),m[b].vertex=!0,v.insert(m[b]),m[b].value=h(a["Tab_"+b]),m[b].style+=r(a["Tab_"+b]),m[b].style+=q(a["Tab_"+b])+p(a["Tab_"+b])+z(a["Tab_"+b])+A(a["Tab_"+b])+B(a["Tab_"+b])+C(a["Tab_"+b])+D(a["Tab_"+b])+E(a["Tab_"+b]),m[b].style+="verticalAlign=bottom;",
m[b].style=a.Selected==b?m[b].style+"fillColor=#BBBBBB;":m[b].style+"fillColor=none;";break;case "iOSDatePicker":b=new mxCell("",new mxGeometry(0,0,.5*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option11);b.style+=k(a.Option11);b=new mxCell("",new mxGeometry(.5*e,0,.15*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option21);b.style+=k(a.Option21);b=new mxCell("",new mxGeometry(.65*e,0,.15*e,.2*f),"strokeColor=none;fillColor=none;");
b.vertex=!0;v.insert(b);b.value=h(a.Option31);b.style+=k(a.Option31);b=new mxCell("",new mxGeometry(0,.2*f,.5*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option12);b.style+=k(a.Option12);b=new mxCell("",new mxGeometry(.5*e,.2*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option22);b.style+=k(a.Option22);b=new mxCell("",new mxGeometry(.65*e,.2*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=
h(a.Option32);b.style+=k(a.Option32);b=new mxCell("",new mxGeometry(0,.4*f,.5*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option13);b.style+=k(a.Option13);b=new mxCell("",new mxGeometry(.5*e,.4*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option23);b.style+=k(a.Option23);b=new mxCell("",new mxGeometry(.65*e,.4*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option33);b.style+=k(a.Option33);
b=new mxCell("",new mxGeometry(.8*e,.4*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option43);b.style+=k(a.Option43);b=new mxCell("",new mxGeometry(0,.6*f,.5*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option14);b.style+=k(a.Option14);b=new mxCell("",new mxGeometry(.5*e,.6*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option24);b.style+=k(a.Option24);b=new mxCell("",new mxGeometry(.65*
e,.6*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option34);b.style+=k(a.Option34);b=new mxCell("",new mxGeometry(.8*e,.6*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option44);b.style+=k(a.Option44);b=new mxCell("",new mxGeometry(0,.8*f,.5*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option15);b.style+=k(a.Option15);b=new mxCell("",new mxGeometry(.5*e,.8*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");
b.vertex=!0;v.insert(b);b.value=h(a.Option25);b.style+=k(a.Option25);b=new mxCell("",new mxGeometry(.65*e,.8*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option35);b.style+=k(a.Option35);l=new mxCell("",new mxGeometry(0,.4*f-2,e,4),"shape=line;strokeColor=#888888;");l.vertex=!0;v.insert(l);l=new mxCell("",new mxGeometry(0,.6*f-2,e,4),"shape=line;strokeColor=#888888;");l.vertex=!0;v.insert(l);v.style+=t(a,c)+u(a,c)+"strokeColor=none;";break;case "iOSTimePicker":b=
new mxCell("",new mxGeometry(0,0,.25*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option11);b.style+=k(a.Option11);b=new mxCell("",new mxGeometry(.25*e,0,.3*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option21);b.style+=k(a.Option21);b=new mxCell("",new mxGeometry(0,.2*f,.25*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option12);b.style+=k(a.Option12);b=new mxCell("",new mxGeometry(.25*e,.2*f,
.3*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option22);b.style+=k(a.Option22);b=new mxCell("",new mxGeometry(0,.4*f,.25*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option13);b.style+=k(a.Option13);b=new mxCell("",new mxGeometry(.25*e,.4*f,.3*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option23);b.style+=k(a.Option23);b=new mxCell("",new mxGeometry(.7*e,.4*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");
b.vertex=!0;v.insert(b);b.value=h(a.Option33);b.style+=k(a.Option33);b=new mxCell("",new mxGeometry(0,.6*f,.25*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option14);b.style+=k(a.Option14);b=new mxCell("",new mxGeometry(.25*e,.6*f,.3*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option24);b.style+=k(a.Option24);b=new mxCell("",new mxGeometry(.7*e,.6*f,.15*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=
h(a.Option34);b.style+=k(a.Option34);b=new mxCell("",new mxGeometry(0,.8*f,.25*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option15);b.style+=k(a.Option15);b=new mxCell("",new mxGeometry(.25*e,.8*f,.3*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option25);b.style+=k(a.Option25);l=new mxCell("",new mxGeometry(0,.4*f-2,e,4),"shape=line;strokeColor=#888888;");l.vertex=!0;v.insert(l);l=new mxCell("",new mxGeometry(0,.6*f-2,e,4),"shape=line;strokeColor=#888888;");
l.vertex=!0;v.insert(l);v.style+=t(a,c)+u(a,c)+"strokeColor=none;";break;case "iOSCountdownPicker":b=new mxCell("",new mxGeometry(.45*e,0,.2*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option31);b.style+=k(a.Option31);b=new mxCell("",new mxGeometry(.45*e,.2*f,.2*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option32);b.style+=k(a.Option32);b=new mxCell("",new mxGeometry(0,.4*f,.25*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=
!0;v.insert(b);b.value=h(a.Option13);b.style+=k(a.Option13);b=new mxCell("",new mxGeometry(.2*e,.4*f,.25*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option23);b.style+=k(a.Option23);b=new mxCell("",new mxGeometry(.45*e,.4*f,.2*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option33);b.style+=k(a.Option33);b=new mxCell("",new mxGeometry(.6*e,.4*f,.2*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option43);
b.style+=k(a.Option43);b=new mxCell("",new mxGeometry(0,.6*f,.25*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option14);b.style+=k(a.Option14);b=new mxCell("",new mxGeometry(.45*e,.6*f,.2*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option34);b.style+=k(a.Option34);b=new mxCell("",new mxGeometry(0,.8*f,.25*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option15);b.style+=k(a.Option15);b=new mxCell("",
new mxGeometry(.45*e,.8*f,.2*e,.2*f),"strokeColor=none;fillColor=none;");b.vertex=!0;v.insert(b);b.value=h(a.Option35);b.style+=k(a.Option35);l=new mxCell("",new mxGeometry(0,.4*f-2,e,4),"shape=line;strokeColor=#888888;");l.vertex=!0;v.insert(l);l=new mxCell("",new mxGeometry(0,.6*f-2,e,4),"shape=line;strokeColor=#888888;");l.vertex=!0;v.insert(l);v.style+=t(a,c)+u(a,c)+"strokeColor=none;";break;case "iOSBasicCell":v.style+="shape=partialRectangle;left=0;top=0;right=0;fillColor=#ffffff;strokeColor=#C8C7CC;spacing=0;align=left;spacingLeft="+
.6*a.SeparatorInset+";";v.style+=r(a.text)+q(a.text)+p(a.text)+F(a.text);v.value=h(a.text);switch(a.AccessoryIndicatorType){case "Disclosure":c=new mxCell("",new mxGeometry(.91*e,.35*f,.15*f,.3*f),"shape=mxgraph.ios7.misc.right;strokeColor=#D2D2D6;");c.vertex=!0;v.insert(c);break;case "DetailDisclosure":c=new mxCell("",new mxGeometry(.91*e,.35*f,.15*f,.3*f),"shape=mxgraph.ios7.misc.right;strokeColor=#D2D2D6;");c.vertex=!0;v.insert(c);c=new mxCell("",new mxGeometry(.79*e,.25*f,.5*f,.5*f),"shape=mxgraph.ios7.icons.info;strokeColor=#007AFF;fillColor=#ffffff;");
c.vertex=!0;v.insert(c);break;case "DetailIndicator":c=new mxCell("",new mxGeometry(.87*e,.25*f,.5*f,.5*f),"shape=mxgraph.ios7.icons.info;strokeColor=#007AFF;fillColor=#ffffff;");c.vertex=!0;v.insert(c);break;case "CheckMark":c=new mxCell("",new mxGeometry(.89*e,.37*f,.4*f,.26*f),"shape=mxgraph.ios7.misc.check;strokeColor=#007AFF;strokeWidth=2;"),c.vertex=!0,v.insert(c)}break;case "iOSSubtitleCell":v.style+="shape=partialRectangle;left=0;top=0;right=0;fillColor=#ffffff;strokeColor=#C8C7CC;align=left;spacing=0;verticalAlign=top;spacingLeft="+
.6*a.SeparatorInset+";";v.style+=r(a.subtext)+q(a.subtext)+p(a.subtext);v.value=h(a.subtext);c=new mxCell("",new mxGeometry(0,.4*f,e,.6*f),"fillColor=none;strokeColor=none;spacing=0;align=left;verticalAlign=bottom;spacingLeft="+.6*a.SeparatorInset+";");c.vertex=!0;v.insert(c);c.style+=r(a.text)+q(a.text)+p(a.text);c.value=h(a.text);switch(a.AccessoryIndicatorType){case "Disclosure":c=new mxCell("",new mxGeometry(.91*e,.35*f,.15*f,.3*f),"shape=mxgraph.ios7.misc.right;strokeColor=#D2D2D6;");c.vertex=
!0;v.insert(c);break;case "DetailDisclosure":c=new mxCell("",new mxGeometry(.91*e,.35*f,.15*f,.3*f),"shape=mxgraph.ios7.misc.right;strokeColor=#D2D2D6;");c.vertex=!0;v.insert(c);c=new mxCell("",new mxGeometry(.79*e,.25*f,.5*f,.5*f),"shape=mxgraph.ios7.icons.info;strokeColor=#007AFF;fillColor=#ffffff;");c.vertex=!0;v.insert(c);break;case "DetailIndicator":c=new mxCell("",new mxGeometry(.87*e,.25*f,.5*f,.5*f),"shape=mxgraph.ios7.icons.info;strokeColor=#007AFF;fillColor=#ffffff;");c.vertex=!0;v.insert(c);
break;case "CheckMark":c=new mxCell("",new mxGeometry(.89*e,.37*f,.4*f,.26*f),"shape=mxgraph.ios7.misc.check;strokeColor=#007AFF;strokeWidth=2;"),c.vertex=!0,v.insert(c)}break;case "iOSRightDetailCell":v.style+="shape=partialRectangle;left=0;top=0;right=0;fillColor=#ffffff;strokeColor=#C8C7CC;align=left;spacing=0;verticalAlign=middle;spacingLeft="+.6*a.SeparatorInset+";";v.style+=r(a.subtext)+q(a.subtext)+p(a.subtext);v.value=h(a.subtext);switch(a.AccessoryIndicatorType){case "Disclosure":c=new mxCell("",
new mxGeometry(.91*e,.35*f,.15*f,.3*f),"shape=mxgraph.ios7.misc.right;strokeColor=#D2D2D6;");c.vertex=!0;v.insert(c);c=new mxCell("",new mxGeometry(.55*e,0,.3*e,f),"fillColor=none;strokeColor=none;spacing=0;align=right;");break;case "DetailDisclosure":c=new mxCell("",new mxGeometry(.91*e,.35*f,.15*f,.3*f),"shape=mxgraph.ios7.misc.right;strokeColor=#D2D2D6;");c.vertex=!0;v.insert(c);c=new mxCell("",new mxGeometry(.79*e,.25*f,.5*f,.5*f),"shape=mxgraph.ios7.icons.info;strokeColor=#007AFF;fillColor=#ffffff;");
c.vertex=!0;v.insert(c);c=new mxCell("",new mxGeometry(.45*e,0,.3*e,f),"fillColor=none;strokeColor=none;spacing=0;align=right;");break;case "DetailIndicator":c=new mxCell("",new mxGeometry(.87*e,.25*f,.5*f,.5*f),"shape=mxgraph.ios7.icons.info;strokeColor=#007AFF;fillColor=#ffffff;");c.vertex=!0;v.insert(c);c=new mxCell("",new mxGeometry(.52*e,0,.3*e,f),"fillColor=none;strokeColor=none;spacing=0;align=right;");break;case "CheckMark":c=new mxCell("",new mxGeometry(.89*e,.37*f,.4*f,.26*f),"shape=mxgraph.ios7.misc.check;strokeColor=#007AFF;strokeWidth=2;");
c.vertex=!0;v.insert(c);c=new mxCell("",new mxGeometry(.55*e,0,.3*e,f),"fillColor=none;strokeColor=none;spacing=0;align=right;");break;default:c=new mxCell("",new mxGeometry(.65*e,0,.3*e,f),"fillColor=none;strokeColor=none;spacing=0;align=right;")}c.vertex=!0;v.insert(c);c.style+=r(a.text)+q(a.text)+p(a.text);c.value=h(a.text);break;case "iOSLeftDetailCell":v.style+="shape=partialRectangle;left=0;top=0;right=0;fillColor=#ffffff;strokeColor=#C8C7CC;";c=new mxCell("",new mxGeometry(0,0,.25*e,f),"fillColor=none;strokeColor=none;spacing=0;align=right;verticalAlign=middle;spacingRight=3;");
c.vertex=!0;v.insert(c);c.style+=r(a.subtext)+q(a.subtext)+p(a.subtext);c.value=h(a.subtext);c=new mxCell("",new mxGeometry(.25*e,0,.5*e,f),"fillColor=none;strokeColor=none;spacing=0;align=left;verticalAlign=middle;spacingLeft=3;");c.vertex=!0;v.insert(c);c.style+=r(a.text)+q(a.text)+p(a.text);c.value=h(a.text);switch(a.AccessoryIndicatorType){case "Disclosure":c=new mxCell("",new mxGeometry(.91*e,.35*f,.15*f,.3*f),"shape=mxgraph.ios7.misc.right;strokeColor=#D2D2D6;");c.vertex=!0;v.insert(c);break;
case "DetailDisclosure":c=new mxCell("",new mxGeometry(.91*e,.35*f,.15*f,.3*f),"shape=mxgraph.ios7.misc.right;strokeColor=#D2D2D6;");c.vertex=!0;v.insert(c);c=new mxCell("",new mxGeometry(.79*e,.25*f,.5*f,.5*f),"shape=mxgraph.ios7.icons.info;strokeColor=#007AFF;fillColor=#ffffff;");c.vertex=!0;v.insert(c);break;case "DetailIndicator":c=new mxCell("",new mxGeometry(.87*e,.25*f,.5*f,.5*f),"shape=mxgraph.ios7.icons.info;strokeColor=#007AFF;fillColor=#ffffff;");c.vertex=!0;v.insert(c);break;case "CheckMark":c=
new mxCell("",new mxGeometry(.89*e,.37*f,.4*f,.26*f),"shape=mxgraph.ios7.misc.check;strokeColor=#007AFF;strokeWidth=2;"),c.vertex=!0,v.insert(c)}break;case "iOSTableGroupedSectionBreak":v.style+="shape=partialRectangle;left=0;right=0;fillColor=#EFEFF4;strokeColor=#C8C7CC;";c=new mxCell("",new mxGeometry(0,0,e,.4*f),"fillColor=none;strokeColor=none;spacing=10;align=left;");c.vertex=!0;v.insert(c);c.style+=r(a.text)+q(a.text)+p(a.text);c.value=h(a.text);c=new mxCell("",new mxGeometry(0,.6*f,e,.4*f),
"fillColor=none;strokeColor=none;spacing=10;align=left;");c.vertex=!0;v.insert(c);c.style+=r(a["bottom-text"])+q(a["bottom-text"])+p(a["bottom-text"]);c.value=h(a["bottom-text"]);break;case "iOSTablePlainHeaderFooter":v.style+="fillColor=#F7F7F7;strokeColor=none;align=left;spacingLeft=5;spacing=0;",v.style+=r(a.text)+q(a.text)+p(a.text),v.value=h(a.text)}return v}var V=["GSDFDProcessBlock","RoundedRectangleContainerBlock","UI2ButtonBlock","UMLStateBlock"],W=["ProcessBlock","UMLActivationBlock"],T=
"VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8 UMLEndBlock DefaultTextBlockNew iOSButton".split(" "),Y="AWSAndroidBlock3 AWSiOSBlock3 AWSJavaBlock3 AWSJavaScript AWSNetBlock3 AWSNodeJSBlock3 AWSPHPBlock3 AWSPythonBlock3 AWSRubyBlock3 AWSXamarin AWSCLIBlock3 AWSEclipseToolkitBlock3 AWSVisualStudioToolkitBlock3 AWSWindowsPowershellToolkitBlock3 DefaultTextBlock RectangleContainerBlock UMLStartBlock UMLEndBlock DefaultTextBlockNew UMLHForkJoinBlock iOSButton".split(" "),
U="VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8".split(" "),X=["AEUSBBlock","AGSCutandpasteBlock","iOSDeviceiPadLandscape","iOSDeviceiPadProLandscape"],P={None:"none",Arrow:"block;endFill=1","Hollow Arrow":"block;endFill=0","Open Arrow":"open;","CFN ERD Zero Or More Arrow":"ERzeroToMany;startSize=10",
...
ERDEntityBlock2:"mxCompositeShape",ERDEntityBlock3:"mxCompositeShape",ERDEntityBlock4:"mxCompositeShape",SMPage:"mxCompositeShape",SMHome:"mxCompositeShape",SMGallery:"mxCompositeShape",SMShopping:"mxCompositeShape",SMMap:"mxCompositeShape",SMAthletics:"mxCompositeShape",SMLogin:"mxCompositeShape",SMPrint:"mxCompositeShape",SMScript:"mxCompositeShape",SMSearch:"mxCompositeShape",SMSettings:"mxCompositeShape",SMSitemap:"mxCompositeShape",SMSuccess:"mxCompositeShape",SMVideo:"mxCompositeShape",SMAudio:"mxCompositeShape",
SMBlog:"mxCompositeShape",SMCalendar:"mxCompositeShape",SMChart:"mxCompositeShape",SMCloud:"mxCompositeShape",SMDocument:"mxCompositeShape",SMDownload:"mxCompositeShape",SMError:"mxCompositeShape",SMForm:"mxCompositeShape",SMGame:"mxCompositeShape",SMJobs:"mxCompositeShape",SMLucid:"mxCompositeShape",SMNewspress:"mxCompositeShape",SMPhoto:"mxCompositeShape",SMPortfolio:"mxCompositeShape",SMPricing:"mxCompositeShape",SMProfile:"mxCompositeShape",SMSlideshow:"mxCompositeShape",SMUpload:"mxCompositeShape",
UMLClassBlock:"",UMLActiveClassBlock:"shape=process",UMLPackageBlock:"shape=folder;tabPosition=left",UMLNoteBlock:"shape=note;size=15",UMLTextBlock:"shape=text;strokeColor=none;fillColor=none",UMLActorBlock:"shape=umlActor;labelPosition=center;verticalLabelPosition=bottom;verticalAlign=top;whiteSpace=nowrap",UMLUseCaseBlock:"shape=ellipse",UMLCircleContainerBlock:"shape=ellipse;container=1",UMLRectangleContainerBlock:"container=1",UMLOptionLoopBlock:"shape=mxgraph.sysml.package2;xSize=90;overflow=fill",
UMLAlternativeBlock2:"shape=mxgraph.sysml.package2;xSize=90;overflow=fill",UMLStartBlock:"shape=ellipse;fillColor=#000000",UMLStateBlock:"rounded=1;arcSize=20",UMLDecisionBlock:"shape=rhombus;",UMLHForkJoinBlock:"fillColor=#000000",UMLVForkJoinBlock:"fillColor=#000000",UMLFlowFinalBlock:"shape=mxgraph.flowchart.or",UMLHistoryStateBlock:"shape=ellipse",UMLEndBlock:"shape=mxgraph.bpmn.shape;outline=end;symbol=terminate;strokeColor=#000000;fillColor=#ffffff",UMLObjectBlock:"",UMLSendSignalBlock:"shape=mxgraph.sysml.sendSigAct",
UMLReceiveSignalBlock:"shape=mxgraph.sysml.accEvent;flipH=1",UMLAcceptTimeEventActionBlock:"shape=mxgraph.sysml.timeEvent",UMLOffPageLinkBlock:"shape=mxgraph.sysml.sendSigAct;direction=south",UMLMultiLanePoolBlock:"mxCompositeShape",UMLMultiLanePoolRotatedBlock:"mxCompositeShape",UMLMultidimensionalSwimlane:"mxCompositeShape",UMLActivationBlock:"",UMLDeletionBlock:"shape=mxgraph.sysml.x;strokeWidth=4",UMLSeqEntityBlock:"shape=mxgraph.electrical.radio.microphone_1;direction=north",UMLComponentBlock:"shape=component;align=left;spacingLeft=36",
UMLNodeBlock:"shape=cube;size=12;flipH=1",UMLComponentInterfaceBlock:"shape=ellipse",UMLComponentBoxBlock:"mxCompositeShape",UMLProvidedInterfaceBlock:"shape=lollipop;direction=south",UMLRequiredInterfaceBlock:"shape=requires;direction=north",UMLEntityBlock:"",UMLWeakEntityBlock:"shape=ext;double=1",UMLAttributeBlock:"shape=ellipse",UMLMultivaluedAttributeBlock:"shape=doubleEllipse",UMLRelationshipBlock:"shape=rhombus",UMLWeakRelationshipBlock:"shape=rhombus;double=1",BPMNActivity:"mxCompositeShape",
BPMNGateway:"mxCompositeShape",BPMNData:"mxCompositeShape",BPMNDataStore:"mxCompositeShape",BPMNAdvancedPoolBlock:"mxCompositeShape",BPMNAdvancedPoolBlockRotated:"mxCompositeShape",BPMNBlackPool:"mxCompositeShape",DFDExternalEntityBlock2:"",YDMDFDProcessBlock:"shape=ellipse",YDMDFDDataStoreBlock:"shape=partialRectangle;right=0;left=0",GSDFDProcessBlock:"shape=swimlane;rounded=1;arcSize=10",GSDFDProcessBlock2:"",GSDFDDataStoreBlock2:"shape=partialRectangle;right=0",OrgBlock:"",DefaultTableBlock:"mxCompositeShape",
VSMCustomerSupplierBlock:"shape=mxgraph.lean_mapping.outside_sources",VSMDedicatedProcessBlock:"shape=mxgraph.lean_mapping.manufacturing_process",VSMSharedProcessBlock:"shape=mxgraph.lean_mapping.manufacturing_process_shared",VSMWorkcellBlock:"shape=mxgraph.lean_mapping.work_cell",VSMDatacellBlock:"mxCompositeShape",VSMInventoryBlock:"shape=mxgraph.lean_mapping.inventory_box",VSMSupermarketBlock:"mxCompositeShape",VSMPhysicalPullBlock:"shape=mxgraph.lean_mapping.physical_pull;direction=south",VSMFIFOLaneBlock:"shape=mxgraph.lean_mapping.fifo_sequence_flow;fontStyle=0;fontSize=20",
...
AWSEC2OptimizedInstance2:"strokeColor=none;shape=mxgraph.aws3.optimized_instance","AWSAmazonEC2(Spotinstance)":"strokeColor=none;shape=mxgraph.aws3.spot_instance",AWSAmazonECR:"strokeColor=none;shape=mxgraph.aws3.ecr",AWSAmazonECS:"strokeColor=none;shape=mxgraph.aws3.ecs",AWSLambda2:"strokeColor=none;shape=mxgraph.aws3.lambda",AWSElasticLoadBalancing:"strokeColor=none;shape=mxgraph.aws3.elastic_load_balancing",AWSElasticLoadBlock2:"strokeColor=none;shape=mxgraph.aws3.classic_load_balancer",AWSDirectConnectBlock3:"strokeColor=none;shape=mxgraph.aws3.direct_connect",
AWSElasticNetworkBlock2:"strokeColor=none;shape=mxgraph.aws3.elastic_network_interface",AWSRoute53Block2:"strokeColor=none;shape=mxgraph.aws3.route_53",AWSHostedZoneBlock2:"strokeColor=none;shape=mxgraph.aws3.hosted_zone;fontColor=#FFFFFF;fontStyle=1",AWSRouteTableBlock2:"strokeColor=none;shape=mxgraph.aws3.route_table",AWSVPCBlock2:"strokeColor=none;shape=mxgraph.aws3.vpc",AWSVPNConnectionBlock2:"strokeColor=none;shape=mxgraph.aws3.vpn_connection",AWSVPNGatewayBlock2:"strokeColor=none;shape=mxgraph.aws3.vpn_gateway",
AWSCustomerGatewayBlock2:"strokeColor=none;shape=mxgraph.aws3.customer_gateway",AWSCustomerGatewayBlock3:"strokeColor=none;shape=mxgraph.aws3.customer_gateway",AWSInternetGatewayBlock2:"strokeColor=none;shape=mxgraph.aws3.internet_gateway",AWSRouterBlock2:"strokeColor=none;shape=mxgraph.aws3.router",AWSRouterBlock3:"strokeColor=none;shape=mxgraph.aws3.router","AWSAmazonVPC(endpoints)":"strokeColor=none;shape=mxgraph.aws3.endpoints","AWSAmazonVPC(flowlogs)":"strokeColor=none;shape=mxgraph.aws3.flow_logs",
"AWSAmazonVPC(VPCNATgateway)":"strokeColor=none;shape=mxgraph.aws3.vpc_nat_gateway",AWSVPCPeering3:"strokeColor=none;shape=mxgraph.aws3.vpc_peering",AWSSimpleStorageBlock2:"strokeColor=none;shape=mxgraph.aws3.s3",AWSBucketBlock2:"strokeColor=none;shape=mxgraph.aws3.bucket;fontStyle=1;fontColor=#ffffff",AWSBuckethWithObjectsBlock2:"strokeColor=none;shape=mxgraph.aws3.bucket_with_objects",AWSObjectBlock2:"strokeColor=none;shape=mxgraph.aws3.object;fontStyle=1;fontColor=#ffffff",AWSImportExportBlock2:"strokeColor=none;shape=mxgraph.aws3.import_export",
AWSStorageGatewayBlock2:"strokeColor=none;shape=mxgraph.aws3.storage_gateway",AWSElasticBlockStorageBlock2:"strokeColor=none;shape=mxgraph.aws3.volume;fontStyle=1;fontColor=#ffffff",AWSVolumeBlock3:"strokeColor=none;shape=mxgraph.aws3.volume;fontStyle=1;fontColor=#ffffff",AWSSnapshotBlock2:"strokeColor=none;shape=mxgraph.aws3.snapshot;fontStyle=1;fontColor=#ffffff",AWSGlacierArchiveBlock3:"strokeColor=none;shape=mxgraph.aws3.archive",AWSGlacierVaultBlock3:"strokeColor=none;shape=mxgraph.aws3.vault",
AWSAmazonEFS:"strokeColor=none;shape=mxgraph.aws3.efs",AWSGlacierBlock2:"strokeColor=none;shape=mxgraph.aws3.glacier",AWSAWSImportExportSnowball:"strokeColor=none;shape=mxgraph.aws3.snowball",AWSStorageGatewayCachedVolumn2:"strokeColor=none;shape=mxgraph.aws3.cached_volume","AWSStorageGatewayNon-CachedVolumn2":"strokeColor=none;shape=mxgraph.aws3.non_cached_volume",AWSStorageGatewayVirtualTapeLibrary2:"strokeColor=none;shape=mxgraph.aws3.virtual_tape_library",AWSCloudFrontBlock2:"strokeColor=none;shape=mxgraph.aws3.cloudfront",
AWSDownloadDistBlock2:"strokeColor=none;shape=mxgraph.aws3.download_distribution",AWSStreamingBlock2:"strokeColor=none;shape=mxgraph.aws3.streaming_distribution",AWSEdgeLocationBlock2:"strokeColor=none;shape=mxgraph.aws3.edge_location",AWSItemBlock2:"strokeColor=none;shape=mxgraph.aws3.item",AWSItemsBlock2:"strokeColor=none;shape=mxgraph.aws3.items",AWSAttributeBlock2:"strokeColor=none;shape=mxgraph.aws3.attribute",AWSAttributesBlock2:"strokeColor=none;shape=mxgraph.aws3.attributes",AWSRDBSBlock2:"strokeColor=none;shape=mxgraph.aws3.rds",
AWSRDSInstanceBlock2:"strokeColor=none;shape=mxgraph.aws3.rds_db_instance",AWSRDSStandbyBlock2:"strokeColor=none;shape=mxgraph.aws3.rds_db_instance_standby_multi_az",AWSRDSInstanceReadBlock2:"strokeColor=none;shape=mxgraph.aws3.rds_db_instance_read_replica",AWSOracleDBBlock2:"strokeColor=none;shape=mxgraph.aws3.oracle_db_instance",AWSMySQLDBBlock2:"strokeColor=none;shape=mxgraph.aws3.mysql_db_instance",AWSDynamoDBBlock2:"strokeColor=none;shape=mxgraph.aws3.dynamo_db",AWSSimpleDatabaseBlock3:"strokeColor=none;shape=mxgraph.aws2.database.simpledb",
AWSSimpleDatabaseDomainBlock3:"strokeColor=none;shape=mxgraph.aws2.database.simpledb_domain",AWSTableBlock2:"strokeColor=none;shape=mxgraph.aws3.table",AWSAmazonRedShiftBlock3:"strokeColor=none;shape=mxgraph.aws3.redshift",AWSElastiCacheNodeBlock2:"strokeColor=none;shape=mxgraph.aws3.cache_node",AWSElastiCacheBlock2:"strokeColor=none;shape=mxgraph.aws3.elasticache",AWSDynamoDBGlobalSecondaryIndexes2:"strokeColor=none;shape=mxgraph.aws3.global_secondary_index",AWSAmazonElastiCacheMemcache2:"strokeColor=none;shape=mxgraph.aws3.memcached",
AWSAmazonElastiCacheRedis2:"strokeColor=none;shape=mxgraph.aws3.redis",AWSAmazonRDSMSSQLInstance2:"strokeColor=none;shape=mxgraph.aws3.ms_sql_instance_2",AWSMSSQLDBBlock3:"strokeColor=none;shape=mxgraph.aws3.ms_sql_instance",AWSAmazonRDSMySQLDBInstance2:"strokeColor=none;shape=mxgraph.aws3.mysql_db_instance_2",AWSAmazonRDSOracleDBInstance2:"strokeColor=none;shape=mxgraph.aws3.oracle_db_instance_2",AWSRDSReplicasetswithPIOP2:"strokeColor=none;shape=mxgraph.aws3.piop",AWSAmazonRDSPostgreSQL2:"strokeColor=none;shape=mxgraph.aws3.postgre_sql_instance",
AWSRDSMasterSQL2:"strokeColor=none;shape=mxgraph.aws3.sql_master",AWSRDSSlaveSQL2:"strokeColor=none;shape=mxgraph.aws3.sql_slave","AWSAmazonRedshift(densecomputenode)":"strokeColor=none;shape=mxgraph.aws3.dense_compute_node","AWSAmazonRedshift(densestoragenode)":"strokeColor=none;shape=mxgraph.aws3.dense_storage_node",AWSAWSDatabaseMigrationService:"strokeColor=none;shape=mxgraph.aws3.database_migration_service",AWSACM:"strokeColor=none;shape=mxgraph.aws3.certificate_manager",AWSAmazonInspector:"strokeColor=none;shape=mxgraph.aws3.inspector",
AWSAWSCloudHSM:"strokeColor=none;shape=mxgraph.aws3.cloudhsm",AWSDirectoryService2:"strokeColor=none;shape=mxgraph.aws3.directory_service",AWSAWSKMS:"strokeColor=none;shape=mxgraph.aws3.kms",AWSAWSWAF:"strokeColor=none;shape=mxgraph.aws3.waf","AWSACM(certificate-manager)":"strokeColor=none;shape=mxgraph.aws3.certificate_manager_2",AWSSESBlock2:"strokeColor=none;shape=mxgraph.aws3.ses",AWSEmailBlock2:"strokeColor=none;shape=mxgraph.aws3.email",AWSSNSBlock2:"strokeColor=none;shape=mxgraph.aws3.sns",
AWSSQSBlock3:"strokeColor=none;shape=mxgraph.aws3.sqs",AWSQueueBlock2:"strokeColor=none;shape=mxgraph.aws3.queue",AWSMessageBlock2:"strokeColor=none;shape=mxgraph.aws3.message",AWSDeciderBlock2:"strokeColor=none;shape=mxgraph.aws3.decider",AWSSWFBlock2:"strokeColor=none;shape=mxgraph.aws3.swf",AWSWorkerBlock2:"strokeColor=none;shape=mxgraph.aws3.worker",AWSCloudSearchBlock2:"strokeColor=none;shape=mxgraph.aws3.cloudsearch",AWSCloudSearchMetadataBlock3:"strokeColor=none;shape=mxgraph.aws3.search_documents",
...
Image_iphone_mark_as_read:"shape=ellipse",Image_iphone_pin_green:"shape=mxgraph.ios.iPin;fillColor2=#00dd00;fillColor3=#004400;strokeColor=#006600",Image_iphone_pin_red:"shape=mxgraph.ios.iPin;fillColor2=#dd0000;fillColor3=#440000;strokeColor=#660000",Image_iphone_radio_off:"shape=ellipse",Image_iphone_checkbox_off:"",Image_iphone_indicator:"fillColor=#e8878E;gradientColor=#BD1421;strokeColor=#ffffff",Image_iphone_thread_count:""},S=function(d,c,a){a.includes(d)||a.push(d);if(d in c){var g=c[d];g.id=
d;if(null!=g.Members)for(var e in g.Members)a=S(e,c,a)}return a};EditorUi.prototype.pasteLucidChart=function(d,c,a,g){var e=this.editor.graph;e.getModel().beginUpdate();try{var f=function(a,c){var d=null!=c.Endpoint1.Block?h[c.Endpoint1.Block]:null,f=null!=c.Endpoint2.Block?h[c.Endpoint2.Block]:null,g;g=new mxCell("",new mxGeometry(0,0,100,100),"html=1;");g.geometry.relative=!0;g.edge=!0;O(g,a);var k=y(a).Properties,l=null!=k?k.TextAreas:a.TextAreas;if(null!=l){for(var m=0;null!=l["t"+m];){var n=
l["t"+m];g=G(n,g);m++}for(m=1;null!=l["m"+m];)n=l["m"+m],g=G(n,g,a),m++;null!=l.Text&&(g=G(l,g,a));l=null!=k?k.TextAreas:a.TextAreas;null!=l.Message&&(g=G(l.Message,g,a))}null==d&&null!=c.Endpoint1&&g.geometry.setTerminalPoint(new mxPoint(Math.round(.6*c.Endpoint1.x),Math.round(.6*c.Endpoint1.y)),!0);null==f&&null!=c.Endpoint2&&g.geometry.setTerminalPoint(new mxPoint(Math.round(.6*c.Endpoint2.x),Math.round(.6*c.Endpoint2.y)),!1);b.push(e.addCell(g,null,null,d,f))},b=[],h={},k=[],r=[],q=0;if(null!=
d.Groups)for(var p in d.Groups){var n=d.Groups[p];n.id=p;if(1==n.Hidden&&null!=n.Members){r.includes(p)||r.push(p);for(var t in n.Members)r=S(t,d.Groups,r)}}if(null!=d.Blocks)for(p in d.Blocks)n=d.Blocks[p],n.id=p,r.includes(p)||(t=!1,null!=N[n.Class]&&"mxCompositeShape"==N[n.Class]&&(h[n.id]=Z(n),k.push(n),t=!0),t||(h[n.id]=R(n),k.push(n)));else for(q=0;q<d.Objects.length;q++)n=d.Objects[q],n.IsBlock&&null!=n.Action&&null!=n.Action.Properties&&(h[n.id]=R(n)),k.push(n);k.sort(function(a,b){a=y(a);
b=y(b);return null!=a.Properties&&null!=b.Properties?a.Properties.ZOrder-b.Properties.ZOrder:0});for(q=0;q<k.length;q++){var n=k[q],w=h[n.id];null!=w?b.push(e.addCell(w)):n.IsLine&&null!=n.Action&&null!=n.Action.Properties&&f(n,n.Action.Properties)}if(null!=d.Lines)for(p in d.Lines)r.includes(p)||(n=d.Lines[p],f(n,n));if(g&&null!=c&&null!=a){e.isGridEnabled()&&(c=e.snap(c),a=e.snap(a));var u=e.getBoundingBoxFromGeometry(b,!0);null!=u&&e.moveCells(b,c-u.x,a-u.y)}e.setSelectionCells(b)}finally{e.getModel().endUpdate()}e.isSelectionEmpty()||
(e.scrollCellToVisible(e.getSelectionCell()),null!=this.hoverIcons&&this.hoverIcons.update(e.view.getState(e.getSelectionCell())))}})();