...
function q(a){return null!=a.Action?a.Action:a}function x(a,d){var e=q(d);if(null!=e){var b=B[e.Class]+";";null!=b&&(a.style+=b);b=null!=e.Properties?e.Properties:e;if(null!=b){a.value=t(b);var h=!1,g;a:{if(null!=b.Text){if(null!=b.Text.m){g=b.Text.m;break a}}else if(null!=b.TextAreas&&null!=b.TextAreas.Text&&null!=b.TextAreas.Text.Value&&null!=b.TextAreas.Text.Value.m){g=b.TextAreas.Text.Value.m;break a}g=null}if(null!=g)for(var f=0;!h&&f<g.length;){var c=g[f];"s"==c.n&&null!=c.v&&(h=!0,c=c.v,c=
Math.round(.6*c),a.style+="fontSize="+c+";");f++}0==h&&(a.style+="fontSize=10;");h=!1;if(null!=g){for(f=0;!h&&f<g.length;)c=g[f],"c"==c.n&&null!=c.v&&(h=!0,c=c.v,"#"!=c.charAt(0)&&(c="#"+c),c=c.substring(0,7),a.style+=mxConstants.STYLE_FONTCOLOR+"="+c+";"),f++;var h=0,m=!1;if(null!=g)for(f=0;!m&&f<g.length;)c=g[f],"b"==c.n&&null!=c.v&&c.v&&(m=!0,h+=1),f++;m=!1;if(null!=g)for(f=0;!m&&f<g.length;)c=g[f],"i"==c.n&&null!=c.v&&c.v&&(m=!0,h+=2),f++;m=!1;if(null!=g)for(f=0;!m&&f<g.length;)c=g[f],"u"==c.n&&
null!=c.v&&c.v&&(m=!0,h+=4),f++;0<h&&(a.style+="fontStyle="+h+";");h=!1;if(null!=g)for(f=0;!h&&f<g.length;)c=g[f],"a"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="align="+c+";"),f++;h||(a.style+="align=center;");h=!1;if(null!=g)for(f=0;!h&&f<g.length;)c=g[f],"il"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="spacingLeft="+c+";"),f++;h=!1;if(null!=g)for(f=0;!h&&f<g.length;)c=g[f],"ir"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="spacingRight="+c+";"),f++;h=!1;if(null!=g)for(f=0;!h&&f<g.length;)c=g[f],"mt"==c.n&&null!=
c.v&&(h=!0,c=c.v,a.style+="spacingTop="+c+";"),f++;h=!1;if(null!=g)for(f=0;!h&&f<g.length;)c=g[f],"mb"==c.n&&null!=c.v&&(h=!0,c=c.v,a.style+="spacingBottom="+c+";"),f++;"number"===typeof b.InsetMargin&&(a.style+="spacing="+parseInt(b.InsetMargin)+";");null!=b.Text_VAlign&&"string"===typeof b.Text_VAlign&&(a.style+="verticalAlign="+b.Text_VAlign+";")}"ImageSearchBlock2"==e.Class&&(a.style+="image="+b.URL+";");a.style+=l(mxConstants.STYLE_STROKEWIDTH,.6*parseFloat(b.LineWidth),"1");C.includes(e.Class)?
"Venn"==e.Class.substring(0,4)&&(a.style+=l(mxConstants.STYLE_STROKECOLOR,b.FillColor.substring(0,7),"#FFFFFF")):a.style=0==b.LineWidth?a.style+(mxConstants.STYLE_STROKECOLOR+"=none;"):a.style+l(mxConstants.STYLE_STROKECOLOR,b.LineColor.substring(0,7),"#000000");a.style+=l(mxConstants.STYLE_ALIGN,b.TextAlign,"center");a.style+=l(mxConstants.STYLE_VERTICAL_ALIGN,b.TextVAlign,"middle");D.includes(e.Class)||(a.style+=l(mxConstants.STYLE_OPACITY,b.Opacity,"100"));"string"===typeof b.LineColor&&7<b.LineColor.length&&
(g="0x"+b.LineColor.substring(b.LineColor.length-2,b.LineColor.length),a.style+="strokeOpacity="+Math.round(parseInt(g)/2.55)+";");"string"===typeof b.FillColor&&7<b.FillColor.length&&(g="0x"+b.FillColor.substring(b.FillColor.length-2,b.FillColor.length),a.style+="fillOpacity="+Math.round(parseInt(g)/2.55)+";");null==b.Rounding||E.includes(e.Class)?null==b.Rounding&&F.includes(e.Class)&&(a.style+="rounded=1;absoluteArcSize=1;arcSize=8;"):0<b.Rounding&&(a.style+="rounded=1;absoluteArcSize=1;arcSize="+
.6*b.Rounding+";");null!=b.Rotation&&(g=mxUtils.toDegree(parseFloat(b.Rotation)),"AdvancedSwimLaneBlockRotated"==e.Class?(g+=90,a.geometry.rotate90()):G.includes(e.Class)&&(g-=90,a.geometry.rotate90(),a.geometry.rotate90(),a.geometry.rotate90()),0!=g&&(a.style+="rotation="+g+";"));b.FlipX&&(a.style+="flipH=1;");b.FlipY&&(a.style+="flipV=1;");null!=b.Shadow&&(a.style+=mxConstants.STYLE_SHADOW+"=1;");"dashed"==b.StrokeStyle?a.style+="dashed=1;":"dotted"==b.StrokeStyle&&(a.style+="dashed=1;dashPattern=1 4;");
null==b.FillColor||H.includes(e.Class)||("object"===typeof b.FillColor?null!=b.FillColor.cs&&1<b.FillColor.cs.length&&(a.style+=l(mxConstants.STYLE_FILLCOLOR,b.FillColor.cs[0].c.substring(0,7)),a.style+=l(mxConstants.STYLE_GRADIENTCOLOR,b.FillColor.cs[1].c.substring(0,7))):a.style="string"===typeof b.FillColor?a.style+l(mxConstants.STYLE_FILLCOLOR,b.FillColor.substring(0,7),"#FFFFFF"):a.style+l(mxConstants.STYLE_FILLCOLOR,"none"));if(a.edge){a.style+="rounded=1;arcSize=6;";if("diagonal"!=b.Shape)if(null!=
b.ElbowPoints)for(a.geometry.points=[],f=0;f<b.ElbowPoints.length;f++)a.geometry.points.push(new mxPoint(Math.round(.6*b.ElbowPoints[f].x+0),Math.round(.6*b.ElbowPoints[f].y+0)));else"elbow"==b.Shape?a.style=null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block?a.style+"edgeStyle=orthogonalEdgeStyle;":a.style+"edgeStyle=elbowEdgeStyle;":null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block&&(a.style+="edgeStyle=orthogonalEdgeStyle;","curve"==b.Shape&&(a.style+="curved=1;"));null!=b.Endpoint1.Style&&(a.style+=
"startArrow="+r[b.Endpoint1.Style]+";");null!=b.Endpoint2.Style&&(a.style+="endArrow="+r[b.Endpoint2.Style].replace(/startSize/g,"endSize")+";");y(a,b.Endpoint1,!0);y(a,b.Endpoint2,!1)}}}}function z(a){var d=q(a).Properties.BoundingBox;null!=a.Class&&"AWS"===a.Class.substring(0,3)&&(d.h-=20);v=new mxCell("",new mxGeometry(Math.round(.6*d.x+0),Math.round(.6*d.y+0),Math.round(.6*d.w),Math.round(.6*d.h)),"html=1;whiteSpace=wrap;");v.vertex=!0;x(v,a);return v}function u(a,d,e){e=2*(parseFloat(a.Location)-
.5);a=new mxCell(t(a),new mxGeometry(e,0,0,0),"text;html=1;resizable=0;labelBackgroundColor=#ffffff;");a.geometry.relative=!0;a.vertex=!0;d.insert(a);return d}function l(a,d,e,b){null!=d&&null!=b&&(d=b(d));return null!=d&&d!=e?a+"="+d+";":""}function y(a,d,e){null!=d&&null!=d.LinkX&&null!=d.LinkY&&(a.style+=(e?"exitX":"entryX")+"="+d.LinkX+";"+(e?"exitY":"entryY")+"="+d.LinkY+";"+(e?"exitPerimeter":"entryPerimeter")+"=0;")}var E=["GSDFDProcessBlock","RoundedRectangleContainerBlock","UI2ButtonBlock",
"UMLStateBlock"],F=["ProcessBlock","UMLActivationBlock"],C="VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8 UMLEndBlock DefaultTextBlockNew".split(" "),H="AWSAndroidBlock3 AWSiOSBlock3 AWSJavaBlock3 AWSJavaScript AWSNetBlock3 AWSNodeJSBlock3 AWSPHPBlock3 AWSPythonBlock3 AWSRubyBlock3 AWSXamarin AWSCLIBlock3 AWSEclipseToolkitBlock3 AWSVisualStudioToolkitBlock3 AWSWindowsPowershellToolkitBlock3 DefaultTextBlock RectangleContainerBlock UMLStartBlock UMLEndBlock DefaultTextBlockNew UMLHForkJoinBlock".split(" "),
D="VennPlainColor1 VennPlainColor2 VennPlainColor3 VennPlainColor4 VennPlainColor5 VennPlainColor6 VennPlainColor7 VennPlainColor8 VennGradientColor1 VennGradientColor2 VennGradientColor3 VennGradientColor4 VennGradientColor5 VennGradientColor6 VennGradientColor7 VennGradientColor8".split(" "),G=["AEUSBBlock","AGSCutandpasteBlock","iOSDeviceiPadLandscape","iOSDeviceiPadProLandscape"],r={None:"none",Arrow:"block;endFill=1","Hollow Arrow":"block;endFill=0","Open Arrow":"open;","CFN ERD Zero Or More Arrow":"ERzeroToMany;startSize=10",
...
OrBlock:"shape=mxgraph.flowchart.summing_function",SummingJunctionBlock:"shape=mxgraph.flowchart.or",DisplayBlock:"shape=display",OffPageLinkBlock:"shape=offPageConnector",BraceNoteBlock:"shape=curlyBracket",NoteBlock:"shape=mxgraph.flowchart.annotation_1",AdvancedSwimLaneBlock:"swimlane",AdvancedSwimLaneBlockRotated:"swimlane;horizontal=0",RectangleContainerBlock:"fillColor=none;container=1",DiamondContainerBlock:"shape=rhombus;fillColor=none;container=1",RoundedRectangleContainerBlock:"fillColor=none;container=1;rounded=1;absoluteArcSize=1;arcSize=24",
...
DoubleArrowBlock:"shape=doubleArrow;arrowWidth=0.5;arrowSize=0.3",CalloutBlock:"shape=mxgraph.basic.rectangular_callout",ShapeCircleBlock:"ellipse",ShapePolyStarBlock:"shape=mxgraph.basic.star",ShapeDiamondBlock:"rhombus",UI2HotspotBlock:"opacity=50;strokeColor=none",AndroidIconCheck:"shape=mxgraph.ios7.misc.check",AndroidIconCancel:"shape=mxgraph.atlassian.x",AndroidIconCollapse:"shape=mxgraph.ios7.misc.up",AndroidIconExpand:"shape=mxgraph.ios7.misc.down",AndroidIconNext:"shape=mxgraph.ios7.misc.right",
AndroidIconPrevious:"shape=mxgraph.ios7.misc.left",AndroidIconRefresh:NaN,AndroidIconInformation:"shape=mxgraph.ios7.icons.info",AndroidIconSearch:"shape=mxgraph.ios7.icons.looking_glass",AndroidIconSettings:"shape=mxgraph.ios7.icons.volume;direction=south",AndroidIconTrash:"shape=mxgraph.ios7.icons.trashcan",AndroidIconEmail:"shape=mxgraph.mockup.misc.mail2",AndroidIconNew:"shape=mxgraph.ios7.misc.flagged",iOSDeviceiPhoneSE:"shape=mxgraph.ios7.misc.iphone",iOSDeviceiPhone6s:"shape=mxgraph.ios7.misc.iphone",
iOSDeviceiPhone6sPlus:"shape=mxgraph.ios7.misc.iphone",iOSDeviceiPadPortrait:"shape=mxgraph.ios7.misc.ipad7inch",iOSDeviceiPadLandscape:"shape=mxgraph.ios7.misc.ipad7inch",iOSDeviceiPadProPortrait:"shape=mxgraph.ios7.misc.ipad7inch",iOSDeviceiPadProLandscape:"shape=mxgraph.ios7.misc.ipad10inch",iOSButton:"",iOSStepper:"shape=mxgraph.ios7.misc.adjust",iOSToggle:"shape=mxgraph.ios7ui.onOffButton;buttonState=on;strokeColor2=#aaaaaa;fillColor2=#ffffff",iOSSlider:"shape=mxgraph.ios7ui.slider;barPos=20;strokeColor2=#a0a0a0",
iOSProgressBar:"shape=mxgraph.ios.iCloudProgressBar;barPos=20",iOSPageControls:"shape=mxgraph.ios.iCloudProgressBar;barPos=20",iOSUniversalKeyboard:"shape=mxgraph.ios.iKeybLett",MindMapBlock:"",MindMapStadiumBlock:"arcSize=50",MindMapCloud:"shape=cloud",MindMapCircle:"shape=ellipse",MindMapIsoscelesTriangleBlock:"shape=triangle;direction=north",MindMapDiamondBlock:"shape=rhombus",MindMapPentagonBlock:"shape=mxgraph.basic.pentagon",MindMapHexagonBlock:"shape=hexagon",MindMapOctagonBlock:"shape=mxgraph.basic.octagon",
MindMapCrossBlock:"shape=mxgraph.basic.cross2;dx=20",UMLClassBlock:"",UMLActiveClassBlock:"shape=process",UMLPackageBlock:"shape=folder;tabPosition=left",UMLNoteBlock:"shape=note;size=15",UMLTextBlock:"shape=text;strokeColor=none;fillColor=none",UMLActorBlock:"shape=umlActor;labelPosition=center;verticalLabelPosition=bottom;verticalAlign=top;whiteSpace=nowrap",UMLUseCaseBlock:"shape=ellipse",UMLCircleContainerBlock:"shape=ellipse;container=1",UMLRectangleContainerBlock:"container=1",UMLOptionLoopBlock:"shape=mxgraph.sysml.package2;xSize=90;overflow=fill",
...
VSMLoadLevelingBlock:"shape=mxgraph.lean_mapping.load_leveling",VSMGoSeeBlock:"shape=mxgraph.lean_mapping.go_see_production_scheduling;flipH=1",VSMGoSeeProductionBlock:"shape=ellipse",VSMVerbalInfoBlock:"shape=mxgraph.lean_mapping.verbal",VSMKaizenBurstBlock:"shape=mxgraph.lean_mapping.kaizen_lightening_burst",VSMOperatorBlock:"shape=mxgraph.lean_mapping.operator;flipV=1",VSMQualityProblemBlock:"shape=mxgraph.lean_mapping.quality_problem",VSMProductionKanbanSingleBlock:"shape=mxgraph.lean_mapping.production_kanban",
...
PESpiralHeatExchanger:"shape=mxgraph.pid.heat_exchangers.spiral_heat_exchanger",PEUTubeHeatExchangerBlock:"shape=mxgraph.pid.heat_exchangers.u-tube_heat_exchanger",PEDoublePipeHeatBlock:"shape=mxgraph.pid.heat_exchangers.double_pipe_heat_exchanger",PEShellAndTubeHeat1Block:"shape=mxgraph.pid.heat_exchangers.shell_and_tube_heat_exchanger_1",PEShellAndTubeHeat2Block:"shape=mxgraph.pid.heat_exchangers.shell_and_tube_heat_exchanger_2",PEShellAndTubeHeat3Block:"shape=mxgraph.pid.heat_exchangers.shell_and_tube_heat_exchanger_1;direction=north",
PESinglePassHeatBlock:"shape=mxgraph.pid.heat_exchangers.single_pass_heat_exchanger",PEHeaterBlock:"shape=mxgraph.pid.heat_exchangers.heater",PEEjectorInjectorBlock:"shape=mxgraph.pid.fittings.injector",PECompressorTurbineBlock:"shape=mxgraph.pid.engines.turbine;flipH=1",PETripleFanBlades2Block:"shape=mxgraph.pid2misc.fan;fanType=common",PEFanBlades2Block:"shape=mxgraph.pid2misc.fan;fanType=common",PECentrifugalPumpBlock:"shape=mxgraph.pid.pumps.centrifugal_pump_1",PECentrifugalPump:"shape=mxgraph.pid.pumps.centrifugal_pump_1",
PECentrifugalPump2:"shape=mxgraph.pid.pumps.centrifugal_pump_2",PECentrifugalPump3:"shape=mxgraph.pid.pumps.centrifugal_pump_1;flipH=1",PEGearPumpBlock:"shape=mxgraph.pid.pumps.gear_pump",PEHorizontalPump:"shape=mxgraph.pid.pumps.horizontal_pump",PEProgressiveCavityPump:"shape=mxgraph.pid.pumps.cavity_pump;flipH=1;flipV=1",PEScrewPump:"shape=mxgraph.pid.pumps.screw_pump",PEScrewPump2:"shape=mxgraph.pid.pumps.screw_pump_2;flipH=1",PESumpPump:"shape=mxgraph.pid.pumps.sump_pump",PEVacuumPump:"shape=mxgraph.pid.pumps.vacuum_pump",
PEVerticalPump:"shape=mxgraph.pid.pumps.vertical_pump",PEVerticalPump2:"shape=mxgraph.pid.pumps.vertical_pump",PEIndicatorBlock:"shape=mxgraph.pid2inst.discInst;mounting=room",PEIndicator2Block:"shape=mxgraph.pid2inst.indicator;mounting=room;indType=inst",PEIndicator3Block:"shape=mxgraph.pid2inst.discInst;mounting=field",PEIndicator4Block:"shape=mxgraph.pid2inst.indicator;mounting=field;indType=inst",PESharedIndicatorBlock:"shape=mxgraph.pid2inst.sharedCont;mounting=room",PESharedIndicator2Block:"shape=mxgraph.pid2inst.indicator;mounting=room;indType=ctrl",
PEProgrammableIndicatorBlock:"shape=mxgraph.pid2inst.progLogCont;mounting=room",PEGateValveBlock:"shape=mxgraph.pid2valves.valve;valveType=gate",PEGlobeValveBlock:"shape=mxgraph.pid2valves.valve;valveType=globe",PEControlValveBlock:"shape=mxgraph.pid2valves.valve;valveType=gate;actuator=diaph",PENeedleValveBlock:"shape=mxgraph.pid2valves.valve;valveType=needle",PEButterflyValve2Block:"shape=mxgraph.pid2valves.valve;valveType=butterfly",PEDiaphragmBlock:"shape=mxgraph.pid2valves.valve;valveType=ball",
PECheckValveBlock:"shape=mxgraph.pid2valves.valve;valveType=check",PECheckValve2Block:"shape=mxgraph.pid2valves.valve;valveType=check",PEAngleValveBlock:"shape=mxgraph.pid2valves.valve;valveType=angle;actuator=none",PEAngleGlobeValveBlock:"shape=mxgraph.pid2valves.valve;valveType=angleGlobe;actuator=man;flipH=1",PEPoweredValveBlock:"shape=mxgraph.pid2valves.valve;valveType=gate;actuator=digital",PEFloatOperatedValveBlock:"shape=mxgraph.pid2valves.valve;valveType=gate;actuator=singActing",PEThreeWayValveBlock:"shape=mxgraph.pid2valves.valve;valveType=threeWay;actuator=none",
PEBleederValveBlock:"shape=mxgraph.pid2valves.blockBleedValve;actuator=none",PERotameterBlock:"shape=mxgraph.pid.flow_sensors.rotameter;flipH=1",VennGradientColor1:"shape=ellipse;fillOpacity=35",VennGradientColor2:"shape=ellipse;fillOpacity=35",VennGradientColor3:"shape=ellipse;fillOpacity=35",VennGradientColor4:"shape=ellipse;fillOpacity=35",VennGradientColor5:"shape=ellipse;fillOpacity=35",VennGradientColor6:"shape=ellipse;fillOpacity=35",VennGradientColor7:"shape=ellipse;fillOpacity=35",VennGradientColor8:"shape=ellipse;fillOpacity=35",
...
Image_iphone_mark_as_read:"shape=ellipse",Image_iphone_pin_green:"shape=mxgraph.ios.iPin;fillColor2=#00dd00;fillColor3=#004400;strokeColor=#006600",Image_iphone_pin_red:"shape=mxgraph.ios.iPin;fillColor2=#dd0000;fillColor3=#440000;strokeColor=#660000",Image_iphone_radio_off:"shape=ellipse",Image_iphone_checkbox_off:"",Image_iphone_indicator:"fillColor=#e8878E;gradientColor=#BD1421;strokeColor=#ffffff",Image_iphone_thread_count:""},A=function(a,d,e){e.includes(a)||e.push(a);if(a in d){var b=d[a];b.id=
a;if(null!=b.Members)for(var h in b.Members)e=A(h,d,e)}return e};EditorUi.prototype.pasteLucidChart=function(a,d,e,b){var h=this.editor.graph;h.getModel().beginUpdate();try{var g=function(a,b){var d=null!=b.Endpoint1.Block?c[b.Endpoint1.Block]:null,g=null!=b.Endpoint2.Block?c[b.Endpoint2.Block]:null,e;e=new mxCell("",new mxGeometry(0,0,100,100),"html=1;");e.geometry.relative=!0;e.edge=!0;x(e,a);var k=q(a).Properties,l=null!=k?k.TextAreas:a.TextAreas;if(null!=l){for(var m=0;null!=l["t"+m];){var n=
l["t"+m];e=u(n,e);m++}for(m=1;null!=l["m"+m];)n=l["m"+m],e=u(n,e,a),m++;null!=l.Text&&(e=u(l,e,a));l=null!=k?k.TextAreas:a.TextAreas;null!=l.Message&&(e=u(l.Message,e,a))}null==d&&null!=b.Endpoint1&&e.geometry.setTerminalPoint(new mxPoint(Math.round(.6*b.Endpoint1.x),Math.round(.6*b.Endpoint1.y)),!0);null==g&&null!=b.Endpoint2&&e.geometry.setTerminalPoint(new mxPoint(Math.round(.6*b.Endpoint2.x),Math.round(.6*b.Endpoint2.y)),!1);f.push(h.addCell(e,null,null,d,g))},f=[],c={},m=[],l=[],p=0;if(null!=
a.Groups)for(var n in a.Groups){var k=a.Groups[n];k.id=n;if(1==k.Hidden&&null!=k.Members){l.includes(n)||l.push(n);for(var t in k.Members)l=A(t,a.Groups,l)}}if(null!=a.Blocks)for(n in a.Blocks)k=a.Blocks[n],k.id=n,l.includes(n)||(c[k.id]=z(k),m.push(k));else for(p=0;p<a.Objects.length;p++)k=a.Objects[p],k.IsBlock&&null!=k.Action&&null!=k.Action.Properties&&(c[k.id]=z(k)),m.push(k);m.sort(function(a,b){a=q(a);b=q(b);return null!=a.Properties&&null!=b.Properties?a.Properties.ZOrder-b.Properties.ZOrder:
0});for(p=0;p<m.length;p++){var k=m[p],r=c[k.id];null!=r?f.push(h.addCell(r)):k.IsLine&&null!=k.Action&&null!=k.Action.Properties&&g(k,k.Action.Properties)}if(null!=a.Lines)for(n in a.Lines)l.includes(n)||(k=a.Lines[n],g(k,k));if(b&&null!=d&&null!=e){h.isGridEnabled()&&(d=h.snap(d),e=h.snap(e));var w=h.getBoundingBoxFromGeometry(f,!0);null!=w&&h.moveCells(f,d-w.x,e-w.y)}h.setSelectionCells(f)}finally{h.getModel().endUpdate()}h.isSelectionEmpty()||(h.scrollCellToVisible(h.getSelectionCell()),null!=
this.hoverIcons&&this.hoverIcons.update(h.view.getState(h.getSelectionCell())))}})();