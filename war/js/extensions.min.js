(function(){function u(a){a=null!=a.Text?a.Text:null!=a.Value?a.Value:a.Lane_0;return null!=a&&null!=a.t?a.t:""}function n(a){return null!=a.Action?a.Action:a}function w(a,d){var c=n(d);if(null!=c){var b=y[c.Class];null!=b&&(a.style+=b);b=null!=c.Properties?c.Properties:c;if(null!=b){a.value=u(b);"ImageSearchBlock2"==c.Class&&(a.style+="image="+b.URL+";");a.style+=h(mxConstants.STYLE_STROKEWIDTH,b.LineWidth,"1");a.style+=h(mxConstants.STYLE_STROKECOLOR,b.LineColor.substring(0,7),"#000000");a.style+=
h(mxConstants.STYLE_ALIGN,b.TextAlign,"center");a.style+=h(mxConstants.STYLE_VERTICAL_ALIGN,b.TextVAlign,"middle");a.style+=h(mxConstants.STYLE_OPACITY,b.Opacity,"100");if(null!=b.Rotation){var f=mxUtils.toDegree(parseFloat(b.Rotation)),z=["AEUSBBlock","AGSCutandpasteBlock"];"AdvancedSwimLaneBlockRotated"==c.Class?(f+=90,a.geometry.rotate90()):z.includes(c.Class)&&(f-=90,a.geometry.rotate90(),a.geometry.rotate90(),a.geometry.rotate90());a.style+="rotation="+f+";"}b.FlipX&&(a.style+="flipH=1;");b.FlipY&&
(a.style+="flipV=1;");null!=b.Shadow&&(a.style+=mxConstants.STYLE_SHADOW+"=1;");"dashed"==b.StrokeStyle?a.style+="dashed=1;":"dotted"==b.StrokeStyle&&(a.style+="dashed=1;dashPattern=1 4;");null==b.FillColor||"AWSAndroidBlock3 AWSiOSBlock3 AWSJavaBlock3 AWSJavaScript AWSNetBlock3 AWSNodeJSBlock3 AWSPHPBlock3 AWSPythonBlock3 AWSRubyBlock3 AWSXamarin AWSCLIBlock3 AWSEclipseToolkitBlock3 AWSVisualStudioToolkitBlock3 AWSWindowsPowershellToolkitBlock3".split(" ").includes(c.Class)||("object"===typeof b.FillColor?
null!=b.FillColor.cs&&1<b.FillColor.cs.length&&(a.style+=h(mxConstants.STYLE_FILLCOLOR,b.FillColor.cs[0].c.substring(0,7)),a.style+=h(mxConstants.STYLE_GRADIENTCOLOR,b.FillColor.cs[1].c.substring(0,7))):"string"===typeof b.FillColor&&(a.style+=h(mxConstants.STYLE_FILLCOLOR,b.FillColor.substring(0,7),"#FFFFFF")));if(a.edge){a.style+="rounded=1;arcSize=5;";if("diagonal"!=b.Shape)if(null!=b.ElbowPoints)for(a.geometry.points=[],c=0;c<b.ElbowPoints.length;c++)a.geometry.points.push(new mxPoint(Math.round(.6*
b.ElbowPoints[c].x+0),Math.round(.6*b.ElbowPoints[c].y+0)));else"elbow"==b.Shape?a.style=null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block?a.style+"edgeStyle=orthogonalEdgeStyle;":a.style+"edgeStyle=elbowEdgeStyle;":null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block&&(a.style+="edgeStyle=orthogonalEdgeStyle;","curve"==b.Shape&&(a.style+="curved=1;"));l(a,b.Endpoint1,!0);l(a,b.Endpoint2,!1)}}}}function x(a){var d=n(a).Properties.BoundingBox;null!=a.Class&&"AWS"===a.Class.substring(0,3)&&(d.h-=20);v=new mxCell("",
new mxGeometry(Math.round(.6*d.x+0),Math.round(.6*d.y+0),Math.round(.6*d.w),Math.round(.6*d.h)),"html=1;whiteSpace=wrap;");v.vertex=!0;w(v,a);return v}function h(a,d,c,b){null!=d&&null!=b&&(d=b(d));return null!=d&&d!=c?a+"="+d+";":""}function l(a,d,c){null!=d&&(null!=d.LinkX&&null!=d.LinkY&&(a.style+=(c?"exitX":"entryX")+"="+d.LinkX+";"+(c?"exitY":"entryY")+"="+d.LinkY+";"+(c?"exitPerimeter":"entryPerimeter")+"=0;"),"Arrow"==d.Style?a.style+=(c?"startArrow":"endArrow")+"=block;":"Hollow Arrow"==d.Style?
(a.style+=(c?"startArrow":"endArrow")+"=block;",a.style+=(c?"startFill":"endFill")+"=0;"):"Open Arrow"==d.Style&&(a.style+=(c?"startArrow":"endArrow")+"=open;",a.style+=(c?"startSize":"endSize")+"=12;"))}var y={DefaultTextBlockNew:"text;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;",DefaultSquareBlock:"rounded=1;arcSize=5;",DefaultNoteBlock:"shape=note;size=15;",HotspotBlock:"strokeColor=none;opacity=50;",ImageSearchBlock2:"shape=image;",ProcessBlock:"rounded=1;arcSize=5;",DecisionBlock:"rhombus;rounded=1;arcSize=5;",
TerminatorBlock:"rounded=1;arcSize=50;",PredefinedProcessBlock:"shape=process;rounded=1;arcSize=5;",DocumentBlock:"shape=document;",MultiDocumentBlock:"shape=mxgraph.flowchart.multi-document;",ManualInputBlock:"shape=manualInput;size=15;rounded=1;arcSize=5;",PreparationBlock:"shape=hexagon;rounded=1;arcSize=5;",DataBlockNew:"shape=parallelogram;rounded=1;arcSize=5;",DatabaseBlock:"shape=cylinder;",DirectAccessStorageBlock:"shape=mxgraph.flowchart.direct_data;",InternalStorageBlock:"shape=internalStorage;rounded=1;arcSize=5;dx=10;dy=10;",
...
EE_SquareWave:"shape=mxgraph.electrical.waveforms.square_wave;",EIChannelBlock:"shape=mxgraph.eip.messageChannel;",EIMessageRouterBlock:"shape=mxgraph.eip.content_based_router;",EIMessageTranslatorBlock:"shape=mxgraph.eip.message_translator;",EIMessagingBridgeBlock:"shape=mxgraph.eip.messaging_bridge;",EIContentBasedRouterBlock:"shape=mxgraph.eip.content_based_router;",EIMessageFilterBlock:"shape=mxgraph.eip.message_filter;",EIDynamicRouterBlock:"shape=mxgraph.eip.dynamic_router;",EIRecipientListBlock:"shape=mxgraph.eip.recipient_list;",
EISplitterBlock:"shape=mxgraph.eip.splitter;",EIAggregatorBlock:"shape=mxgraph.eip.aggregator;",EIResequencerBlock:"shape=mxgraph.eip.resequencer;",EIComposedMessageBlock:"shape=mxgraph.eip.composed_message_processor;",EIRoutingSlipBlock:"shape=mxgraph.eip.routing_slip;",EIProcessManagerBlock:"shape=mxgraph.eip.process_manager;",EIEnvelopeWrapperBlock:"shape=mxgraph.eip.envelope_wrapper;",EIContentEnricherBlock:"shape=mxgraph.eip.content_enricher;",EIContentFilterBlock:"shape=mxgraph.eip.content_filter;",
EIClaimCheckBlock:"shape=mxgraph.eip.claim_check;",EINormalizerBlock:"shape=mxgraph.eip.normalizer;",EIMessagingGatewayBlock:"shape=mxgraph.eip.messaging_gateway;",EITransactionalClientBlock:"shape=mxgraph.eip.transactional_client;",EIPollingConsumerBlock:"shape=mxgraph.eip.polling_consumer;",EIEventDrivenConsumerBlock:"shape=mxgraph.eip.event_driven_consumer;",EICompetingConsumersBlock:"shape=mxgraph.eip.competing_consumers;",EIMessageDispatcherBlock:"shape=mxgraph.eip.message_dispatcher;",EISelectiveConsumerBlock:"shape=mxgraph.eip.selective_consumer;",
...
PEDesuperheater:"shape=mxgraph.pid.piping.desuper_heater;",PEEjectorOrEductor:"shape=mxgraph.pid.fittings.injector;",PEExhaustHead:"shape=mxgraph.pid.piping.exhaust_head;",PERotaryValve:"shape=mxgraph.pid.piping.rotary_valve;",PEExpansionJoint:"shape=mxgraph.pid.piping.expansion_joint;",PEVesselBlock:"shape=rect;",PEOpenTankBlock:"shape=mxgraph.pid.vessels.container,_tank,_cistern;",PEClosedTankBlock:"shape=rect;",PEStorageSphereBlock:"shape=mxgraph.pid.vessels.storage_sphere;",PEColumnBlock:"shape=mxgraph.pid.vessels.pressurized_vessel;",
...
Image_iphone_indicator:"shape=rect;rounded=1;fillColor=#e8878E;gradientColor=#BD1421;strokeColor=#ffffff;",Image_iphone_thread_count:"shape=rect;rounded=1;"};EditorUi.prototype.pasteLucidChart=function(a,d,c,b){var f=this.editor.graph;f.getModel().beginUpdate();try{var h=function(a,b){var e=null!=b.Endpoint1.Block?p[b.Endpoint1.Block]:null,h=null!=b.Endpoint2.Block?p[b.Endpoint2.Block]:null,g=new mxCell("",new mxGeometry(0,0,100,100),"html=1;");g.geometry.relative=!0;g.edge=!0;w(g,a);var m=n(a).Properties,
m=null!=m?m.TextAreas:a.TextAreas;if(null!=m)for(var l=0;null!=m["t"+l];){var m=m["t"+l],k=2*(parseFloat(m.Location)-.5),k=new mxCell(u(m),new mxGeometry(k,0,0,0),"text;html=1;resizable=0;align=center;verticalAlign=middle;labelBackgroundColor=#ffffff;");k.geometry.relative=!0;k.vertex=!0;g.insert(k);l++}null==e&&null!=b.Endpoint1&&g.geometry.setTerminalPoint(new mxPoint(Math.round(.6*b.Endpoint1.x+d),Math.round(.6*b.Endpoint1.y+c)),!0);null==h&&null!=b.Endpoint2&&g.geometry.setTerminalPoint(new mxPoint(Math.round(.6*
b.Endpoint2.x+d),Math.round(.6*b.Endpoint2.y+c)),!1);q.push(f.addCell(g,null,null,e,h))},q=[],p={},k=[];if(null!=a.Blocks)for(var r in a.Blocks){var e=a.Blocks[r];e.id=r;p[e.id]=x(e);k.push(e)}else for(var g=0;g<a.Objects.length;g++)e=a.Objects[g],e.IsBlock&&null!=e.Action&&null!=e.Action.Properties&&(p[e.id]=x(e)),k.push(e);k.sort(function(a,b){a=n(a);b=n(b);return null!=a.Properties&&null!=b.Properties?a.Properties.ZOrder-b.Properties.ZOrder:0});for(g=0;g<k.length;g++){var e=k[g],l=p[e.id];null!=
l?q.push(f.addCell(l)):e.IsLine&&null!=e.Action&&null!=e.Action.Properties&&h(e,e.Action.Properties)}if(null!=a.Lines)for(r in a.Lines)e=a.Lines[r],h(e,e);if(b&&null!=d&&null!=c){f.isGridEnabled()&&(d=f.snap(d),c=f.snap(c));var t=f.getBoundingBoxFromGeometry(q,!0);null!=t&&f.moveCells(q,d-t.x,c-t.y)}f.setSelectionCells(q)}finally{f.getModel().endUpdate()}f.isSelectionEmpty()||(f.scrollCellToVisible(f.getSelectionCell()),null!=this.hoverIcons&&this.hoverIcons.update(f.view.getState(f.getSelectionCell())))}})();