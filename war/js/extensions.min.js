...
b.ElbowPoints[c].x+0),Math.round(.6*b.ElbowPoints[c].y+0)));else"elbow"==b.Shape?a.style=null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block?a.style+"edgeStyle=orthogonalEdgeStyle;":a.style+"edgeStyle=elbowEdgeStyle;":null!=b.Endpoint1.Block&&null!=b.Endpoint1.Block&&(a.style+="edgeStyle=orthogonalEdgeStyle;","curve"==b.Shape&&(a.style+="curved=1;"));l(a,b.Endpoint1,!0);l(a,b.Endpoint2,!1)}}}}function x(a){var d=n(a).Properties.BoundingBox;a.Class.startsWith("AWS")&&(d.h-=20);v=new mxCell("",new mxGeometry(Math.round(.6*
d.x+0),Math.round(.6*d.y+0),Math.round(.6*d.w),Math.round(.6*d.h)),"html=1;whiteSpace=wrap;");v.vertex=!0;w(v,a);return v}function h(a,d,c,b){null!=d&&null!=b&&(d=b(d));return null!=d&&d!=c?a+"="+d+";":""}function l(a,d,c){null!=d&&(null!=d.LinkX&&null!=d.LinkY&&(a.style+=(c?"exitX":"entryX")+"="+d.LinkX+";"+(c?"exitY":"entryY")+"="+d.LinkY+";"+(c?"exitPerimeter":"entryPerimeter")+"=0;"),"Arrow"==d.Style?a.style+=(c?"startArrow":"endArrow")+"=block;":"Hollow Arrow"==d.Style?(a.style+=(c?"startArrow":
...
e&&null!=b.Endpoint1&&g.geometry.setTerminalPoint(new mxPoint(Math.round(.6*b.Endpoint1.x+d),Math.round(.6*b.Endpoint1.y+c)),!0);null==h&&null!=b.Endpoint2&&g.geometry.setTerminalPoint(new mxPoint(Math.round(.6*b.Endpoint2.x+d),Math.round(.6*b.Endpoint2.y+c)),!1);q.push(f.addCell(g,null,null,e,h))},q=[],p={},k=[];if(null!=a.Blocks)for(var r in a.Blocks){var e=a.Blocks[r];e.id=r;p[e.id]=x(e);k.push(e)}else for(var g=0;g<a.Objects.length;g++)e=a.Objects[g],e.IsBlock&&null!=e.Action&&null!=e.Action.Properties&&
(p[e.id]=x(e)),k.push(e);k.sort(function(a,b){a=n(a);b=n(b);return null!=a.Properties&&null!=b.Properties?a.Properties.ZOrder-b.Properties.ZOrder:0});for(g=0;g<k.length;g++){var e=k[g],l=p[e.id];null!=l?q.push(f.addCell(l)):e.IsLine&&null!=e.Action&&null!=e.Action.Properties&&h(e,e.Action.Properties)}if(null!=a.Lines)for(r in a.Lines)e=a.Lines[r],h(e,e);if(b&&null!=d&&null!=c){f.isGridEnabled()&&(d=f.snap(d),c=f.snap(c));var t=f.getBoundingBoxFromGeometry(q,!0);null!=t&&f.moveCells(q,d-t.x,c-t.y)}f.setSelectionCells(q)}finally{f.getModel().endUpdate()}f.isSelectionEmpty()||
