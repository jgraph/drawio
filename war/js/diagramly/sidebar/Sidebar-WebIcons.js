(function()
{
	...
	Sidebar.prototype.addWebLogosPalette = function()
	{
		...
		[
		 ...
		 this.createVertexTemplateEntry('image;image=img/lib/atlassian/Atlassian.svg;',
				 520, 65, '', 'Atlassian', null, null, this.getTagsForStencil(gn, 'atlassian', dt).join(' ')),
		 ...
		 this.createVertexTemplateEntry('image;image=img/lib/atlassian/Bitbucket.svg;',
				 443, 63, '', 'Bitbucket', null, null, this.getTagsForStencil(gn, 'bitbucket atlassian', dt).join(' ')),
		 ...
		 this.createVertexTemplateEntry('image;image=img/lib/atlassian/Hipchat.svg;',
				 382, 80, '', 'Hipchat', null, null, this.getTagsForStencil(gn, 'hipchat atlassian', dt).join(' ')),
		 ...
		 this.createVertexTemplateEntry('image;image=img/lib/atlassian/Jira_Core.svg;',
				 397, 66, '', 'Jira Core', null, null, this.getTagsForStencil(gn, 'jira core atlassian', dt).join(' ')),
		 ...
		 this.createVertexTemplateEntry('image;image=img/lib/atlassian/Jira_Service_Desk.svg;',
				 520, 56, '', 'Jira Service Desk', null, null, this.getTagsForStencil(gn, 'jira service desk atlassian', dt).join(' ')),
		 ...
		 this.createVertexTemplateEntry('image;image=img/lib/atlassian/Jira_Software.svg;',
				 520, 65, '', 'Jira Software', null, null, this.getTagsForStencil(gn, 'jira software atlassian', dt).join(' ')),
		 ...
		 this.createVertexTemplateEntry('image;image=img/lib/atlassian/Stride.svg;',
				 309, 63, '', 'Stride', null, null, this.getTagsForStencil(gn, 'stride atlassian', dt).join(' ')),
