...
[`+Ct+"] ",arguments[0])a(arguments[0],O)&&(S+=O+": "+arguments[0][O]+", ");S=S.slice(0,-2)}else S=arguments[Ct];it.push(S)}Y(h+`
...
`,Mc={flowchart:Lc,"flowchart-v2":Lc,sequence:ag,gantt:rg,classDiagram:yo,"classDiagram-v2":yo,class:yo,stateDiagram:Dc,state:Dc,info:ng,pie:ig,er:tg,error:eg,journey:og,requirement:sg,c4:lg},cE=(t,e,r)=>{let n="";return t in Mc&&Mc[t]?n=Mc[t](r):B.warn(`No theme found for ${t}`),` & {
...
`),i=0;i<n.length;i++)r.append("tspan").attr("xml:space","preserve").attr("dy","1em").attr("x","1").text(n[i]);return qn(r,e.labelStyle),r}function bR(t){for(var e="",r=!1,n,i=0;i<t.length;++i)if(n=t[i],r){switch(n){case"n":e+=`
