import { b as sanitizeText$1, g as getConfig, l as log, f as select, I as lighten, J as darken } from "./config-69acf485.js";
import { s as setupGraphViewbox } from "./setupGraphViewbox-7e84bca9.js";
import { i as isDark } from "./is_dark-53833c4a.js";
var parser = function() {
...
async function layoutMindmap(node, conf) {
  if (!cytoscape) {
    cytoscape = (await import("./cytoscape.cjs-c47f6334.js").then((n) => n.c)).default;
    const coseBilkent = (await import("./cytoscape-cose-bilkent-4e738a75.js").then((n) => n.c)).default;
...
//# sourceMappingURL=mindmap-definition-b51b5650.js.map
