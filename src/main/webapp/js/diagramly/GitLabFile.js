...
mxUtils.extend(GitLabFile, DrawioFile);
...
{
	return encodeURIComponent('GITLAB' + this.getId());
};
 ...
 */
GitLabFile.prototype.isAutosave = function()
{
	return false;
};
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
GitLabFile.prototype.getTitle = function()
{
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
GitLabFile.prototype.isRenamable = function()
{
	return false;
};
 ...
 */
GitLabFile.prototype.getDescriptor = function()
{
	return this.meta;
};
 ...
 * Hook for subclassers to update the descriptor from given file
 */
GitLabFile.prototype.setDescriptor = function(desc)
{
	this.meta = desc;
};
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
GitLabFile.prototype.save = function(revision, success, error, unloading, overwrite, message)
{
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
GitLabFile.prototype.saveAs = function(title, success, error)
{
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
GitLabFile.prototype.doSave = function(title, success, error, unloading, overwrite, message)
{
...
GitLabFile.prototype.saveFile = function(title, revision, success, error, unloading, overwrite, message)
{
	...
	else if (!this.savingFile)
	{
		...
		{
			this.ui.gitLab.showCommitDialog(this.meta.name, this.meta.sha == null || this.meta.isNew,
