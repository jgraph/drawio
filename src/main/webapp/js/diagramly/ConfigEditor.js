...
DrawioConfigEditor.html = [
	...
	'          <input type="number" id="cfg-maxImageBytes" data-key="maxImageBytes" placeholder="2000000" min="0">',
	'        </div>',
	'        <div class="field">',
	'          <label for="cfg-maxImageSize"></label>',
	'          <input type="number" id="cfg-maxImageSize" data-key="maxImageSize" placeholder="1200" min="0">',
	'        </div>',
	'      </div>',
	'      <div class="field-row">',
	'        <div class="field">',
