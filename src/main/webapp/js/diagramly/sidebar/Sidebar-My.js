(function()
{
  ...
  {
    this.setCurrentSearchEntryLibrary('myid', 'mylib');
    ...
    var fns = [
      ...
      this.createEdgeTemplateEntry(
        ...
        null,
        'link'),
      this.addEntry('edge title', mxUtils.bind(this, function()
      {
    ...
    this.addPaletteFunctions('myid', mxResources.get('mylib'), true, fns);
  };

  // Adds Arrow shapes with control points
  Sidebar.prototype.addMyPaletteYolo = function()
  {
    ...
    var fns = [
     	...
     	this.addEntry(dt + 'class', function()
    	{
    		...
    		return sb.createVertexTemplateFromCells([cell1], cell1.geometry.width, cell1.geometry.height, 'asdfClass');
    	}),
