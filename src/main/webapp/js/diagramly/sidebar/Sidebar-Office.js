(function()
{
	...
	Sidebar.prototype.addOfficeCommunicationsPalette = function()
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'email_workload;',
					w * 57, h * 47, '', 'Email Workload', null, null, this.getTagsForStencil(gn, 'email workload', dt).join(' ')),
	...
	Sidebar.prototype.addOfficeServersPalette = function()
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'exchange_client_access_server_role;',
					w * 52, h * 59, '', 'Exchange Client Access Server Role', null, null, this.getTagsForStencil(gn, 'exchange client access server role', dt).join(' ')),
			...
			this.createVertexTemplateEntry(s + 'voicemail_preview_partner;',
					w * 46, h * 56, '', 'Voicemail Preview Partner', null, null, this.getTagsForStencil(gn, 'voicemail preview partner', dt).join(' ')),
