(function()
{
	Sidebar.prototype.addAlliedTelesysPalette = function()
	{
		var d = 60;
		var dt = 'allied telesys';
		var sb = this;
		var s = 'aspect=fixed;perimeter=ellipsePerimeter;html=1;align=center;shadow=0;dashed=0;image;image=img/lib/allied_telesys/';

		// Adds Allied Telesys shapes
		this.addAlliedTelesysBuildingsPalette(d, dt, sb, s);
		this.addAlliedTelesysComputerTerminalsPalette(d, dt, sb, s);
		this.addAlliedTelesysMediaConvertersPalette(d, dt, sb, s);
		this.addAlliedTelesysSecurityPalette(d, dt, sb, s);
		this.addAlliedTelesysStoragePalette(d, dt, sb, s);
		this.addAlliedTelesysSwitchPalette(d, dt, sb, s);
		this.addAlliedTelesysWirelessPalette(d, dt, sb, s);
	};

	Sidebar.prototype.addAlliedTelesysBuildingsPalette = function(d, dt, sb, s)
	{
		s += 'buildings/';
		var gn = 'buildings';
		...
		var fns = [
   		...
   		this.addPalette('allied_telesysBuildings', 'Allied Telesys / Buildings', false, mxUtils.bind(this, function(content)
	    {
	...
	Sidebar.prototype.addAlliedTelesysComputerTerminalsPalette = function(d, dt, sb, s)
	{
		...
		var fns = [
   		...
   		this.addPalette('allied_telesysComputer and Terminals', 'Allied Telesys / Computer and Terminals', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAlliedTelesysMediaConvertersPalette = function(d, dt, sb, s)
	{
		s += 'media_converters/';
		...
		var fns = [
   		...
   		this.addPalette('allied_telesysMedia Converters', 'Allied Telesys / Media Converters', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAlliedTelesysSecurityPalette = function(d, dt, sb, s)
	{
		s += 'security/';
		var gn = 'security';
		...
		var fns = [
   		...
   		this.addPalette('allied_telesysSecurity', 'Allied Telesys / Security', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAlliedTelesysStoragePalette = function(d, dt, sb, s)
	{
		s += 'storage/';
		var gn = 'storage';
		...
		var fns = [
   		...
   		this.addPalette('allied_telesysStorage', 'Allied Telesys / Storage', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAlliedTelesysSwitchPalette = function(d, dt, sb, s)
	{
		s += 'switch/';
		var gn = 'switch';
		...
		var fns = [
   		...
   		this.addPalette('allied_telesysSwitch', 'Allied Telesys / Switch', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addAlliedTelesysWirelessPalette = function(d, dt, sb, s)
	{
		s += 'wireless/';
		var gn = 'wireless';
		...
		var fns = [
   		...
   		this.addPalette('allied_telesysWireless', 'Allied Telesys / Wireless', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
