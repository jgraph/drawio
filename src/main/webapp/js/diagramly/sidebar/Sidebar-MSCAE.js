	...
	Sidebar.prototype.addMSCAEIntuneFlatPalette = function(gn, r, sb)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'intune_mobile_application_management',
					r * 0.49, r * 0.5, '', 'Intune Mobile Application Management', null, null, this.getTagsForStencil(gn, 'mobile app application management', dt).join(' ')),
	...
	Sidebar.prototype.addMSCAENetworkingServicePalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'ClassicIPAddress.svg;',
					r * 0.5, r * 0.42, '', 'Reserved IP Addresses (Classic)', null, null, this.getTagsForStencil(gn, 'classic ip internet protocol address addresses', dt).join(' ')),
