(function()
{
	...
	Sidebar.prototype.addAWS4bPalette = function()
	{
		...
		this.addAWS4bArrowsPalette(s, gn, sb);
		this.addAWS4bGeneralResourcesPalette(s, gn, sb);
		this.addAWS4bIllustrationsPalette(s, n3, gn, sb);
		this.addAWS4bGroupsPalette(s, gn, sb, pts);
		this.addAWS4bAnalyticsPalette(s, w, h, w2, gn, sb);
		this.addAWS4bApplicationIntegrationPalette(s, w, h, w2, gn, sb);
		this.addAWS4bARVRPalette(s, w, h, w2, gn, sb);
		this.addAWS4bCostManagementPalette(s, w, h, w2, gn, sb);
		this.addAWS4bBlockchainPalette(s, w, h, w2, gn, sb);
		this.addAWS4bBusinessApplicationsPalette(s, w, h, w2, gn, sb);
		this.addAWS4bEC2InstanceTypePalette(s, w, h, w2, gn, sb);
		this.addAWS4bComputePalette(s, w, h, w2, gn, sb);
		this.addAWS4bCustomerEngagementPalette(s, w, h, w2, gn, sb);
		this.addAWS4bDatabasePalette(s, w, h, w2, gn, sb);
		this.addAWS4bDesktopAppStreamingPalette(s, w, h, w2, gn, sb);
		this.addAWS4bDeveloperToolsPalette(s, w, h, w2, gn, sb);
		this.addAWS4bGameTechPalette(s, w, h, w2, gn, sb);
		this.addAWS4bInternetOfThingsPalette(s, w, h, w2, gn, sb);
		this.addAWS4bMachineLearningPalette(s, w, h, w2, gn, sb);
		this.addAWS4bManagementGovernancePalette(s, w, h, w2, gn, sb);
		this.addAWS4bMediaServicesPalette(s, w, h, w2, gn, sb);
		this.addAWS4bMigrationTransferPalette(s, w, h, w2, gn, sb);
		this.addAWS4bMobilePalette(s, w, h, w2, gn, sb);
		this.addAWS4bNetworkContentDeliveryPalette(s, w, h, w2, gn, sb);
		this.addAWS4bRoboticsPalette(s, w, h, w2, gn, sb);
		this.addAWS4bSatellitePalette(s, w, h, w2, gn, sb);
		this.addAWS4bSecurityIdentityCompliancePalette(s, w, h, w2, gn, sb);
		this.addAWS4bStoragePalette(s, w, h, w2, gn, sb);
	};
	
	Sidebar.prototype.addAWS4bArrowsPalette = function(s, gn, sb)
	{
		var dt = 'aws amazon web service arrows';
		
		this.addPaletteFunctions('aws4bArrows', 'AWS / Arrows', false,
		[
	...
	Sidebar.prototype.addAWS4bGeneralResourcesPalette = function(s, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4bGeneral Resources', 'AWS / General Resources', false,
		[
			 ...
			 this.createVertexTemplateEntry(n2 + 'external_sdk;',
					 s * 68, s * 78, '', 'External SDK', null, null, this.getTagsForStencil(gn, 'external sdk software development kit', dt).join(' ')),
			 this.createVertexTemplateEntry(n2 + 'external_toolkit;',
					 s * 68, s * 78, '', 'External Toolkit', null, null, this.getTagsForStencil(gn, 'external toolkit', dt).join(' '))
		]);
	};

	Sidebar.prototype.addAWS4bIllustrationsPalette = function(s, n3, gn, sb)
	{
		var dt = 'aws amazon web service illustrations';
		
		this.addPaletteFunctions('aws4bIllustrations', 'AWS / Illustrations', false,
		[
	...
	Sidebar.prototype.addAWS4bGroupsPalette = function(s, gn, sb, pts)
	{
		var n4 = pts + 'outlineConnect=0;gradientColor=none;html=1;whiteSpace=wrap;fontSize=12;fontStyle=0;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service groups group';
		
		this.addPaletteFunctions('aws4bGroups', 'AWS / Groups', false,
		[
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_auto_scaling_group;strokeColor=#D86613;fillColor=none;verticalAlign=top;align=left;spacingLeft=30;fontColor=#D86613;dashed=0;',
					 s * 130, s * 130, '', 'Auto Scaling Group', null, null, this.getTagsForStencil(gn, 'auto scaling', dt).join(' ')),
			 this.createVertexTemplateEntry('outlineConnect=0;gradientColor=none;html=1;whiteSpace=wrap;fontSize=12;fontStyle=0;strokeColor=#007CBC;fillColor=none;verticalAlign=top;align=center;fontColor=#007CBC;dashed=1;spacingTop=3;',
				     s * 130, s * 130, '', 'Availability Zone', null, null, this.getTagsForStencil(gn, 'availability zone', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_aws_cloud;strokeColor=#232F3D;fillColor=none;verticalAlign=top;align=left;spacingLeft=30;fontColor=#000000;dashed=0;',
					 s * 130, s * 130, '', 'AWS Cloud', null, null, this.getTagsForStencil(gn, 'cloud', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_aws_cloud_alt;strokeColor=#232F3D;fillColor=none;verticalAlign=top;align=left;spacingLeft=30;fontColor=#000000;dashed=0;',
					 s * 130, s * 130, '', 'AWS Cloud', null, null, this.getTagsForStencil(gn, 'cloud', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_aws_step_functions_workflow;strokeColor=#CD2264;fillColor=none;verticalAlign=top;align=left;spacingLeft=30;fontColor=#CD2264;dashed=0;',
					 s * 130, s * 130, '', 'AWS Step Functions Workflow', null, null, this.getTagsForStencil(gn, 'step function', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_corporate_data_center;strokeColor=#5A6B86;fillColor=none;verticalAlign=top;align=left;spacingLeft=30;fontColor=#5A6B86;dashed=0;',
					 s * 130, s * 130, '', 'Corporate Data Center', null, null, this.getTagsForStencil(gn, 'corporate data center', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_ec2_instance_contents;strokeColor=#D86613;fillColor=none;verticalAlign=top;align=left;spacingLeft=30;fontColor=#D86613;dashed=0;',
					 s * 130, s * 130, '', 'EC2 Instance Contents', null, null, this.getTagsForStencil(gn, 'ec2 instance contents', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_elastic_beanstalk;strokeColor=#D86613;fillColor=none;verticalAlign=top;align=left;spacingLeft=30;fontColor=#D86613;dashed=0;',
					 s * 130, s * 130, '', 'Elastic Beanstalk Container', null, null, this.getTagsForStencil(gn, 'elastic beanstalk', dt).join(' ')),
			 this.createVertexTemplateEntry('outlineConnect=0;gradientColor=none;html=1;whiteSpace=wrap;fontSize=12;fontStyle=0;strokeColor=#5A6B86;fillColor=none;verticalAlign=top;align=center;fontColor=#5A6B86;dashed=1;spacingTop=3;',
					 s * 130, s * 130, '', 'Generic Group', null, null, this.getTagsForStencil(gn, 'generic', dt).join(' ')),
			 this.createVertexTemplateEntry('outlineConnect=0;gradientColor=none;html=1;whiteSpace=wrap;fontSize=12;fontStyle=0;strokeColor=none;fillColor=#E8E8E8;verticalAlign=top;align=center;fontColor=#232F3D;dashed=0;spacingTop=3;',
					 s * 130, s * 130, '', 'Generic Group', null, null, this.getTagsForStencil(gn, 'generic', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_private_subnet;strokeColor=none;fillColor=#D9EDFC;verticalAlign=top;align=left;spacingLeft=30;fontColor=#007CBC;dashed=0;',
					 s * 130, s * 130, '', 'Private Subnet', null, null, this.getTagsForStencil(gn, 'private subnet', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_public_subnet;strokeColor=none;fillColor=#D2E8D1;verticalAlign=top;align=left;spacingLeft=30;fontColor=#1D8900;dashed=0;',
					 s * 130, s * 130, '', 'Public Subnet', null, null, this.getTagsForStencil(gn, 'public subnet', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_region;strokeColor=#007CBC;fillColor=none;verticalAlign=top;align=left;spacingLeft=30;fontColor=#007CBC;dashed=0;',
					 s * 130, s * 130, '', 'Region', null, null, this.getTagsForStencil(gn, 'region', dt).join(' ')),
			 this.createVertexTemplateEntry('outlineConnect=0;gradientColor=none;html=1;whiteSpace=wrap;fontSize=12;fontStyle=0;strokeColor=#DF3312;fillColor=none;verticalAlign=top;align=center;fontColor=#DF3312;dashed=0;spacingTop=3;',
					 s * 130, s * 130, '', 'Security Group', null, null, this.getTagsForStencil(gn, 'security', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_on_premise;strokeColor=#5A6B86;fillColor=none;verticalAlign=top;align=left;spacingLeft=30;fontColor=#5A6B86;dashed=0;',
					 s * 130, s * 130, '', 'Server Contents', null, null, this.getTagsForStencil(gn, 'server contents', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_spot_fleet;strokeColor=#D86613;fillColor=none;verticalAlign=top;align=left;spacingLeft=30;fontColor=#D86613;dashed=0;',
					 s * 130, s * 130, '', 'Spot Fleet', null, null, this.getTagsForStencil(gn, 'spot fleet', dt).join(' ')),
			 this.createVertexTemplateEntry(n4 + 'group;grIcon=' + gn + '.group_vpc;strokeColor=#1D8900;fillColor=none;verticalAlign=top;align=left;spacingLeft=30;fontColor=#1D8900;dashed=0;',
					 s * 130, s * 130, '', 'VPC', null, null, this.getTagsForStencil(gn, 'vpc virtual private cloud', dt).join(' ')),
		]);
	};

	Sidebar.prototype.addAWS4bAnalyticsPalette = function(s, w, h, w2, gn, sb, pts)
	{
		...
		this.addPaletteFunctions('aws4bAnalytics', 'AWS / Analytics', false,
		[
	...
	Sidebar.prototype.addAWS4bApplicationIntegrationPalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4bApplication Integration', 'AWS / Application Integration', false,
		[
	...
	Sidebar.prototype.addAWS4bARVRPalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#BC1356;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#F34482;gradientDirection=north;fillColor=#BC1356;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service ar vr augmented virtual reality';
		
		this.addPaletteFunctions('aws4bAR VR', 'AWS / AR & VR', false,
		[
	...
	Sidebar.prototype.addAWS4bCostManagementPalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4bCost Management', 'AWS / Cost Management', false,
		[
	...
	Sidebar.prototype.addAWS4bBlockchainPalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4bBlockchain', 'AWS / Blockchain', false,
		[
	...
	Sidebar.prototype.addAWS4bBusinessApplicationsPalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4bBusiness Applications', 'AWS / Applications', false,
		[
	...
	Sidebar.prototype.addAWS4bEC2InstanceTypePalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4bEC2 Instance Types', 'AWS / EC2 Instance Types', false,
		[
	...
	Sidebar.prototype.addAWS4bComputePalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#D05C17;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#F78E04;gradientDirection=north;fillColor=#D05C17;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service compute';
		
		this.addPaletteFunctions('aws4bCompute', 'AWS / Compute', false,
		[
	...
	Sidebar.prototype.addAWS4bCustomerEngagementPalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4bCustomer Engagement', 'AWS / Customer Engagement', false,
		[
	...
	Sidebar.prototype.addAWS4bDatabasePalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#3334B9;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#4D72F3;gradientDirection=north;fillColor=#3334B9;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service db database';
		
		this.addPaletteFunctions('aws4bDatabase', 'AWS / Database', false,
		[
	...
	Sidebar.prototype.addAWS4bDesktopAppStreamingPalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4bDesktop App Streaming', 'AWS / Desktop & App Streaming', false,
		[
	...
	Sidebar.prototype.addAWS4bDeveloperToolsPalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#3334B9;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#4D72F3;gradientDirection=north;fillColor=#3334B9;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service dev developer tools';
		
		this.addPaletteFunctions('aws4bDeveloper Tools', 'AWS / Developer Tools', false,
		[
	...
	Sidebar.prototype.addAWS4bGameTechPalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#5A30B5;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#945DF2;gradientDirection=north;fillColor=#5A30B5;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service game development';
		
		this.addPaletteFunctions('aws4bGame Tech', 'AWS / Game Tech', false,
		[
	...
	Sidebar.prototype.addAWS4bInternetOfThingsPalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#277116;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#60A337;gradientDirection=north;fillColor=#277116;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service internet of things iot';
		
		this.addPaletteFunctions('aws4bInternet of Things', 'AWS / Internet of Things', false,
		[
	...
	Sidebar.prototype.addAWS4bMachineLearningPalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#116D5B;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#4AB29A;gradientDirection=north;fillColor=#116D5B;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service machine learning';
		
		this.addPaletteFunctions('aws4bMachine Learning', 'AWS / Machine Learning', false,
		[
	...
	Sidebar.prototype.addAWS4bManagementGovernancePalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#BC1356;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#F34482;gradientDirection=north;fillColor=#BC1356;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service management governance';
		
		this.addPaletteFunctions('aws4bManagement Governance', 'AWS / Management & Governance', false,
		[
	...
	Sidebar.prototype.addAWS4bMediaServicesPalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#D05C17;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#F78E04;gradientDirection=north;fillColor=#D05C17;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service media services';
		
		this.addPaletteFunctions('aws4bMedia Services', 'AWS / Media Services', false,
		[
	...
	Sidebar.prototype.addAWS4bMigrationTransferPalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#116D5B;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#4AB29A;gradientDirection=north;fillColor=#116D5B;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service migration transfer';
		
		this.addPaletteFunctions('aws4bMigration Transfer', 'AWS / Migration & Transfer', false,
		[
	...
	Sidebar.prototype.addAWS4bMobilePalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#C7131F;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#F54749;gradientDirection=north;fillColor=#C7131F;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service mobile';
		
		this.addPaletteFunctions('aws4bMobile', 'AWS / Mobile', false,
		[
	...
	Sidebar.prototype.addAWS4bNetworkContentDeliveryPalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#5A30B5;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#945DF2;gradientDirection=north;fillColor=#5A30B5;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service netowrk content delivery';
		
		this.addPaletteFunctions('aws4bNetwork Content Delivery', 'AWS / Network & Content Delivery', false,
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.api_gateway;',
					 w2, w2, '', 'API Gateway', null, null, this.getTagsForStencil(gn, 'api application programming interface gateway', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4bRoboticsPalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4bRobotics', 'AWS / Robotics', false,
		[
	...
	Sidebar.prototype.addAWS4bSatellitePalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4bSatellite', 'AWS / Satellite', false,
		[
	...
	Sidebar.prototype.addAWS4bSecurityIdentityCompliancePalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#C7131F;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#F54749;gradientDirection=north;fillColor=#C7131F;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service security identity compliance';
		
		this.addPaletteFunctions('aws4bSecurity Identity Compliance', 'AWS / Security, Identity & Compliance', false,
		[
	...
	Sidebar.prototype.addAWS4bStoragePalette = function(s, w, h, w2, gn, sb)
	{
		var n = 'outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=#277116;strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var n2 = 'outlineConnect=0;fontColor=#232F3E;gradientColor=#60A337;gradientDirection=north;fillColor=#277116;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service storage';
		
		this.addPaletteFunctions('aws4bStorage', 'AWS / Storage', false,
		[
