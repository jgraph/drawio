	...
	Sidebar.prototype.addIsometricPalette = function()
	{
		...
		[
			...
			this.addEntry('generic isometric shape group container', function()
			{
				...
				s + 'shape;fillColor=#ECECEC;strokeColor=#5E5E5E;aspect=fixed;isoAngle=20;container=1;collapsible=0;');
				cell.vertex = true;

				var symbol = new mxCell('', new mxGeometry(30.8, -8.4, 61.5, 61.5), s2 + 'mxgraph.basic.6_point_star;fillColor=#5E5E5E;aspect=fixed;isoAngle=20;gradientColor=none;');
				symbol.vertex = true;
				cell.insert(symbol);
			...
			this.addEntry('generic isometric image group container', function()
			{
				...
				var symbol = new mxCell('', new mxGeometry(30.8, -8.4, 61.5, 61.5), 'image;fillColor=#ECECEC;strokeColor=#5E5E5E;aspect=fixed;isoAngle=20;image=img/lib/active_directory/active_directory.svg;');
				symbol.vertex = true;
				cell.insert(symbol);
			...
			this.createVertexTemplateEntry(s + 'genericContainer;fillColor=#ECECEC;strokeColor=#5E5E5E;isoAngle=30;indicatorShape=mxgraph.mscae.cloud.functions;indicatorColor=#5E5E5E;', 
					w * 1.23, h * 1.06, '', 'Generic Isometric Shape Decoration', null, null, this.getTagsForStencil(gn, 'generic isometric shape decoration', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'genericContainer;fillColor=#ECECEC;strokeColor=#5E5E5E;isoAngle=30;image=img/lib/mscae/Service_Bus.svg;', 
					w * 1.23, h * 1.06, '', 'Generic Isometric Image decoration', null, null, this.getTagsForStencil(gn, 'generic isometric image decoration', dt).join(' ')),
