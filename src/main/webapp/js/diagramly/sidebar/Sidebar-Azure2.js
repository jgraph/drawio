...
(function()
{
	...
	Sidebar.prototype.addAzure2AIMachineLearningPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Azure_Machine_Learning.svg;',
			...
			this.createVertexTemplateEntry(s + 'Planetary_Computer_Pro.svg;',
	...
	Sidebar.prototype.addAzure2ComputePalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Azure_Linux.svg;',
			...
			this.createVertexTemplateEntry(s + 'Scheduled_Actions.svg;',
			...
			this.createVertexTemplateEntry(s + 'Stage_Maps.svg;',
	...
	Sidebar.prototype.addAzure2ContainersPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry(s + 'AKS_Network_Policy.svg;',
			...
			this.createVertexTemplateEntry(s + 'Azure_Container_Storage.svg;',
					r * 0.17, r * 0.17, '', 'Container Storage', null, null, this.getTagsForStencil(gn, 'container storage', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Kubernetes_Hub.svg;',
			...
			this.createVertexTemplateEntry(s + 'Service_Groups.svg;',
	...
	Sidebar.prototype.addAzure2DatabasesPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry(s + 'Azure_DocumentDB.svg;',
					r * 0.1282, r * 0.17, '', 'Azure DocumentDB', null, null, this.getTagsForStencil(gn, 'documentdb document db', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Azure_Managed_Redis.svg;',
			...
			this.createVertexTemplateEntry(s + 'SQL_Database_Fleet_Manager.svg;',
	...
	Sidebar.prototype.addAzure2DevOpsPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Azure_App_Testing.svg;',
	...
	Sidebar.prototype.addAzure2GeneralPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Region_Management.svg;',
	...
	Sidebar.prototype.addAzure2HybridAndMulticloudPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry(s + 'AI_at_Edge.svg;',
					r * 0.17, r * 0.169, '', 'AI at Edge', null, null, this.getTagsForStencil(gn, 'ai edge', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Azure_Local.svg;',
			...
			this.createVertexTemplateEntry(s + 'Edge_Storage_Accelerator.svg;',
					r * 0.17, r * 0.17, '', 'Edge Storage Accelerator', null, null, this.getTagsForStencil(gn, 'edge storage accelerator', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Workload_Orchestration.svg;',
	...
	Sidebar.prototype.addAzure2IdentityPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'External_ID.svg;',
	...
	Sidebar.prototype.addAzure2IntegrationPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry(s + 'AI_Gateway.svg;',
			...
			this.createVertexTemplateEntry(s + 'Logic_Apps_Template.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/analytics/Power_Platform.svg;',
					r * 0.1623, r * 0.17, '', 'Power Platform', null, null, this.getTagsForStencil(gn, 'power platform', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Azure_PubSub.svg;',
	...
	Sidebar.prototype.addAzure2IntunePalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Engage_Center_Connect.svg;',
	...
	Sidebar.prototype.addAzure2IOTPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Function_Apps.svg;',
					r * 0.17, r * 0.15, '', 'Function Apps', null, null, this.getTagsForStencil(gn, 'function apps', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Hybrid_Connectivity_Hub.svg;',
	...
	Sidebar.prototype.addAzure2ManagementGovernancePalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Landing_Zone.svg;',
			...
			this.createVertexTemplateEntry(s + 'Service_Group_Relationships.svg;',
	...
	Sidebar.prototype.addAzure2NetworkingPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry(s + 'Azure_Access_Point.svg;',
			...
			this.createVertexTemplateEntry(s + 'DDoS_Custom_Policy.svg;',
			...
			this.createVertexTemplateEntry(s + 'Edge_Actions.svg;',
			...
			this.createVertexTemplateEntry(s + 'Load_Balancer_Hub2.svg;',
			...
			this.createVertexTemplateEntry(s + 'Network_Foundation_Hub.svg;',
			...
			this.createVertexTemplateEntry(s + 'Network_Security_Hub.svg;',
			...
			this.createVertexTemplateEntry(s + 'VNet_Appliance.svg;',
					r * 0.1699, r * 0.17, '', 'VNet Appliance', null, null, this.getTagsForStencil(gn, 'vnet appliance virtual network', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'VPN_Client_Windows.svg;',
	...
	Sidebar.prototype.addAzure2OtherPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Azure_Enclaves.svg;',
			...
			this.createVertexTemplateEntry(s + 'Breeze.svg;',
			...
			this.createVertexTemplateEntry(s + 'Azure_Consumption_Commitment.svg;',
			...
			this.createVertexTemplateEntry(s + 'Azure_Data_Sharing.svg;',
					r * 0.17, r * 0.119, '', 'Data Sharing', null, null, this.getTagsForStencil(gn, 'data sharing', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Azure_Data_Transfer.svg;',
			...
			this.createVertexTemplateEntry(s + 'Disconnected_Operations.svg;',
			...
			this.createVertexTemplateEntry(s + 'Microsoft_Discovery.svg;',
			...
			this.createVertexTemplateEntry(s + 'Prometheus.svg;',
			...
			this.createVertexTemplateEntry(s + 'Resiliency.svg;',
	...
	Sidebar.prototype.addAzure2StoragePalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Data_Virtualization.svg;',
			...
			this.createVertexTemplateEntry(s + 'Storage_Hubs.svg;',
	...
	Sidebar.prototype.addAzure2WebPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry(s + 'Agentic_Web_Apps.svg;',
