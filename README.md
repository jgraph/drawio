...
About
-----
draw.io is an [online diagramming](https://www.draw.io) solution also available [offline](https://app.draw.io) and for [desktop](https://get.draw.io). The complete source code is in this project.
